...
bool VulkanRenderer::Init()
{
    ...
    Platform::Log(
        ...
        "native_vulkan_shadow_pipeline_bootstrap=1 native_vulkan_toon_highlight_contract=1 native_vulkan_toon_highlight_shader_abi=1 native_vulkan_3d=0 generation=%llu\n",
        contract.ModeName,
