...
namespace Config
{
    ...
    DefaultList<int> DefaultInts =
    {
        ...
        {"Instance*.Metroid.Visual.HudHpX",              120},
        ...
        {"Instance*.Metroid.Visual.HudHpGaugeOffsetX",       0},
        {"Instance*.Metroid.Visual.HudHpGaugeOffsetY",       2},
        {"Instance*.Metroid.Visual.HudHpGaugeColorR",        0},
        {"Instance*.Metroid.Visual.HudHpGaugeColorG",      255},
        {"Instance*.Metroid.Visual.HudHpGaugeColorB",        0},
        {"Instance*.Metroid.Visual.HudHpGaugeAnchor",        0},
        {"Instance*.Metroid.Visual.HudAmmoGaugeOrientation", 0},
        {"Instance*.Metroid.Visual.HudAmmoGaugeLength",     28},
        {"Instance*.Metroid.Visual.HudAmmoGaugeWidth",       3},
        {"Instance*.Metroid.Visual.HudAmmoGaugeOffsetX",     0},
        {"Instance*.Metroid.Visual.HudAmmoGaugeOffsetY",    28},
        {"Instance*.Metroid.Visual.HudAmmoGaugeColorR",      0},
        {"Instance*.Metroid.Visual.HudAmmoGaugeColorG",    200},
        {"Instance*.Metroid.Visual.HudAmmoGaugeColorB",    255},
        {"Instance*.Metroid.Visual.HudAmmoGaugeAnchor",      0},
