...
namespace Config
{
    ...
    DefaultList<bool> DefaultBools =
    {
        ...
        {"Instance*.Metroid.GameFeature.PowerUpPickupNoEffect", false},
        {"Instance*.Metroid.GameFeature.PowerUpPickupNoEffect.DoubleDamage", false},
        {"Instance*.Metroid.GameFeature.PowerUpPickupNoEffect.Cloak", false},
        {"Instance*.Metroid.GameFeature.PowerUpPickupNoEffect.Deathalt", false},
