...
namespace Config
{
    ...
    DefaultList<int> DefaultInts =
    {
        ...
        {"Instance*.Metroid.Visual.HudWeaponIconAnchorX",  0},
        {"Instance*.Metroid.Visual.HudWeaponIconAnchorY",  0},
        ...
        {"Instance*.Metroid.Visual.HudHpGaugeOffsetX",      -5},
        ...
        {"Instance*.Metroid.Visual.HudHpGaugePosMode",       0},
        {"Instance*.Metroid.Visual.HudHpGaugePosX",          0},
        {"Instance*.Metroid.Visual.HudHpGaugePosY",         96},
        ...
        {"Instance*.Metroid.Visual.HudAmmoGaugePosX",      240},
        {"Instance*.Metroid.Visual.HudAmmoGaugePosY",       82},
        /* Battle HUD */
        {"Instance*.Metroid.Visual.HudMatchStatusX",             4},
        {"Instance*.Metroid.Visual.HudMatchStatusY",            16},
        {"Instance*.Metroid.Visual.HudMatchStatusLabelOfsX",     0},
        {"Instance*.Metroid.Visual.HudMatchStatusLabelOfsY",     0},
