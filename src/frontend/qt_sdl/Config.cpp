...
#ifdef MELONPRIME_DS
#define MP_HUD_DEFAULT_ENTRY(identifier, key, cfgType, defaultExpr, uiMin, uiMax, uiStep, label, uiKind, surfaceMask, flags) \
        {"Instance*." key, defaultExpr},
#endif
    ...
    DefaultList<int> DefaultInts =
    {
        ...
        {"Instance*.Metroid.Input.AltFormTransformMethod", 0},
        ...
        /* MelonPrimeDS Visual int defaults are generated from MelonPrimeHudPropSchema.inc. */
        MP_HUD_PROP_SCHEMA_INT(MP_HUD_DEFAULT_ENTRY)
    ...
    RangeList IntRanges =
    {
        ...
        {"Instance*.Metroid.Input.WeaponSwitchMethod", {0,2}},
        {"Instance*.Metroid.Input.AltFormTransformMethod", {0,2}},
        {"Instance*.Metroid.Input.BipedFireMethod", {0,1}},
        {"Instance*.Metroid.Input.ZoomMethod", {0,3}},
    ...
    #ifdef MELONPRIME_DS
        /* MelonPrimeDS Visual string defaults are generated from MelonPrimeHudPropSchema.inc. */
        MP_HUD_PROP_SCHEMA_STRING(MP_HUD_DEFAULT_ENTRY)
    #endif
    };
    ...
    DefaultList<double> DefaultDoubles =
    {
        ...
        /* MelonPrimeDS Visual double defaults are generated from MelonPrimeHudPropSchema.inc. */
        MP_HUD_PROP_SCHEMA_DOUBLE(MP_HUD_DEFAULT_ENTRY)
    #endif
    };

#ifdef MELONPRIME_DS
#undef MP_HUD_DEFAULT_ENTRY
#endif
