...
namespace Config
{
    ...
    DefaultList<int> DefaultInts =
    {
        ...
        {"Instance*.Metroid.Visual.HudWeaponInventoryX",            -20},
        {"Instance*.Metroid.Visual.HudWeaponInventoryY",            -110},
        ...
        {"Instance*.Metroid.Visual.HudHpGaugeOffsetX",     -14},
        {"Instance*.Metroid.Visual.HudHpGaugeOffsetY",       1},
        ...
        {"Instance*.Metroid.Visual.BtmOverlayRadarColorR",    185},
    ...
    DefaultList<bool> DefaultBools =
    {
        ...
        {"Instance*.Metroid.Visual.HudWeaponIconOutline",    false},
        {"Instance*.Metroid.Visual.HudAmmoGaugeOutline",     false},
        {"Instance*.Metroid.Visual.HudMatchStatusOutline",   false},
        {"Instance*.Metroid.Visual.HudRankOutline",          false},
        {"Instance*.Metroid.Visual.HudTimeLeftOutline",      false},
        {"Instance*.Metroid.Visual.HudTimeLimitOutline",     false},
        {"Instance*.Metroid.Visual.HudBombLeftOutline",      false},
        {"Instance*.Metroid.Visual.HudBombIconOutline",      false},
        {"Instance*.Metroid.Visual.BtmOverlayOutline",       false},
