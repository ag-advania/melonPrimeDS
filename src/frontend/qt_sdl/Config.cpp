...
namespace Config
{
    ...
    DefaultList<bool> DefaultBools =
    {
        ...
        {"Instance*.Metroid.Visual.HudRankTimeOutline",      false},
    ...
    DefaultList<double> DefaultDoubles =
    {
        ...
        {"Instance*.Metroid.Visual.HudRankTimeOutlineColorR",      0},
        {"Instance*.Metroid.Visual.HudRankTimeOutlineColorG",      0},
        {"Instance*.Metroid.Visual.HudRankTimeOutlineColorB",      0},
        {"Instance*.Metroid.Visual.HudRankTimeOutlineOpacity",     0.75},
        {"Instance*.Metroid.Visual.HudRankTimeOutlineThickness",   1},
