...
namespace Config
{
    ...
    DefaultList<int> DefaultInts =
    {
        ...
        {"Instance*.Metroid.UI.MenuLanguage", 0}, // 0=Japanese, 1=English; ignored outside Japanese OS
        ...
        {"Instance*.Metroid.Aim.MoonLikeAimFastStepQ12", 0x058F},
        {"Instance*.Metroid.Aim.MoonLikeAimFastThresholdQ12", 0x042E},
        {"Instance*.Metroid.Input.WeaponSwitchMethod", 0},
        {"Instance*.Metroid.Input.BipedFireMethod", 0},
        ...
        {"Instance*.Metroid.Visual.HudHpGaugeLength",       77},
        {"Instance*.Metroid.Visual.HudHpGaugeWidth",         4},
        ...
        {"Instance*.Metroid.Visual.HudHpTextAnchor",         2},
        {"Instance*.Metroid.Visual.HudHpTextOffsetX",        7},
        ...
        {"Instance*.Metroid.Visual.HudAmmoGaugeLength",     27},
        ...
        {"Instance*.Metroid.Visual.HudAmmoGaugePosMode",     2},
        {"Instance*.Metroid.Visual.HudAmmoGaugePosAnchor",  7},
        {"Instance*.Metroid.Visual.HudAmmoGaugePosX",      12},
        {"Instance*.Metroid.Visual.HudAmmoGaugePosY",     -22},
        {"Instance*.Metroid.Visual.HudAmmoTextAnchor",      2},
        {"Instance*.Metroid.Visual.HudAmmoTextOffsetX",    6},
        {"Instance*.Metroid.Visual.HudAmmoTextOffsetY",   0},
        /* Color-by-value ramps (HP/Ammo label & gauge). Count = active stops;
           per stop: Pct threshold (% of max) + R/G/B. Default seeds the
           75/50/25/0% green/blue/yellow/red example (enabled flags default off). */
        {"Instance*.Metroid.Visual.HudHpTextRampCount",   4},
        {"Instance*.Metroid.Visual.HudHpTextRamp1Pct", 75}, {"Instance*.Metroid.Visual.HudHpTextRamp1R",   0}, {"Instance*.Metroid.Visual.HudHpTextRamp1G", 200}, {"Instance*.Metroid.Visual.HudHpTextRamp1B",   8},
        {"Instance*.Metroid.Visual.HudHpTextRamp2Pct", 50}, {"Instance*.Metroid.Visual.HudHpTextRamp2R",  40}, {"Instance*.Metroid.Visual.HudHpTextRamp2G", 130}, {"Instance*.Metroid.Visual.HudHpTextRamp2B", 255},
        {"Instance*.Metroid.Visual.HudHpTextRamp3Pct", 25}, {"Instance*.Metroid.Visual.HudHpTextRamp3R", 255}, {"Instance*.Metroid.Visual.HudHpTextRamp3G", 210}, {"Instance*.Metroid.Visual.HudHpTextRamp3B",   0},
        {"Instance*.Metroid.Visual.HudHpTextRamp4Pct",  0}, {"Instance*.Metroid.Visual.HudHpTextRamp4R", 255}, {"Instance*.Metroid.Visual.HudHpTextRamp4G",   0}, {"Instance*.Metroid.Visual.HudHpTextRamp4B",   0},
        {"Instance*.Metroid.Visual.HudHpTextRamp5Pct",  0}, {"Instance*.Metroid.Visual.HudHpTextRamp5R", 255}, {"Instance*.Metroid.Visual.HudHpTextRamp5G",   0}, {"Instance*.Metroid.Visual.HudHpTextRamp5B",   0},
        {"Instance*.Metroid.Visual.HudHpTextRamp6Pct",  0}, {"Instance*.Metroid.Visual.HudHpTextRamp6R", 255}, {"Instance*.Metroid.Visual.HudHpTextRamp6G",   0}, {"Instance*.Metroid.Visual.HudHpTextRamp6B",   0},
        {"Instance*.Metroid.Visual.HudHpGaugeRampCount",  4},
        {"Instance*.Metroid.Visual.HudHpGaugeRamp1Pct", 75}, {"Instance*.Metroid.Visual.HudHpGaugeRamp1R",   0}, {"Instance*.Metroid.Visual.HudHpGaugeRamp1G", 200}, {"Instance*.Metroid.Visual.HudHpGaugeRamp1B",   8},
        {"Instance*.Metroid.Visual.HudHpGaugeRamp2Pct", 50}, {"Instance*.Metroid.Visual.HudHpGaugeRamp2R",  40}, {"Instance*.Metroid.Visual.HudHpGaugeRamp2G", 130}, {"Instance*.Metroid.Visual.HudHpGaugeRamp2B", 255},
        {"Instance*.Metroid.Visual.HudHpGaugeRamp3Pct", 25}, {"Instance*.Metroid.Visual.HudHpGaugeRamp3R", 255}, {"Instance*.Metroid.Visual.HudHpGaugeRamp3G", 210}, {"Instance*.Metroid.Visual.HudHpGaugeRamp3B",   0},
        {"Instance*.Metroid.Visual.HudHpGaugeRamp4Pct",  0}, {"Instance*.Metroid.Visual.HudHpGaugeRamp4R", 255}, {"Instance*.Metroid.Visual.HudHpGaugeRamp4G",   0}, {"Instance*.Metroid.Visual.HudHpGaugeRamp4B",   0},
        {"Instance*.Metroid.Visual.HudHpGaugeRamp5Pct",  0}, {"Instance*.Metroid.Visual.HudHpGaugeRamp5R", 255}, {"Instance*.Metroid.Visual.HudHpGaugeRamp5G",   0}, {"Instance*.Metroid.Visual.HudHpGaugeRamp5B",   0},
        {"Instance*.Metroid.Visual.HudHpGaugeRamp6Pct",  0}, {"Instance*.Metroid.Visual.HudHpGaugeRamp6R", 255}, {"Instance*.Metroid.Visual.HudHpGaugeRamp6G",   0}, {"Instance*.Metroid.Visual.HudHpGaugeRamp6B",   0},
        {"Instance*.Metroid.Visual.HudAmmoTextRampCount", 4},
        {"Instance*.Metroid.Visual.HudAmmoTextRamp1Pct", 75}, {"Instance*.Metroid.Visual.HudAmmoTextRamp1R",   0}, {"Instance*.Metroid.Visual.HudAmmoTextRamp1G", 200}, {"Instance*.Metroid.Visual.HudAmmoTextRamp1B",   8},
        {"Instance*.Metroid.Visual.HudAmmoTextRamp2Pct", 50}, {"Instance*.Metroid.Visual.HudAmmoTextRamp2R",  40}, {"Instance*.Metroid.Visual.HudAmmoTextRamp2G", 130}, {"Instance*.Metroid.Visual.HudAmmoTextRamp2B", 255},
        {"Instance*.Metroid.Visual.HudAmmoTextRamp3Pct", 25}, {"Instance*.Metroid.Visual.HudAmmoTextRamp3R", 255}, {"Instance*.Metroid.Visual.HudAmmoTextRamp3G", 210}, {"Instance*.Metroid.Visual.HudAmmoTextRamp3B",   0},
        {"Instance*.Metroid.Visual.HudAmmoTextRamp4Pct",  0}, {"Instance*.Metroid.Visual.HudAmmoTextRamp4R", 255}, {"Instance*.Metroid.Visual.HudAmmoTextRamp4G",   0}, {"Instance*.Metroid.Visual.HudAmmoTextRamp4B",   0},
        {"Instance*.Metroid.Visual.HudAmmoTextRamp5Pct",  0}, {"Instance*.Metroid.Visual.HudAmmoTextRamp5R", 255}, {"Instance*.Metroid.Visual.HudAmmoTextRamp5G",   0}, {"Instance*.Metroid.Visual.HudAmmoTextRamp5B",   0},
        {"Instance*.Metroid.Visual.HudAmmoTextRamp6Pct",  0}, {"Instance*.Metroid.Visual.HudAmmoTextRamp6R", 255}, {"Instance*.Metroid.Visual.HudAmmoTextRamp6G",   0}, {"Instance*.Metroid.Visual.HudAmmoTextRamp6B",   0},
        {"Instance*.Metroid.Visual.HudAmmoGaugeRampCount", 4},
        {"Instance*.Metroid.Visual.HudAmmoGaugeRamp1Pct", 75}, {"Instance*.Metroid.Visual.HudAmmoGaugeRamp1R",   0}, {"Instance*.Metroid.Visual.HudAmmoGaugeRamp1G", 200}, {"Instance*.Metroid.Visual.HudAmmoGaugeRamp1B",   8},
        {"Instance*.Metroid.Visual.HudAmmoGaugeRamp2Pct", 50}, {"Instance*.Metroid.Visual.HudAmmoGaugeRamp2R",  40}, {"Instance*.Metroid.Visual.HudAmmoGaugeRamp2G", 130}, {"Instance*.Metroid.Visual.HudAmmoGaugeRamp2B", 255},
        {"Instance*.Metroid.Visual.HudAmmoGaugeRamp3Pct", 25}, {"Instance*.Metroid.Visual.HudAmmoGaugeRamp3R", 255}, {"Instance*.Metroid.Visual.HudAmmoGaugeRamp3G", 210}, {"Instance*.Metroid.Visual.HudAmmoGaugeRamp3B",   0},
        {"Instance*.Metroid.Visual.HudAmmoGaugeRamp4Pct",  0}, {"Instance*.Metroid.Visual.HudAmmoGaugeRamp4R", 255}, {"Instance*.Metroid.Visual.HudAmmoGaugeRamp4G",   0}, {"Instance*.Metroid.Visual.HudAmmoGaugeRamp4B",   0},
        {"Instance*.Metroid.Visual.HudAmmoGaugeRamp5Pct",  0}, {"Instance*.Metroid.Visual.HudAmmoGaugeRamp5R", 255}, {"Instance*.Metroid.Visual.HudAmmoGaugeRamp5G",   0}, {"Instance*.Metroid.Visual.HudAmmoGaugeRamp5B",   0},
        {"Instance*.Metroid.Visual.HudAmmoGaugeRamp6Pct",  0}, {"Instance*.Metroid.Visual.HudAmmoGaugeRamp6R", 255}, {"Instance*.Metroid.Visual.HudAmmoGaugeRamp6G",   0}, {"Instance*.Metroid.Visual.HudAmmoGaugeRamp6B",   0},
        /* Battle HUD */
        ...
        /* These defaults describe the MelonPrime Custom HUD preset colors, not
           the game's original BGR555 literals. The patch still writes the same
           literal sites; these values define the initial UI/preset state.

           Original vanilla-preserving BGR555 references:
        ...
        /* Global "set all" color (yellow) */
        {"Instance*.Metroid.Visual.OsdColorR",              248},
        {"Instance*.Metroid.Visual.OsdColorG",              248},
        {"Instance*.Metroid.Visual.OsdColorB",               88},
        /* Per-category literal colors. Most direct-message categories default
           to the red alert color, while objective/system slot categories below
           keep the yellow message color. */
        {"Instance*.Metroid.Visual.OsdColorLostLivesR",     248},
        {"Instance*.Metroid.Visual.OsdColorLostLivesG",      40},
        {"Instance*.Metroid.Visual.OsdColorLostLivesB",      40},
        {"Instance*.Metroid.Visual.OsdColorKillDeathR",     248},
        {"Instance*.Metroid.Visual.OsdColorKillDeathG",      40},
        {"Instance*.Metroid.Visual.OsdColorKillDeathB",      40},
        {"Instance*.Metroid.Visual.OsdColorReturnBaseR",    248},
        {"Instance*.Metroid.Visual.OsdColorReturnBaseG",     40},
        {"Instance*.Metroid.Visual.OsdColorReturnBaseB",     40},
        {"Instance*.Metroid.Visual.OsdColorNoAmmoR",        248},
        {"Instance*.Metroid.Visual.OsdColorNoAmmoG",         40},
        {"Instance*.Metroid.Visual.OsdColorNoAmmoB",         40},
        {"Instance*.Metroid.Visual.OsdColorCowardDetectR",  248},
        {"Instance*.Metroid.Visual.OsdColorCowardDetectG",   40},
        {"Instance*.Metroid.Visual.OsdColorCowardDetectB",   40},
        {"Instance*.Metroid.Visual.OsdColorAcquiringNodeR", 248},
        {"Instance*.Metroid.Visual.OsdColorAcquiringNodeG",  40},
        {"Instance*.Metroid.Visual.OsdColorAcquiringNodeB",  40},
        {"Instance*.Metroid.Visual.OsdColorTurretR",        248},
        {"Instance*.Metroid.Visual.OsdColorTurretG",         40},
        {"Instance*.Metroid.Visual.OsdColorTurretB",         40},
        {"Instance*.Metroid.Visual.OsdColorOctoResetR",     248},
        {"Instance*.Metroid.Visual.OsdColorOctoResetG",      40},
        {"Instance*.Metroid.Visual.OsdColorOctoResetB",      40},
        {"Instance*.Metroid.Visual.OsdColorOctoDropR",      248},
        {"Instance*.Metroid.Visual.OsdColorOctoDropG",       40},
        {"Instance*.Metroid.Visual.OsdColorOctoDropB",       40},
        {"Instance*.Metroid.Visual.OsdColorOctoCondR",      248},
        {"Instance*.Metroid.Visual.OsdColorOctoCondG",       40},
        {"Instance*.Metroid.Visual.OsdColorOctoCondB",       40},
        {"Instance*.Metroid.Visual.OsdColorOctoMissingR",   248},
        {"Instance*.Metroid.Visual.OsdColorOctoMissingG",    40},
        {"Instance*.Metroid.Visual.OsdColorOctoMissingB",    40},
        /* H211 "node stolen" separate color */
        {"Instance*.Metroid.Visual.OsdColorH211R",          255},
        {"Instance*.Metroid.Visual.OsdColorH211G",          255},
        {"Instance*.Metroid.Visual.OsdColorH211B",            0},
        /* Slot override per-flag category colors (used when applyGlobal=false).
           flags=0x02: kill/death result messages (YOU KILLED, KILLED YOU,
                      5-kill, prime hunter)
           flags=0x11: node capture messages (acquiring node H204/H205,
                      node stolen H211)
           flags=0x01: objective messages (AMMO DEPLETED, return to base,
                      bounty, octolith events)
           flags=0x00: system/quick messages (HEADSHOT!, FACE OFF!,
                      RETURN TO BATTLE!, COWARD, turret) */
        {"Instance*.Metroid.Visual.OsdColorSlotKillDeathR", 255},
        {"Instance*.Metroid.Visual.OsdColorSlotKillDeathG", 255},
        {"Instance*.Metroid.Visual.OsdColorSlotKillDeathB",   0},
        {"Instance*.Metroid.Visual.OsdColorSlotNodeR",      255},
        {"Instance*.Metroid.Visual.OsdColorSlotNodeG",      255},
        {"Instance*.Metroid.Visual.OsdColorSlotNodeB",        0},
        {"Instance*.Metroid.Visual.OsdColorSlotObjectiveR", 248},
        {"Instance*.Metroid.Visual.OsdColorSlotObjectiveG", 248},
        {"Instance*.Metroid.Visual.OsdColorSlotObjectiveB",  88},
        {"Instance*.Metroid.Visual.OsdColorSlotSystemR",    248},
        {"Instance*.Metroid.Visual.OsdColorSlotSystemG",    248},
        {"Instance*.Metroid.Visual.OsdColorSlotSystemB",     88},
        /* MelonPrimeDS OSD Color Patch defaults } */
        /* MelonPrimeDS Custom HUD Crosshair defaults } */
    #endif
    };
    ...
    RangeList IntRanges =
    {
        ...
        {"Instance*.Metroid.Input.BipedFireMethod", {0,1}},
    ...
    DefaultList<bool> DefaultBools =
    {
        ...
        {"Instance*.Metroid.Visual.HudWeaponInventoryShow", false},
        ...
        {"Instance*.Metroid.GameFeature.ExpandStageMatrixExtra", false},
        ...
        {"Instance*.Metroid.GameFeature.PowerUpPickupNoEffectDeathalt", false},
        {"Instance*.Metroid.Visual.InGameAspectRatio", true},
        {"Instance*.Metroid.Visual.OsdColor",            false},
        {"Instance*.Metroid.Visual.OsdColorApplyGlobal", true},
        ...
        {"Instance*.Metroid.UI.SectionDisableFeatures", true},
        {"Instance*.Metroid.UI.SectionPowerUpPickupEffects", true},
