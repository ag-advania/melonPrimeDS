    ...
    while (EmuRunning != emuStatus_Exit) {
        ...
        if (isFocused) {
			...
			if (isInGame) {
                ...
                font6.setHintingPreference(QFont::HintingPreference::PreferFullHinting);
                ...
                font7.setHintingPreference(QFont::HintingPreference::PreferFullHinting);
                ...
                font8.setHintingPreference(QFont::HintingPreference::PreferFullHinting);
                ...
                font9.setHintingPreference(QFont::HintingPreference::PreferFullHinting);
