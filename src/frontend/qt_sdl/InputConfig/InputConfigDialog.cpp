...
InputConfigDialog::InputConfigDialog(QWidget* parent) : QDialog(parent), ui(new Ui::InputConfigDialog)
{
    ...
    // �N���X��(MelonPrimeInputConfig)�ł͂Ȃ��ϐ���(melonPrimeInputConfig)���g�p
    melonPrimeInputConfig = new MelonPrimeInputConfig(emuInstance, this);

    // �y�d�v�z�R���e�i���͕̂\�����Ȃ��悤�ɉB���i���ꂪ�Ȃ��Ɣ�����ʂ��킳��j
    melonPrimeInputConfig->hide();

    // �I���W�i���̃^�u�iDS keypad, Add-ons�j���폜����
    // ����ɂ��AInputConfigDialog.ui ���I���W�i���̂܂܂ł�MelonPrimeDS�ł͕\������Ȃ��Ȃ�܂�
