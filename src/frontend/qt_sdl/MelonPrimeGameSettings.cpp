...
namespace MelonPrime {
    ...
    {
        constexpr uint32_t BASE_VAL = 0x0999;
        constexpr uint32_t STEP_VAL = 0x0199;
        double val = static_cast<double>(BASE_VAL) + (sensiNum - 1.0) * static_cast<double>(STEP_VAL);
        return static_cast<uint16_t>(std::min(static_cast<uint32_t>(std::llround(val)), 0xFFFFu));
    }

    bool MelonPrimeGameSettings::ApplyHeadphoneOnce(melonDS::NDS* nds, Config::Table& localCfg, melonDS::u32 addr, uint8_t& flags, uint8_t bit)
    {
    ...
    bool MelonPrimeGameSettings::ApplyLicenseColorStrict(melonDS::NDS* nds, Config::Table& localCfg, melonDS::u32 addr)
    {
    ...
    bool MelonPrimeGameSettings::ApplySelectedHunterStrict(melonDS::NDS* nds, Config::Table& localCfg, melonDS::u32 addr)
    {
    ...
    bool MelonPrimeGameSettings::UseDsName(melonDS::NDS* nds, Config::Table& localCfg, melonDS::u32 addr)
    {
    ...
    bool MelonPrimeGameSettings::ApplySfxVolumeOnce(melonDS::NDS* nds, Config::Table& localCfg, melonDS::u32 addr, uint8_t& flags, uint8_t bit)
    {
    ...
    bool MelonPrimeGameSettings::ApplyMusicVolumeOnce(melonDS::NDS* nds, Config::Table& localCfg, melonDS::u32 addr, uint8_t& flags, uint8_t bit)
    {
    ...
    void MelonPrimeGameSettings::ApplyMphSensitivity(melonDS::NDS* nds, Config::Table& localCfg, melonDS::u32 addrSensi, melonDS::u32 addrInGame, bool inGameInit)
    {
    ...
    bool MelonPrimeGameSettings::ApplyUnlockHuntersMaps(melonDS::NDS* nds, Config::Table& localCfg, uint8_t& flags, uint8_t bit,
    ...
    melonDS::u32 MelonPrimeGameSettings::CalculatePlayerAddress(melonDS::u32 base, melonDS::u8 pos, int32_t inc)
    {
