...
namespace MelonPrime {
    ...
    uint16_t MelonPrimeGameSettings::SensiNumToSensiVal(double sensiNum)
    {
        ...
        // Fused Multiply-Add (FMA) might be generated by compiler here.

        // val + 0.5f followed by cast is a standard fast round for positive numbers.

        double val = BASE_VAL + (sensiNum - 1.0) * STEP_VAL;
