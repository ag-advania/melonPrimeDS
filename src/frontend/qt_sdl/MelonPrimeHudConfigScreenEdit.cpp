...
#include "MelonPrimeHudConfigScreenEdit.h"
...
MelonPrimeHudConfigScreenEdit::MelonPrimeHudConfigScreenEdit(QWidget* parent, EmuInstance* emu)
...
Config::Table& MelonPrimeHudConfigScreenEdit::cfg()
{
...
void MelonPrimeHudConfigScreenEdit::clearForm()
{
...
void MelonPrimeHudConfigScreenEdit::clear()
{
    clearForm();
    m_currentElem = -1;
    m_title->clear();
...
void MelonPrimeHudConfigScreenEdit::reloadValues()
{
    if (m_currentElem >= 0)
...
QCheckBox* MelonPrimeHudConfigScreenEdit::addCheckBox(const QString& label, const char* key)
{
...
QComboBox* MelonPrimeHudConfigScreenEdit::addComboBox(const QString& label, const char* key, const QStringList& items)
{
...
QSpinBox* MelonPrimeHudConfigScreenEdit::addSpinBox(const QString& label, const char* key, int min, int max)
{
...
QDoubleSpinBox* MelonPrimeHudConfigScreenEdit::addDoubleSpinBox(const QString& label, const char* key, double min, double max, double step)
{
...
QSlider* MelonPrimeHudConfigScreenEdit::addOpacitySlider(const QString& label, const char* key)
{
...
QLineEdit* MelonPrimeHudConfigScreenEdit::addLineEdit(const QString& label, const char* key)
{
...
QPushButton* MelonPrimeHudConfigScreenEdit::addColorPicker(const QString& label, const char* keyR, const char* keyG, const char* keyB)
{
...
void MelonPrimeHudConfigScreenEdit::addSubColor(const QString& label, const char* overallKey,
...
void MelonPrimeHudConfigScreenEdit::addColorOverlayRow(
...
void MelonPrimeHudConfigScreenEdit::addSeparator()
{
...
void MelonPrimeHudConfigScreenEdit::addOutlineGroup(const char* prefix)
{
...
void MelonPrimeHudConfigScreenEdit::addBuiltins(const char* showKey,
...
void MelonPrimeHudConfigScreenEdit::populateForElement(int idx)
{
    m_populating = true;
    clearForm();
    m_currentElem = idx;
...
void MelonPrimeHudConfigScreenEdit::populateHP()
{
    addBuiltins(nullptr,
...
void MelonPrimeHudConfigScreenEdit::populateHPGauge()
{
...
void MelonPrimeHudConfigScreenEdit::populateWeaponAmmo()
{
    addBuiltins(nullptr,
...
void MelonPrimeHudConfigScreenEdit::populateWpnIcon()
{
...
void MelonPrimeHudConfigScreenEdit::populateAmmoGauge()
{
...
void MelonPrimeHudConfigScreenEdit::populateMatchStatus()
{
...
void MelonPrimeHudConfigScreenEdit::populateRank()
{
...
void MelonPrimeHudConfigScreenEdit::populateTimeLeft()
{
...
void MelonPrimeHudConfigScreenEdit::populateTimeLimit()
{
...
void MelonPrimeHudConfigScreenEdit::populateBombLeft()
{
...
void MelonPrimeHudConfigScreenEdit::populateBombIcon()
{
...
void MelonPrimeHudConfigScreenEdit::populateRadar()
{
