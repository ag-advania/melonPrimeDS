...
inline QString SourcePropertyText(QWidget* widget, const char* propertyName, const QString& current)
{
    if (!widget)
        return current;
...
inline QStringList SourcePropertyTextList(QWidget* widget, const char* propertyName, const QStringList& current)
{
    if (!widget)
        return current;
...
inline QString SourceObjectPropertyText(QObject* object, const char* propertyName, const QString& current)
{
    if (!object)
        return current;
...
inline void LocalizeActionTextProperties(QAction* action)
{
    if (!action)
        return;
...
inline void SetLocalizedActionText(QAction* action, const QString& sourceText)
{
    if (!action)
        return;
...
inline void LocalizeAction(QAction* action);

inline void LocalizeMenu(QMenu* menu)
{
    if (!menu)
        return;
...
inline void LocalizeMenuBar(QMenuBar* menuBar)
{
    if (!menuBar)
        return;
