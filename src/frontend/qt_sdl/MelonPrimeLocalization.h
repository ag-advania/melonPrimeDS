...
inline constexpr Translation kTranslations[] = {
    ...
    {"Enable Direct Alt-Form Transform", "直接Altフォーム変形を有効化"},
    ...
    {"Checked: use the native ARM9 TransformRequest hook. Unchecked: use the older touch/menu simulation path.", "オン: ゲーム本来のARM9 TransformRequestフックを使います。オフ: 従来のタッチ/メニュー模擬処理を使います。"},
    ...
    {"Checked: toggle native weapon zoom by calling the game's SetPlayerScopeZoom setter. Unchecked with New Method also off: use Legacy fixed R-button input.", "オン: ゲーム本来のSetPlayerScopeZoom setterを呼んで武器ズームを切り替えます。新方式もオフの場合は、旧式の固定Rボタン入力を使います。"},
    ...
    {"HP Label Color By Value", "HPラベル色 (値連動)"},
    {"HP Outline", "HPアウトライン"},
    {"HP Gauge", "HPゲージ"},
    {"HP Gauge Color By Value", "HPゲージ色 (値連動)"},
    {"HP Gauge Outline", "HPゲージアウトライン"},
    {"Ammo", "弾薬"},
    {"Ammo Number Position", "弾薬数値位置"},
    {"Ammo Label Color By Value", "弾薬ラベル色 (値連動)"},
    {"Ammo Outline", "弾薬アウトライン"},
    {"Ammo Gauge", "弾薬ゲージ"},
    {"Ammo Gauge Color By Value", "弾薬ゲージ色 (値連動)"},
    {"Ammo Gauge Outline", "弾薬ゲージアウトライン"},
    {"Weapon/Ammo", "武器/弾薬"},
    {"Weapon Icon", "武器アイコン"},
    {"Weapon Icon Outline", "武器アイコンアウトライン"},
    {"Weapon Icon Color Overlay", "武器アイコン色オーバーレイ"},
    {"Weapon Inventory", "武器インベントリ"},
    {"Weapon Inventory Highlight", "武器インベントリハイライト"},
    {"Weapon Inventory Outline", "武器インベントリアウトライン"},
    {"Weapon Inventory Icon Outline", "武器インベントリアイコンアウトライン"},
    {"Match Status", "試合情報"},
    {"Score", "スコア"},
    {"Score Outline", "スコアアウトライン"},
    {"Rank / Time", "順位 / 時間"},
    {"Rank", "順位"},
    {"Rank Outline", "順位アウトライン"},
    {"Time Left", "残り時間"},
    {"Time Left Outline", "残り時間アウトライン"},
    {"Time Limit", "制限時間"},
    {"Time Limit Outline", "制限時間アウトライン"},
    {"Bomb", "ボム"},
    {"Bomb Left", "残りボム"},
    {"Bomb Left Outline", "残りボムアウトライン"},
    {"Bomb Icon", "ボムアイコン"},
    {"Bomb Icon Outline", "ボムアイコンアウトライン"},
    {"Radar", "レーダー"},
    {"Radar Settings", "レーダー設定"},
    {"Radar Outline", "レーダーアウトライン"},
    {"Frame Outline", "フレームアウトライン"},
    {"Crosshair", "照準"},
    {"Wpn\nIcon", "武器\nアイコン"},
    {"Bmb\nIcon", "ボム\nアイコン"},
    {"Wpn\nInventory", "武器\n一覧"},
    ...
    {"Orange", "オレンジ"},
    {"Samus Hud", "サムスHUD"},
    {"Samus Hud Outline", "サムスHUDアウトライン"},
    {"Kanden Hud", "カンデンHUD"},
    {"Spire Hud", "スパイアHUD"},
    {"Spire Hud Outline", "スパイアHUDアウトライン"},
    {"Trace Hud", "トレースHUD"},
    {"Noxus Hud", "ノクサスHUD"},
    {"Noxus Hud Outline", "ノクサスHUDアウトライン"},
    {"Sylux Hud", "サイラックスHUD"},
    {"Sylux Crosshair", "サイラックス照準"},
    {"Weavel Hud", "ウィーヴェルHUD"},
    {"Weavel Hud Outline", "ウィーヴェルHUDアウトライン"},
    {"Avium Purple", "アヴィウム紫"},
    ...
    {"Use New Method for Alt-Form Transform", "Altフォーム変形に新方式を使う"},
    {"Use New Method for Zoom", "ズームに新方式を使う"},
    {"Use New Method 2 for Zoom", "ズームに新方式2を使う"},
};

inline constexpr ObjectTextTranslation kObjectTextTranslations[] = {
    {
    ...
    },
    {
        ...
        "Instant Aim Followは、ゲーム本来の照準追従処理をパッチして currentAim を targetAim へ即座にコピーします。Immediate Syncは低遅延ARM9フックで currentAim を targetAim に同期し、照準基準を再構築します。MoonLike Aimは小さなエイム移動を即時反映し、大きなジャンプだけ最大ステップ付きで追従します。Disable Aim Smoothingが必要です。"
    },
    {
        "lblMetroidNativeAimHookModeDesc",
        "PostFold WriteはTouchInputProcessorの後でフックし、spec108=0 (Samus/Kanden/Noxus/Spire) を含むすべてのAltフォームをカバーします。開発者ビルド専用です。"
    },
    {
        "lblMetroidDirectAltFormTransformDesc",
        "新方式は短いネイティブ入力ゲートをゲーム本来のTransformRequest処理へリダイレクトします。旧方式は従来のタッチ/メニュー模擬による変形処理を使います。"
    },
    {
    ...
    },
    {
        ...
        "Ice Waveの最後の命中/ミス角度判定を、元の横方向範囲チェックは保ったまま完全な3D判定へ置き換えて、Shadow Freeze問題を修正します。"
    },
    {
        "lblMetroidFixNoxusBladePersistenceDesc",
        "NoxusのVhoscythe/ブレード攻撃が死亡とリスポーン後もダメージを与え続ける不具合を修正します。ブレード攻撃中にNoxusが死亡するとAlt攻撃タイマーがクリアされず、復活後もブレードの当たり判定が残ります。この修正では死亡した瞬間にタイマーをクリアします。"
    },
    {
...
<b>KR ROM:</b> まだ未対応です。
    ...
    },
    {
        ...
        "Wi-Fi/オンライン対戦中でも、単独のHEADSHOT通知を強制的に表示します。"
    },
    {
...
<b>Bounty</b><br>
&nbsp;&nbsp;Fuel Stack — Octolithあり、アイテムあり<br>
&nbsp;&nbsp;Alinos Gateway — Octolithあり、坂の下に得意武器が出現<br><br>
<b>Capture</b><br>
&nbsp;&nbsp;Celestial Gateway — Octolithあり、ジャンパーとアイテムあり<br><br>
<b>Defender</b><br>
&nbsp;&nbsp;High Ground — アイテムあり、Magmaulエリア左下にディフェンダーゾーンリング<br>
&nbsp;&nbsp;Elder Passage — アイテムあり、Magmaulエリア左下にディフェンダーゾーンリング
</body></html>)"
    },
    {
...
<b>Defender</b><br>
&nbsp;&nbsp;Transfer Lock — ディフェンダーリングなし、Volt Driver + Battlehammerのみ<br>
&nbsp;&nbsp;Compressor Room — ディフェンダーリングなし、ジャンパーなし、アイテムなし<br>
&nbsp;&nbsp;Incubator — ディフェンダーリングなし、アイテムとジャンパーあり<br>
&nbsp;&nbsp;Fuel Stack — ディフェンダーリングなし、浮遊なし、Imperialistのみ<br>
&nbsp;&nbsp;Head Shot — ディフェンダーリングなし、通常重力、ジャンパー2個、Altフォーム通路は射出なし
</body></html>)"
    },
    {
        "lblMetroidDisableDoubleDamageMultiplierDesc",
        R"(<html><body>
Double Damageの取得、タイマー、HUD、サウンド、視覚効果はそのままに、ダメージ倍率だけを2xから1xへ変更します。<br><br>
<font color="red"><b>重要:</b> 2x → 1xの変更は<b>自分側</b>にだけ適用されます。相手側もDamage 1xを有効にしていない場合、Double Damage中の自分の弾は相手には2xダメージとして扱われます。</font><br><br>
参加者全員の同意がある場合にだけ使用してください。
    ...
    },
    {
        ...
        R"(<html><body>
ダメージを受けたときに短時間だけDouble Damageの紫状態で点滅させ、相手から被弾が見えるようにします。<br><br>
<font color="red"><b>重要:</b> これは実際のDouble Damageタイマーを書き込むため、短い間だけ本当に<b>Double Damage状態に入ります</b>。その間、自分の弾は相手にも2xダメージを与えます。これを避けるには相手側もDamage 1xを有効にする必要があります。</font><br><br>
<b>対戦で使う前に、必ず参加者全員の同意を取ってください。</b> 自分のダメージを1xに保つには、上の「ダブルダメージ倍率を無効化」と組み合わせてください。
</body></html>)"
    },
    {
        "lblMetroidDisablePickingUpSpecificItemsDesc",
        "有効にすると、選択したパワーアップは取得されて消えますが、プレイヤー側の効果はスキップされます。Double Damage、Cloak、DEATH ALTのタイマー、フラグ、HUD、サウンド、視覚効果は適用されません。この設定が影響するのは自分とボットだけで、オンラインの相手は変更されません。"
    },
    {
    ...
    },
    {
        ...
        "最小遅延のため、エイム呼び出し地点でフックします。二足状態と spec108=1 のAltフォーム (Trace/Sylux/Weavel) をカバーします。有効にすると、上のNative Aim Delta Hook (PostFold Write) より優先されます。"
    },
    {
    ...
    },
    {
        ...
        "オンにすると、ARM9フック経由でゲーム本来のTryEquipWeapon処理を使います。オフでは互換性テスト用に、従来のタッチ/メニュー模擬による武器切替を使います。"
    },
    {
        "lblMetroidBipedFireMethodDesc",
        "オンにすると、ゲーム本来の二足射撃エッジフックで fire input-helper の結果をtrueにし、元のクールダウン、弾薬、弾生成、HUD、SFX経路を自然に動かします。Legacy Methodでは従来のDS入力/ImmediateInputEdgeOverlay射撃経路を使います。"
    },
    {
        "lblMetroidZoomMethodDesc",
        "New Methodはゲーム内のズーム割り当て表を読むため、Touch/Dualプリセットごとに異なるDSボタンへズームを割り当てられます。Legacy Methodより少し低遅延です。両方のチェックを外すと、従来の入力経路と同じく固定Rボタンを使うLegacy Methodになります。"
    },
    {
        "lblMetroidZoomMethod2Desc",
        "New Method 2は、押すたびにSetPlayerScopeZoomを通じてゲーム本来のズーム状態を切り替えます。New Method for Zoomとは同時に使えません。"
    },
};

inline QString TranslateExact(const QString& text)
{
...
inline QString TranslateByObjectName(const QWidget* widget, const QString& text)
{
...
inline QString TrWidgetText(const QWidget* widget, const QString& text)
{
    if (!IsJapaneseLocale() || text.isEmpty())
        return text;
...
inline QString Tr(const char* text, int size)
{
    return Tr(QString::fromUtf8(text, size));
}

inline QStringList TrList(const QStringList& items)
{
    if (!IsJapaneseLocale())
        return items;
...
inline void LocalizeWidgetTextProperties(QWidget* widget)
{
    if (!widget)
        return;
    ...
    if (!windowTitle.isEmpty())
        widget->setWindowTitle(TrWidgetText(widget, windowTitle));

    const QString toolTip = widget->toolTip();
    if (!toolTip.isEmpty())
        widget->setToolTip(TrWidgetText(widget, toolTip));

    const QString whatsThis = widget->whatsThis();
    if (!whatsThis.isEmpty())
        widget->setWhatsThis(TrWidgetText(widget, whatsThis));

    const QString statusTip = widget->statusTip();
    if (!statusTip.isEmpty())
        widget->setStatusTip(TrWidgetText(widget, statusTip));
}

inline void LocalizeWidgetTree(QWidget* root)
{
    if (!IsJapaneseLocale() || !root)
        return;
    ...
    for (QTabWidget* tabs : root->findChildren<QTabWidget*>())
    {
        for (int i = 0; i < tabs->count(); ++i)
            tabs->setTabText(i, Tr(tabs->tabText(i)));
    ...
    for (QLineEdit* lineEdit : root->findChildren<QLineEdit*>())
    {
        ...
        if (!placeholder.isEmpty())
            lineEdit->setPlaceholderText(TrWidgetText(lineEdit, placeholder));
    ...
    for (QPlainTextEdit* textEdit : root->findChildren<QPlainTextEdit*>())
    {
        ...
        if (!placeholder.isEmpty())
            textEdit->setPlaceholderText(TrWidgetText(textEdit, placeholder));
