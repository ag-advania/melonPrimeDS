...
void MelonPrimeHudConfigOnScreenEdit::populateForElement(int idx)
{
    ...
    case 15: populateEnemyTarget(); break;
    }
...
void MelonPrimeHudConfigOnScreenEdit::populateEnemyTarget()
{
    populateFromRowTable(kRowsEnemyTarget, MP_SIDE_ROW_COUNT(kRowsEnemyTarget));
}
