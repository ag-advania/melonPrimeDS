...
// MELONPRIME-PC-ADAPT: Android native_window.h has no PC equivalent; HWND passed as void* to avoid windows.h in header
#include <memory>
#include <string>
#include <utility>
...
public:
    ...
    // MELONPRIME-PC-ADAPT: ANativeWindow* -> void* (HWND) for Win32 surface creation
...
private:
    ...
    {
        int id = 0;
        // MELONPRIME-PC-ADAPT: ANativeWindow* -> void* (HWND); presenter does not own the window
        void* window = nullptr;
