...
constexpr Translation kTranslations[] = {
    ...
    {"Off", "ãªã", "Aus", "Off", "Off", "Off", "Off", "Off", "Выкл.", "关闭", "꺼짐", "إيقاف", "Mati", "Вимк.", "Ανεν.", "Av", "ปิด", "Vyp.", "Fra", "Kapalı", "Av", "Ki", "Pois", "Tắt", "Wył.", "Opr."},
    {"Save", "ä¿å­", "Speichern", "Guardar", "Enregistrer", "Salva", "Opslaan", "Guardar", "Сохранить", "保存", "저장", "حفظ", "Simpan", "Зберегти", "Αποθήκευση", "Spara", "บันทึก", "Uložit", "Gem", "Kaydet", "Lagre", "Mentés", "Tallenna", "Lưu", "Zapisz", "Salvare"},
    ...
    {"Chng", "å¤æ´", "Änd.", "Camb.", "Mod.", "Mod.", "Wijz.", "Alt.", "Изм.", "更改", "변경", "تغ.", "Ubh.", "Зм.", "Αλλ.", "Änd.", "เปล.", "Zm.", "Ænd.", "Değ.", "End.", "Módos.", "Muut.", "Đổi", "Zm.", "Mod."},
    {"OVR", "å¨ä½", "Ges.", "Gral.", "Gén.", "Gen.", "Alg.", "Geral", "Общ.", "总体", "전체", "إجمالي", "Umum", "Заг.", "Γεν.", "Allm.", "รวม", "Celk.", "Samlet", "Gen.", "Tot.", "Össz.", "Kok.", "Tổng", "Ogół.", "Gen."},
    ...
    {"Preview ON", "ãã¬ãã¥ã¼ON", "Vorschau ON", "Vista previa ON", "Aperçu ON", "Anteprima ON", "Voorbeeld ON", "Pré-visualização ON", "Предпросмотр ON", "预览 ON", "미리보기 ON", "معاينة ON", "Pratinjau ON", "Попередній перегляд ON", "Προεπισκόπηση ON", "Förhandsvisning ON", "ตัวอย่าง ON", "Náhled ON", "Forhåndsvisning ON", "Önizleme ON", "Forhåndsvisning ON", "Előnézet ON", "Esikatselu ON", "Xem trước ON", "Podgląd ON", "Previzualizare ON"},
    {"preview", "ãã¬ãã¥ã¼", "Vorschau", "vista previa", "aperçu", "anteprima", "voorbeeld", "visualização", "предпросмотр", "预览", "미리보기", "معاينة", "pratinjau", "попередній перегляд", "προεπισκόπηση", "förhandsgranskning", "ตัวอย่าง", "náhled", "forhåndsvisning", "önizleme", "forhåndsvisning", "előnézet", "esikatselu", "xem trước", "podgląd", "previzualizare"},
    {"Normal", "æ¨æº", "Standard", "Estándar", "Standard", "Standard", "Standaard", "Padrão", "Стандартный", "标准", "표준", "عادي", "Normal", "Стандартний", "Κανονικό", "Normal", "ปกติ", "Normální", "Normal", "Normal", "Normal", "Normál", "Normaali", "Bình thường", "Normalny", "Normal"},
    {"Zoomed (Scope)", "ãºã¼ã æ (ã¹ã³ã¼ã)", "Gezoomt (Visier)", "Con zoom (mira)", "Zoom (viseur)", "Zoom (mirino)", "Ingezoomd (vizier)", "Com zoom (mira)", "С увеличением (прицел)", "缩放时（准星）", "확대 시 (스코프)", "مكبّر (منظار)", "Diperbesar (Scope)", "Збільшено (приціл)", "Με ζουμ (σκόπευτήρας)", "Inzoomad (sikte)", "ซูม (สโคป)", "Přiblíženo (zaměřovač)", "Zoom (sigte)", "Yakınlaştırılmış (nişangah)", "Innzoomet (sikte)", "Nagyítva (távcső)", "Zoomattu (tähtäin)", "Phóng to (Scope)", "Powiększenie (celownik)", "Zoom (lunetă)"},
    ...
    {"Text", "æå­", "Text", "Texto", "Texte", "Testo", "Tekst", "Texto", "Текст", "文字", "텍스트", "نص", "Teks", "Текст", "Κείμενο", "Text", "ข้อความ", "Text", "Tekst", "Metin", "Tekst", "Szöveg", "Teksti", "Văn bản", "Tekst", "Text"},
    {"Auto", "èªå", "Automatisch", "Automático", "Auto", "Auto", "Auto", "Auto", "Авто", "自动", "자동", "تلقائي", "Auto", "Авто", "Αυτόματο", "Auto", "อัตโนมัติ", "Auto", "Auto", "Otomatik", "Auto", "Auto", "Auto", "Tự động", "Auto", "Auto"},
    {"Overall", "å¨ä½", "Gesamt", "General", "Global", "Generale", "Algemeen", "Geral", "Общий", "整体", "전체", "إجمالي", "Keseluruhan", "Загальний", "Συνολικό", "Övergripande", "โดยรวม", "Celkové", "Samlet", "Genel", "Samlet", "Összesített", "Kokonais", "Tổng thể", "Ogólny", "General"},
    {"Custom", "ã«ã¹ã¿ã ", "Benutzerdefiniert", "Personalizado", "Personnalisé", "Personalizzato", "Aangepast", "Personalizado", "Пользовательский", "自定义", "사용자 지정", "مخصص", "Kustom", "Користувацький", "Προσαρμοσμένο", "Anpassad", "กำหนดเอง", "Vlastní", "Brugerdefineret", "Özel", "Tilpasset", "Egyéni", "Mukautettu", "Tùy chỉnh", "Niestandardowy", "Personalizat"},
    ...
    {"English", "è±èª", "Englisch", "Inglés", "Anglais", "Inglese", "Engels", "Inglês", "Английский", "英语", "영어", "الإنجليزية", "Inggris", "Англійська", "Αγγλικά", "Engelska", "อังกฤษ", "Angličtina", "Engelsk", "İngilizce", "Engelsk", "Angol", "Englanti", "Tiếng Anh", "Angielski", "Engleză"},
    {"German", "ãã¤ãèª", "Deutsch", "Alemán", "Allemand", "Tedesco", "Duits", "Alemão", "Немецкий", "德语", "독일어", "الألمانية", "Jerman", "Німецька", "Γερμανικά", "Tyska", "เยอรมัน", "Němčina", "Tysk", "Almanca", "Tysk", "Német", "Saksa", "Tiếng Đức", "Niemiecki", "Germană"},
    {"Spanish", "ã¹ãã¤ã³èª", "Spanisch", "Español", "Espagnol", "Spagnolo", "Spaans", "Espanhol", "Испанский", "西班牙语", "스페인어", "الإسبانية", "Spanyol", "Іспанська", "Ισπανικά", "Spanska", "สเปน", "Španělština", "Spansk", "İspanyolca", "Spansk", "Spanyol", "Espanja", "Tiếng Tây Ban Nha", "Hiszpański", "Spaniolă"},
    {"French", "ãã©ã³ã¹èª", "Französisch", "Francés", "Français", "Francese", "Frans", "Francês", "Французский", "法语", "프랑스어", "Français", "Prancis", "Французька", "Γαλλικά", "Franska", "ฝรั่งเศส", "Francouzština", "Fransk", "Fransızca", "Fransk", "Francia", "Ranska", "Pháp", "Francuski", "Franceză"},
    {"Italian", "Italiană", "Italienisch", "Italiano", "Italien", "Italiano", "Italiaans", "Italiano", "Итальянский", "意大利语", "이탈리아어", "الإيطالية", "Italia", "Італійська", "Ιταλικά", "Italienska", "ภาษาอิตาลี", "Italština", "Italiensk", "İtalyanca", "Italiensk", "Olasz", "Italia", "Tiếng Ý", "Włoski", "Italiană"},
    ...
    {"Chinese", "Chineză", "Chinesisch", "Chino", "Chinois", "Cinese", "Chinees", "Chinês", "Китайский", "中文", "중국어", "الصينية", "Tionghoa", "Китайська", "Κινεζικά", "Kinesiska", "จีน", "Čínština", "Kinesisk", "Çince", "Kinesisk", "Kínai", "Kiina", "Tiếng Trung", "Chiński", "Chineză"},
    ...
    // Main menu bar
    {"File", "ãã¡ã¤ã«", "Datei", "Archivo", "Fichier", "File", "Bestand", "Arquivo", "Файл", "文件", "파일", "ملف", "File", "Файл", "Αρχείο", "Fil", "ไฟล์", "Soubor", "Fil", "Dosya", "Fil", "Fájl", "Tiedosto", "Tệp", "Plik", "Fișier"},
    {"Open ROM...", "ROMãéã...", "ROM öffnen...", "Abrir ROM...", "Ouvrir une ROM...", "Apri ROM...", "ROM openen...", "Abrir ROM...", "Открыть ROM...", "打开 ROM...", "ROM 열기...", "فتح ROM...", "Buka ROM...", "Відкрити ROM...", "Άνοιγμα ROM...", "Öppna ROM...", "เปิด ROM...", "Otevřít ROM...", "Åbn ROM...", "ROM aç...", "Åpne ROM...", "ROM megnyitása...", "Avaa ROM...", "Mở ROM...", "Otwórz ROM...", "Deschide ROM..."},
    {"File->Open ROM...", "ãã¡ã¤ã« â ROMãéã...", "Datei → ROM öffnen...", "Archivo → Abrir ROM...", "Fichier → Ouvrir une ROM...", "File → Apri ROM...", "Bestand → ROM openen...", "Arquivo → Abrir ROM...", "Файл → Открыть ROM...", "文件 → 打开 ROM...", "파일 → ROM 열기...", "ملف → فتح ROM...", "File → Buka ROM...", "Файл → Відкрити ROM...", "Αρχείο → Άνοιγμα ROM...", "Arkiv → Öppna ROM...", "ไฟล์ → เปิด ROM...", "Soubor → Otevřít ROM...", "Fil → Åbn ROM...", "Dosya → ROM aç...", "Fil → Åpne ROM...", "Fájl → ROM megnyitása...", "Tiedosto → Avaa ROM...", "Tệp → Mở ROM...", "Plik → Otwórz ROM...", "Fișier → Deschide ROM..."},
    ...
    {"System", "ã·ã¹ãã ", "System", "Sistema", "Système", "Sistema", "Systeem", "Sistema", "Система", "系统", "시스템", "النظام", "Sistem", "Система", "Σύστημα", "System", "ระบบ", "Systém", "System", "Sistem", "System", "Rendszer", "Järjestelmä", "Hệ thống", "System", "Sistem"},
    {"Pause", "ä¸æåæ­¢", "Pause", "Pausa", "Pause", "Pausa", "Pauze", "Pausa", "Пауза", "暂停", "일시정지", "إيقاف مؤقت", "Jeda", "Пауза", "Παύση", "Paus", "หยุดชั่วคราว", "Pauza", "Pause", "Duraklat", "Pause", "Szünet", "Tauko", "Tạm dừng", "Pauza", "Pauză"},
    {"Stop", "åæ­¢", "Stopp", "Detener", "Arrêter", "Stop", "Stop", "Parar", "Стоп", "停止", "정지", "إيقاف", "Berhenti", "Стоп", "Διακοπή", "Stopp", "หยุด", "Stop", "Stop", "Durdur", "Stopp", "Leállítás", "Pysäytä", "Dừng", "Stop", "Stop"},
    {"Frame step", "ãã¬ã¼ã éã", "Frame-Schritt", "Avance de fotograma", "Avance image par image", "Avanzamento fotogramma", "Frame-stap", "Avanço de quadro", "Пошаговый кадр", "逐帧前进", "프레임 단위 진행", "تقدم إطار", "Langkah frame", "Крок кадру", "Βήμα καρέ", "Bildsteg", "ขั้นเฟรม", "Krok snímku", "Billedtrin", "Kare adımı", "Bildesteg", "Képkocka léptetés", "Ruudun askel", "Bước khung hình", "Krok klatki", "Pas cadru"},
    ...
    {"Date and time", "æ¥ä»ã¨æå»", "Datum und Uhrzeit", "Fecha y hora", "Date et heure", "Data e ora", "Datum en tijd", "Data e hora", "Дата и время", "日期和时间", "날짜 및 시간", "التاريخ والوقت", "Tanggal dan waktu", "Дата і час", "Ημερομηνία και ώρα", "Datum och tid", "วันที่และเวลา", "Datum a čas", "Dato og tid", "Tarih ve saat", "Dato og tid", "Dátum és idő", "Päivämäärä ja aika", "Ngày và giờ", "Data i godzina", "Dată și oră"},
    {"Enable cheats", "ãã¼ããæå¹å", "Cheats aktivieren", "Activar trucos", "Activer les triches", "Attiva cheat", "Cheats inschakelen", "Ativar trapaças", "Включить читы", "启用作弊码", "치트 활성화", "تفعيل الغش", "Aktifkan cheat", "Увімкнути чити", "Ενεργοποίηση cheat", "Aktivera fusk", "เปิดใช้ cheat", "Povolit cheaty", "Aktivér snydekoder", "Hileleri etkinleştir", "Aktiver juks", "Cheat engedélyezése", "Ota huijaukset käyttöön", "Bật cheat", "Włącz kody", "Activează cheat-uri"},
    {"Setup cheat codes", "ãã¼ãã³ã¼ãè¨­å®", "Cheat-Codes einrichten", "Configurar códigos de trucos", "Configurer les codes triche", "Configura codici trucchi", "Cheatcodes instellen", "Configurar códigos de trapaça", "Настроить чит-коды", "设置作弊码", "치트 코드 설정", "إعداد أكواد الغش", "Atur kode cheat", "Налаштувати чит-коди", "Ρύθμιση κωδικών cheat", "Konfigurera fuskoder", "ตั้งค่ารหัส cheat", "Nastavit cheat kódy", "Konfigurer snydekoder", "Hile kodlarını ayarla", "Sett opp juksekoder", "Csalókódok beállítása", "Määritä huijauskoodit", "Thiết lập mã cheat", "Skonfiguruj kody oszustw", "Configurează coduri cheat"},
    {"ROM info", "ROMæå ±", "ROM-Info", "Info de ROM", "Infos ROM", "Info ROM", "ROM-info", "Info da ROM", "Сведения о ROM", "ROM 信息", "ROM 정보", "معلومات ROM", "Info ROM", "Інфо ROM", "Πληροφορίες ROM", "ROM-info", "ข้อมูล ROM", "Info ROM", "ROM-info", "ROM bilgisi", "ROM-info", "ROM infó", "ROM-tiedot", "Thông tin ROM", "Info ROM", "Info ROM"},
    ...
    {"View", "è¡¨ç¤º", "Ansicht", "Ver", "Affichage", "Visualizza", "Beeld", "Exibir", "Вид", "视图", "보기", "عرض", "Tampilan", "Вигляд", "Προβολή", "Visa", "มุมมอง", "Zobrazení", "Visning", "Görünüm", "Visning", "Nézet", "Näkymä", "Xem", "Widok", "Afișare"},
    {"Screen size", "ç»é¢ãµã¤ãº", "Bildschirmgröße", "Tamaño de pantalla", "Taille de l'écran", "Dimensione schermo", "Schermgrootte", "Tamanho da tela", "Размер экрана", "画面大小", "화면 크기", "حجم الشاشة", "Ukuran layar", "Розмір екрана", "Μέγεθος οθόνης", "Skärmstorlek", "ขนาดหน้าจอ", "Velikost obrazovky", "Skærmstørrelse", "Ekran boyutu", "Skjermstørrelse", "Képernyőméret", "Näytön koko", "Kích thước màn hình", "Rozmiar ekranu", "Dimensiune ecran"},
    {"Screen rotation", "ç»é¢åè»¢", "Bildschirmdrehung", "Rotación de pantalla", "Rotation de l'écran", "Rotazione schermo", "Schermrotatie", "Rotação de tela", "Поворот экрана", "屏幕旋转", "화면 회전", "دوران الشاشة", "Rotasi layar", "Обертання екрана", "Περιστροφή οθόνης", "Skärmrotation", "หมุนหน้าจอ", "Otočení obrazovky", "Skærmrotation", "Ekran döndürme", "Skjermrotasjon", "Képernyő forgatás", "Näytön kierto", "Xoay màn hình", "Obrót ekranu", "Rotație ecran"},
    {"Screen gap", "ç»é¢éé", "Bildschirmabstand", "Separación de pantallas", "Espacement des écrans", "Spazio tra schermi", "Schermafstand", "Espaço entre telas", "Зазор между экранами", "屏幕间距", "화면 간격", "فجوة الشاشة", "Jarak layar", "Зазор між екранами", "Κενό οθόνης", "Skärmavstånd", "ช่องว่างหน้าจอ", "Mezera obrazovek", "Skærmafstand", "Ekran aralığı", "Skjermavstand", "Képernyőrés", "Näyttöväli", "Khoảng cách màn hình", "Odstęp ekranów", "Spațiu ecran"},
    ...
    {"Natural", "èªç¶", "Natürlich", "Natural", "Naturel", "Naturale", "Natuurlijk", "Natural", "Естественный", "自然", "자연", "طبيعي", "Alami", "Природний", "Φυσικό", "Naturlig", "ธรรมชาติ", "Přirozené", "Naturlig", "Doğal", "Naturlig", "Természetes", "Luonnollinen", "Tự nhiên", "Naturalny", "Natural"},
    {"Vertical", "ç¸¦", "Vertikal", "Vertical", "Vertical", "Verticale", "Verticaal", "Vertical", "Вертикально", "纵向", "세로", "عمودي", "Vertikal", "Вертикальний", "Κάθετο", "Vertikal", "แนวตั้ง", "Vertikální", "Vertikal", "Dikey", "Vertikal", "Függőleges", "Pysty", "Dọc", "Pionowy", "Vertical"},
    {"Horizontal", "æ¨ª", "Horizontal", "Horizontal", "Horizontal", "Orizzontale", "Horizontaal", "Horizontal", "Горизонтально", "横向", "가로", "أفقي", "Horizontal", "Горизонтально", "Οριζόντια", "Horisontell", "แนวนอน", "Horizontální", "Horisontal", "Yatay", "Horisontal", "Vízszintes", "Vaaka", "Ngang", "Poziomo", "Orizontal"},
    {"Hybrid", "ãã¤ããªãã", "Hybrid", "Híbrido", "Hybride", "Ibrido", "Hybride", "Híbrido", "Гибридный", "混合", "하이브리드", "هجين", "Hibrida", "Гібридний", "Υβριδικό", "Hybrid", "ไฮบริด", "Hybridní", "Hybrid", "Hibrit", "Hybrid", "Hibrid", "Hybridi", "Lai ghép", "Hybrydowy", "Hibrid"},
    ...
    {"Show OSD", "OSDãè¡¨ç¤º", "OSD anzeigen", "Mostrar OSD", "Afficher l'OSD", "Mostra OSD", "OSD weergeven", "Mostrar OSD", "Показывать OSD", "显示 OSD", "OSD 표시", "إظهار OSD", "Tampilkan OSD", "Показати OSD", "Εμφάνιση OSD", "Visa OSD", "แสดง OSD", "Zobrazit OSD", "Vis OSD", "OSD göster", "Vis OSD", "OSD megjelenítése", "Näytä OSD", "Hiện OSD", "Pokaż OSD", "Afișează OSD"},
    {"Config", "è¨­å®", "Konfiguration", "Configuración", "Configuration", "Configurazione", "Configuratie", "Configuração", "Настройки", "设定", "설정", "إعدادات", "Konfigurasi", "Конфігурація", "Ρυθμίσεις", "Konfiguration", "การตั้งค่า", "Konfigurace", "Konfiguration", "Yapılandırma", "Konfigurasjon", "Beállítások", "Asetukset", "Cấu hình", "Konfiguracja", "Configurare"},
    {"Emu settings", "ã¨ãã¥ã¬ã¼ã¿ã¼è¨­å®", "Emulator-Einstellungen", "Ajustes del emulador", "Paramètres de l'émulateur", "Impostazioni emulatore", "Emulatorinstellingen", "Configurações do emulador", "Настройки эмулятора", "模拟器设置", "에뮬레이터 설정", "إعدادات المحاكي", "Pengaturan emu", "Налаштування емулятора", "Ρυθμίσεις εξομοιωτή", "Emulatorinställningar", "การตั้งค่า emu", "Nastavení emulátoru", "Emulatorindstillinger", "Emülatör ayarları", "Emulatorinnstillinger", "Emulátor beállítások", "Emulaattorin asetukset", "Cài đặt emu", "Ustawienia emulatora", "Setări emulator"},
    {"Preferences...", "ç°å¢è¨­å®...", "Einstellungen...", "Preferencias...", "Préférences...", "Preferenze...", "Voorkeuren...", "Preferências...", "Настройки...", "偏好设置...", "환경 설정...", "التفضيلات...", "Preferensi...", "Налаштування...", "Προτιμήσεις...", "Inställningar...", "การตั้งค่า...", "Předvolby...", "Indstillinger...", "Tercihler...", "Innstillinger...", "Beállítások...", "Asetukset...", "Tùy chọn...", "Preferencje...", "Preferințe..."},
    ...
    {"Disable SF (Shadow Freeze)", "SF (ã·ã£ãã¦ããªã¼ãº) ãç¡å¹å", "SF (Shadow Freeze) deaktivieren", "Desactivar SF (Shadow Freeze)", "Désactiver SF (Shadow Freeze)", "Disabilita SF (Shadow Freeze)", "SF (Shadow Freeze) uitschakelen", "Desativar SF (Shadow Freeze)", "Отключить SF (Shadow Freeze)", "禁用 SF (Shadow Freeze)", "SF (Shadow Freeze) 비활성화", "تعطيل SF (Shadow Freeze)", "Nonaktifkan SF (Shadow Freeze)", "Вимкнути SF (Shadow Freeze)", "Απενεργοποίηση SF (Shadow Freeze)", "Inaktivera SF (Shadow Freeze)", "ปิด SF (Shadow Freeze)", "Zakázat SF (Shadow Freeze)", "Deaktiver SF (Shadow Freeze)", "SF'yi devre dışı bırak (Shadow Freeze)", "Deaktiver SF (Shadow Freeze)", "SF (Shadow Freeze) letiltása", "Poista SF (Shadow Freeze) käytöstä", "Tắt SF (Shadow Freeze)", "Wyłącz SF (Shadow Freeze)", "Dezactivează SF (Shadow Freeze)"},
    {"In-Game Top Screen Only", "ã²ã¼ã ä¸­ã¯ä¸ç»é¢ã®ã¿", "Nur oberer Bildschirm im Spiel", "Solo pantalla superior en juego", "Écran supérieur uniquement en jeu", "Solo schermo superiore in gioco", "Alleen bovenste scherm in spel", "Somente tela superior no jogo", "Только верхний экран в игре", "游戏中仅上屏", "게임 중 상단 화면만", "الشاشة العلوية في اللعبة فقط", "Hanya layar atas dalam game", "Лише верхній екран у грі", "Μόνο επάνω οθόνη στο παιχνίδι", "Endast övre skärm i spel", "เฉพาะหน้าจอบนในเกม", "Pouze horní obrazovka ve hře", "Kun øverste skærm i spil", "Oyunda yalnızca üst ekran", "Kun øvre skjerm i spill", "Csak felső képernyő játékban", "Vain ylänäyttö pelissä", "Chỉ màn hình trên trong game", "Tylko górny ekran w grze", "Doar ecran superior în joc"},
    {"Help", "ãã«ã", "Hilfe", "Ayuda", "Aide", "Aiuto", "Help", "Ajuda", "Справка", "帮助", "도움말", "مساعدة", "Bantuan", "Довідка", "Βοήθεια", "Hjälp", "ความช่วยเหลือ", "Nápověda", "Hjælp", "Yardım", "Hjelp", "Súgó", "Ohje", "Trợ giúp", "Pomoc", "Ajutor"},
    {"About...", "ãã®ã¢ããªã«ã¤ãã¦...", "Über...", "Acerca de...", "À propos...", "Informazioni...", "Over...", "Sobre...", "О программе...", "关于...", "정보...", "حول...", "Tentang...", "Про програму...", "Σχετικά...", "Om...", "เกี่ยวกับ...", "O programu...", "Om...", "Hakkında...", "Om...", "Névjegy...", "Tietoja...", "Giới thiệu...", "O programie...", "Despre..."},
    ...
    {"MelonPrime Settings", "MelonPrimeè¨­å®", "MelonPrime-Einstellungen", "Ajustes de MelonPrime", "Paramètres MelonPrime", "Impostazioni MelonPrime", "MelonPrime-instellingen", "Configurações do MelonPrime", "Настройки MelonPrime", "MelonPrime 设置", "MelonPrime 설정", "إعدادات MelonPrime", "Pengaturan MelonPrime", "Налаштування MelonPrime", "Ρυθμίσεις MelonPrime", "MelonPrime-inställningar", "การตั้งค่า MelonPrime", "Nastavení MelonPrime", "MelonPrime-indstillinger", "MelonPrime ayarları", "MelonPrime-innstillinger", "MelonPrime-beállítások", "MelonPrime-asetukset", "Cài đặt MelonPrime", "Ustawienia MelonPrime", "Setări MelonPrime"},
    {"Controls", "æä½", "Steuerung", "Controles", "Commandes", "Comandi", "Besturing", "Controles", "Управление", "操作", "조작", "عناصر التحكم", "Kontrol", "Керування", "Χειρισμοί", "Kontroller", "การควบคุม", "Ovládání", "Kontroller", "Kontroller", "Kontroller", "Irányítás", "Ohjaimet", "Điều khiển", "Sterowanie", "Controale"},
    {"Controls 2", "æä½ 2", "Steuerung 2", "Controles 2", "Commandes 2", "Controlli 2", "Besturing 2", "Controles 2", "Управление 2", "操作 2", "조작 2", "عناصر التحكم 2", "Kontrol 2", "Керування 2", "Χειρισμός 2", "Kontroller 2", "การควบคุม 2", "Ovládání 2", "Styring 2", "Kontroller 2", "Kontroller 2", "Irányítás 2", "Ohjaimet 2", "Điều khiển 2", "Sterowanie 2", "Controale 2"},
    {"Custom HUD", "ã«ã¹ã¿ã HUD", "Benutzerdefiniertes HUD", "HUD personalizado", "HUD personnalisé", "HUD personalizzato", "Aangepaste HUD", "HUD personalizado", "Пользовательский HUD", "自定义 HUD", "사용자 지정 HUD", "HUD مخصص", "HUD kustom", "Користувацький HUD", "Προσαρμοσμένο HUD", "Anpassad HUD", "HUD กำหนดเอง", "Vlastní HUD", "Brugerdefineret HUD", "Özel HUD", "Tilpasset HUD", "Egyéni HUD", "Mukautettu HUD", "HUD tùy chỉnh", "Niestandardowy HUD", "HUD personalizat"},
    ...
    {"Input", "å¥å", "Eingabe", "Entrada", "Entrées", "Input", "Invoer", "Entrada", "Ввод", "输入", "입력", "إدخال", "Input", "Введення", "Είσοδος", "Inmatning", "อินพุต", "Vstup", "Input", "Giriş", "Inndata", "Bemenet", "Syöte", "Nhập", "Wejście", "Intrare"},
    {"Output", "åºå", "Ausgabe", "Salida", "Sortie", "Uscita", "Uitvoer", "Saída", "Вывод", "输出", "출력", "الإخراج", "Keluaran", "Вихід", "Έξοδος", "Utdata", "เอาต์พุต", "Výstup", "Output", "Çıktı", "Utdata", "Kimenet", "Ulostulo", "Đầu ra", "Wyjście", "Ieșire"},
    {"INPUT SETTINGS", "å¥åè¨­å®", "EINGABE-EINSTELLUNGEN", "AJUSTES DE ENTRADA", "PARAMÈTRES D'ENTRÉE", "IMPOSTAZIONI INPUT", "INVOERINSTELLINGEN", "CONFIGURAÇÕES DE ENTRADA", "НАСТРОЙКИ ВВОДА", "输入设置", "입력 설정", "إعدادات الإدخال", "PENGATURAN INPUT", "НАЛАШТУВАННЯ ВВОДУ", "ΡΥΘΜΙΣΕΙΣ ΕΙΣΟΔΟΥ", "INMATNINGSINSTÄLLNINGAR", "การตั้งค่าอินพุต", "NASTAVENÍ VSTUPU", "INPUTINDSTILLINGER", "GİRİŞ AYARLARI", "INNDATASINNSTILLINGER", "BEVITELI BEÁLLÍTÁSOK", "SYÖTEASETUKSET", "CÀI ĐẶT ĐẦU VÀO", "USTAWIENIA WEJŚCIA", "SETĂRI INTRARE"},
    {"INPUT METHOD", "å¥åæ¹å¼", "EINGABEMETHODE", "MÉTODO DE ENTRADA", "MÉTHODE DE SAISIE", "METODO DI INPUT", "INVOERMETHODE", "MÉTODO DE ENTRADA", "МЕТОД ВВОДА", "输入方式", "입력 방식", "طريقة الإدخال", "METODE INPUT", "МЕТОД ВВОДУ", "ΜΕΘΟΔΟΣ ΕΙΣΟΔΟΥ", "INMATNINGSMETOD", "วิธีป้อนข้อมูล", "METODA VSTUPU", "INPUTMETODE", "GİRİŞ YÖNTEMİ", "INNDATAMETODE", "BEVITELI MÓDSZER", "SYÖTTÖMENETELMÄ", "PHƯƠNG THỨC NHẬP", "METODA WEJŚCIA", "METODĂ DE INTRODUCERE"},
    ...
    {"VIDEO QUALITY", "æ ååè³ª", "VIDEOQUALITÄT", "CALIDAD DE VÍDEO", "QUALITÉ VIDÉO", "QUALITÀ VIDEO", "VIDEOKWALITEIT", "QUALIDADE DE VÍDEO", "КАЧЕСТВО ВИДЕО", "视频质量", "비디오 품질", "جودة الفيديو", "KUALITAS VIDEO", "ЯКІСТЬ ВІДЕО", "ΠΟΙΟΤΗΤΑ ΒΙΝΤΕΟ", "VIDEOKVALITET", "คุณภาพวิดีโอ", "KVALITA VIDEA", "VIDEOKVALITET", "VİDEO KALİTESİ", "VIDEOKVALITET", "VIDEÓMINŐSÉG", "VIDEON LAATU", "CHẤT LƯỢNG VIDEO", "JAKOŚĆ WIDEO", "CALITATE VIDEO"},
    {"VOLUME", "é³é", "LAUTSTÄRKE", "VOLUMEN", "VOLUME", "VOLUME", "VOLUME", "VOLUME", "ГРОМКОСТЬ", "音量", "볼륨", "مستوى الصوت", "VOLUME", "ГУЧНІСТЬ", "ΕΝΤΑΣΗ", "VOLYM", "ระดับเสียง", "HLASITOST", "LYDSTYRKE", "SES", "VOLUM", "HANGERŐ", "ÄÄNENVOIMAKKUUS", "ÂM LƯỢNG", "GŁOŚNOŚĆ", "VOLUM"},
    {"LICENSE APPLY", "ã©ã¤ã»ã³ã¹åæ ", "LIZENZ ANWENDEN", "APLICAR LICENCIA", "APPLIQUER LA LICENCE", "APPLICA LICENZA", "LICENTIE TOEPASSEN", "APLICAR LICENÇA", "ПРИМЕНИТЬ ЛИЦЕНЗИЮ", "应用许可证", "라이선스 적용", "تطبيق الترخيص", "TERAPKAN LISENSI", "ЗАСТОСУВАТИ ЛІЦЕНЗІЮ", "ΕΦΑΡΜΟΓΗ ΑΔΕΙΑΣ", "TILLÄMPA LICENS", "ใช้ใบอนุญาต", "POUŽÍT LICENCI", "ANVEND LICENS", "LİSANSI UYGULA", "BRUK LISENS", "LICENC ALKALMAZÁSA", "KÄYTÄ LISENSSIÄ", "ÁP DỤNG GIẤY PHÉP", "ZASTOSUJ LICENCJĘ", "APLICĂ LICENȚA"},
    {"DEVELOPER ONLY", "éçºèåã", "NUR FÜR ENTWICKLER", "SOLO DESARROLLADORES", "RÉSERVÉ AUX DÉVELOPPEURS", "SOLO SVILUPPATORI", "ALLEEN ONTWIKKELAARS", "SOMENTE DESENVOLVEDORES", "ТОЛЬКО ДЛЯ РАЗРАБОТЧИКОВ", "仅限开发者", "개발자 전용", "للمطورين فقط", "KHUSUS PENGEMBANG", "ЛИШЕ ДЛЯ РОЗРОБНИКІВ", "ΜΟΝΟ ΓΙΑ ΠΡΟΓΡΑΜΜΑΤΙΣΤΕΣ", "ENDAST UTVECKLARE", "สำหรับนักพัฒนาเท่านั้น", "POUZE PRO VÝVOJÁŘE", "KUN UDVIKLERE", "YALNIZCA GELİŞTİRİCİLER", "KUN UTVIKLERE", "CSAK FEJLESZTŐKNEK", "VAIN KEHITTÄJILLE", "CHỈ DÀNH CHO NHÀ PHÁT TRIỂN", "TYLKO DLA DEWELOPERÓW", "DOAR PENTRU DEZVOLTATORI"},
    ...
    {"OUTLINE OVERRIDE", "ã¢ã¦ãã©ã¤ã³ä¸æ¬è¨­å®", "KONTUR-ÜBERSCHREIBUNG", "ANULACIÓN DE CONTORNO", "REMPLACEMENT DE CONTOUR", "SOSTITUZIONE CONTORNO", "OORLIJNOVERSCHRIJVING", "SUBSTITUIÇÃO DE CONTORNO", "ПЕРЕОПРЕДЕЛЕНИЕ КОНТУРА", "轮廓覆盖", "외곽선 재정의", "تجاوز الحدود", "PENGGANTIAN GARIS LUAR", "ЗАМІНА КОНТУРУ", "ΑΝΤΙΚΑΤΑΣΤΑΣΗ ΠΕΡΙΓΡΑΜΜΑΤΟΣ", "KONTURÖVERSKRIVNING", "แทนที่เส้นขอบ", "NAHRADENÍ OBRYSU", "KONTURTILSIDESÆTTELSE", "DIŞ ÇİZGİ GEÇERSİZ KILMA", "KONTUROVERSKRIVING", "KONTÚR FELÜLÍRÁSA", "ÄÄRIVIIVAN KORVAUS", "GHI ĐÈ VIỀN", "ZASTĄPIENIE OBRYSU", "ÎNLOCUIRE CONTUR"},
    {"HUD SCALE", "HUDã¹ã±ã¼ã«", "HUD-SKALIERUNG", "ESCALA HUD", "ÉCHELLE HUD", "SCALA HUD", "HUD-SCHAAL", "ESCALA HUD", "МАСШТАБ HUD", "HUD 缩放", "HUD 배율", "مقياس HUD", "SKALA HUD", "МАСШТАБ HUD", "ΚΛΙΜΑΚΑ HUD", "HUD-SKALNING", "สเกล HUD", "MĚŘÍTKO HUD", "HUD-SKALERING", "HUD ÖLÇEĞİ", "HUD-SKALERING", "HUD SKÁLA", "HUD-SKAALAUS", "TỶ LỆ HUD", "SKALA HUD", "SCALĂ HUD"},
    {"HUD FONT", "HUDãã©ã³ã", "HUD-SCHRIFT", "FUENTE HUD", "POLICE HUD", "FONT HUD", "HUD-LETTERTYPE", "FONTE HUD", "ШРИФТ HUD", "HUD 字体", "HUD 글꼴", "خط HUD", "FONT HUD", "ШРИФТ HUD", "ΓΡΑΜΜΑΤΟΣΕΙΡΑ HUD", "HUD-TYPSNITT", "ฟอนต์ HUD", "PÍSMO HUD", "HUD-SKRIFT", "HUD YAZI TİPİ", "HUD-SKRIFT", "HUD BETŰ", "HUD-FONTTI", "PHÔNG HUD", "CZCIONKA HUD", "FONT HUD"},
    {"CROSSHAIR", "ç§æº", "VISIER", "PUNTO DE MIRA", "RÉTICULE", "RETICOLO", "RICHTKRUIS", "MIRA", "ПРИЦЕЛ", "准星", "조준선", "التقاطع", "BIDIK", "ПРИЦІЛ", "ΣΤΟΧΕΥΤΗΡΑΣ", "SIKTE", "เล็ง", "ZAMĚŘOVAČ", "SIGTEKORS", "NİŞANGAH", "TRÅDKORS", "IRÁNYZÉK", "TÄHTÄIN", "TÂM NGẮM", "CELOWNIK", "ȚINTĂ"},
    ...
    {"Auto Scale — Base", "Automatische Skalierung — Basis", "Automatische Skalierung — Basis", "Escala automática — Base", "Échelle automatique — Base", "Scala automatica — Base", "Automatische schaling — Basis", "Escala automática — Base", "Автомасштаб — База", "自动缩放 — 基准", "자동 크기 조절 — 기본", "Automatische Skalierung — Basis", "Automatische Skalierung — Basis", "Automatische Skalierung — Basis", "Automatische Skalierung — Basis", "Automatische Skalierung — Basis", "Automatische Skalierung — Basis", "Automatische Skalierung — Basis", "Automatische Skalierung — Basis", "Automatische Skalierung — Basis", "Automatische Skalierung — Basis", "Automatische Skalierung — Basis", "Automatische Skalierung — Basis", "Automatische Skalierung — Basis", "Automatische Skalierung — Basis", "Automatische Skalierung — Basis"},
    {"Auto Scale (by Damage)", "Scalare automată (după daune)", "Auto-Skalierung (nach Schaden)", "Escala automática (por daño)", "Échelle auto (selon dégâts)", "Scala automatica (per danno)", "Auto-schaal (op schade)", "Escala automática (por dano)", "Автомасштаб (по урону)", "自动缩放（按伤害）", "자동 배율 (피해별)", "تحجيم تلقائي (حسب الضرر)", "Skala Otomatis (berdasarkan Kerusakan)", "Автомасштаб (за шкодою)", "Αυτόματη κλίμακα (κατά ζημιά)", "Autoskalning (efter skada)", "ปรับขนาดอัตโนมัติ (ตามความเสียหาย)", "Automatické škálování (podle poškození)", "Autoskalering (efter skade)", "Otomatik ölçek (hasara göre)", "Autoskalering (etter skade)", "Automatikus skálázás (sebzés szerint)", "Automaattinen skaalaus (vaurion mukaan)", "Tỷ lệ tự động (theo sát thương)", "Skala automatyczna (wg obrażeń)", "Scalare automată (după daune)"},
    {"Disabled (vanilla 25)", "ç¡å¹ (ããã©25)", "Deaktiviert (Vanilla 25)", "Desactivado (vanilla 25)", "Désactivé (vanilla 25)", "Disabilitato (vanilla 25)", "Uitgeschakeld (vanilla 25)", "Desativado (vanilla 25)", "Отключено (vanilla 25)", "禁用 (原版 25)", "비활성화 (바닐라 25)", "معطّل (vanilla 25)", "Nonaktif (vanilla 25)", "Вимкнено (vanilla 25)", "Απενεργοποιημένο (vanilla 25)", "Inaktiverad (vanilla 25)", "ปิดใช้งาน (vanilla 25)", "Zakázáno (vanilla 25)", "Deaktiveret (vanilla 25)", "Devre dışı (vanilla 25)", "Deaktivert (vanilla 25)", "Letiltva (vanilla 25)", "Poissa käytöstä (vanilla 25)", "Đã tắt (vanilla 25)", "Wyłączone (vanilla 25)", "Dezactivat (vanilla 25)"},
    {"Fixed", "åºå®", "Fest", "Fijo", "Fixe", "Fisso", "Vast", "Fixo", "Фиксированный", "固定", "고정", "ثابت", "Tetap", "Фіксований", "Σταθερό", "Fast", "คงที่", "Pevné", "Fast", "Sabit", "Fast", "Rögzített", "Kiinteä", "Cố định", "Stały", "Fix"},
    ...
    {"Font Size (px)", "ãã©ã³ããµã¤ãº (px)", "Schriftgröße (px)", "Tamaño de fuente (px)", "Taille de police (px)", "Dimensione carattere (px)", "Lettergrootte (px)", "Tamanho da fonte (px)", "Размер шрифта (px)", "字体大小 (px)", "글꼴 크기 (px)", "حجم الخط (px)", "Ukuran font (px)", "Розмір шрифту (px)", "Μέγεθος γραμματοσειράς (px)", "Teckenstorlek (px)", "ขนาดฟอนต์ (px)", "Velikost písma (px)", "Skriftstørrelse (px)", "Yazı tipi boyutu (px)", "Skriftstørrelse (px)", "Betűméret (px)", "Fonttikoko (px)", "Cỡ phông (px)", "Rozmiar czcionki (px)", "Dimensiune font (px)"},
    {"Font Weight", "ãã©ã³ãã¦ã§ã¤ã", "Schriftstärke", "Grosor de fuente", "Épaisseur de police", "Spessore carattere", "Lettertypedikte", "Peso da fonte", "Насыщенность шрифта", "字体粗细", "글꼴 굵기", "سمك الخط", "Ketebalan Font", "Насиченість шрифту", "Βάρος γραμματοσειράς", "Teckensnittsvikt", "น้ำหนักฟอนต์", "Tloušťka písma", "Skrifttypevægt", "Yazı Tipi Kalınlığı", "Skriftvekt", "Betűvastagság", "Fontin paksuus", "Độ đậm phông", "Grubość czcionki", "Grosime font"},
    {"Italic", "ã¤ã¿ãªãã¯", "Kursiv", "Cursiva", "Italique", "Corsivo", "Cursief", "Itálico", "Курсив", "斜体", "기울임", "مائل", "Miring", "Курсив", "Πλάγια", "Kursiv", "ตัวเอียง", "Kurzíva", "Kursiv", "İtalik", "Kursiv", "Dőlt", "Kursiivi", "Nghiêng", "Kursywa", "Cursiv"},
    {"Underline", "ä¸ç·", "Unterstreichen", "Subrayado", "Souligné", "Sottolineato", "Onderstrepen", "Sublinhado", "Подчёркивание", "下划线", "밑줄", "تسطير", "Garis bawah", "Підкреслення", "Υπογράμμιση", "Understrykning", "ขีดเส้นใต้", "Podtržení", "Understregning", "Altı çizili", "Understrekning", "Aláhúzás", "Alleviivaus", "Gạch chân", "Podkreślenie", "Subliniere"},
    ...
    {"Color", "è²", "Farbe", "Color", "Couleur", "Colore", "Kleur", "Cor", "Цвет", "颜色", "색상", "اللون", "Warna", "Колір", "Χρώμα", "Färg", "สี", "Barva", "Farve", "Renk", "Farge", "Szín", "Väri", "Màu", "Kolor", "Culoare"},
    {"Scale %", "ã¹ã±ã¼ã« %", "Skalierung %", "Escala %", "Échelle %", "Scala %", "Schaal %", "Escala %", "Масштаб %", "缩放 %", "배율 %", "التحجيم %", "Skala %", "Масштаб %", "Κλίμακα %", "Skalning %", "สเกล %", "Měřítko %", "Skalering %", "Ölçek %", "Skalering %", "Skála %", "Skaalaus %", "Tỷ lệ %", "Skala %", "Scală %"},
    {"Zoom Stage", "ãºã¼ã æ®µé", "Zoom-Stufe", "Etapa de zoom", "Niveau de zoom", "Fase zoom", "Zoomfase", "Estágio de zoom", "Стадия зума", "缩放阶段", "줌 단계", "مرحلة التكبير", "Tahap Zoom", "Стадія зуму", "Στάδιο ζουμ", "Zoomsteg", "ขั้นตอนซูม", "Fáze zoomu", "Zoomtrin", "Zoom aşaması", "Zoomtrinn", "Zoom szakasz", "Zoom-vaihe", "Giai đoạn zoom", "Etap zoomu", "Etapă zoom"},
    {"Zoom Base Scale %", "ãºã¼ã æåç§æºã¹ã±ã¼ã« %", "Basis-Visiergröße beim Zoom %", "Escala base de mira con zoom %", "Échelle de base du réticule au zoom %", "Scala base reticolo zoom %", "Basis richtkruisschaal bij zoom %", "Escala base de mira com zoom %", "Базовый масштаб прицела при зуме %", "缩放时准星基础比例 %", "확대 시 기본 조준선 크기 %", "مقياس التقاطع الأساسي عند التكبير %", "Skala dasar bidik zoom %", "Базовий масштаб прицілу при зумі %", "Βασική κλίμακα στόχευσης ζουμ %", "Zoom bas-skala sikte %", "สเกลฐานเล็งซูม %", "Základní měřítko zaměřovače při zoomu %", "Zoom basisskala sigte %", "Zoom temel nişangah ölçeği %", "Zoom grunnskalering sikte %", "Zoom alap irányzék skála %", "Zoomin perustähtäimen skaala %", "Tỷ lệ cơ sở tâm ngắm zoom %", "Bazowa skala celownika zoom %", "Scală de bază țintă zoom %"},
    ...
    {"Scope Thickness", "ã¹ã³ã¼ãå¤ªã", "Visierstärke", "Grosor del visor", "Épaisseur du viseur", "Spessore mirino", "Vizierdikte", "Espessura da mira", "Толщина прицела", "瞄准镜粗细", "스코프 두께", "سُمك المنظار", "Ketebalan scope", "Товщина прицілу", "Πάχος σκόπευτήρου", "Siktetjocklek", "ความหนาเล็ง", "Tloušťka zaměřovače", "Sigtetykkelse", "Nişangah kalınlığı", "Siktetykkelse", "Irányzék vastagsága", "Tähtäimen paksuus", "Độ dày ống ngắm", "Grubość celownika", "Grosime lunetă"},
    {"Scope Thick.", "ã¹ã³ã¼ãå¤ªã", "Fadenkreuz-Dicke", "Grosor de retícula", "Épaisseur réticule", "Spess. mirino", "Mirino-dikte", "Espess. retícula", "Толщ. прицела", "瞄准镜粗细", "스코프 두께", "سُمك الشبكة", "Ketebalan Reticle", "Товщ. прицілу", "Πάχος σταυρ.", "Siktetjocklek", "ความหนาเรติเคิล", "Tloušťka mířidla", "Sigtekornstykkelse", "Nişangah kalınlığı", "Siktetykkelse", "Célkereszt vastagság", "Tähtäimen paksuus", "Độ dày tâm ngắm", "Grubość celownika", "Grosime reticul"},
    {"Scope Center Dot", "ã¹ã³ã¼ãä¸­å¤®ããã", "Visier-Mittelpunkt", "Punto central del visor", "Point central du viseur", "Punto centrale mirino", "Vizier middenpunt", "Ponto central do visor", "Центральная точка прицела", "瞄准镜中心点", "스코프 중앙 점", "نقطة مركز المنظار", "Titik Tengah Scope", "Центральна точка прицілу", "Κεντρική κουκκίδα σκόπευσης", "Sikte mittpunkt", "จุดกึ่งกลาง scope", "Středová tečka zaměřovače", "Sigte midtpunkt", "Dürbün merkez noktası", "Sikte midtpunkt", "Távcső középpont", "Tähtäimen keskipiste", "Chấm giữa ống ngắm", "Punkt centralny lunety", "Punct central scope"},
    {"Scope Dot Size", "ã¹ã³ã¼ãããããµã¤ãº", "Visierpunktgröße", "Tamaño del punto de mira", "Taille du point du viseur", "Dimensione punto mirino", "Vizierpuntgrootte", "Tamanho do ponto da mira", "Размер точки прицела", "准星点大小", "스코프 점 크기", "حجم نقطة المنظار", "Ukuran titik scope", "Розмір точки прицілу", "Μέγεθος σημείου σκοπευτήρα", "Siktpunktstorlek", "ขนาดจุดสโคป", "Velikost bodu zaměřovače", "Sigtepunktstørrelse", "Nişangah nokta boyutu", "Siktepunktstørrelse", "Távcső pont mérete", "Tähtäimen pisteen koko", "Kích thước chấm scope", "Rozmiar punktu celownika", "Dimensiune punct lunetă"},
    ...
    {"Scope Opacity %", "ã¹ã³ã¼ãä¸éæåº¦ %", "Visier-Deckkraft %", "Opacidad del visor %", "Opacité du viseur %", "Opacità mirino %", "Vizierdekking %", "Opacidade da mira %", "Непрозрачность прицела %", "瞄准镜不透明度 %", "스코프 불투명도 %", "شفافية المنظار %", "Opasitas scope %", "Непрозорість прицілу %", "Αδιαφάνεια σκόπευτήρου %", "Siktets opacitet %", "ความทึบเล็ง %", "Neprůhlednost zaměřovače %", "Sigtets gennemsigtighed %", "Nişangah opaklığı %", "Siktets opasitet %", "Irányzék átlátszatlanság %", "Tähtäimen läpinäkymättömyys %", "Độ mờ ống ngắm %", "Krycie celownika %", "Opacitate lunetă %"},
    {"Zoom Transition", "ãºã¼ã ãã©ã³ã¸ã·ã§ã³", "Zoom-Übergang", "Transición de zoom", "Transition de zoom", "Transizione zoom", "Zoom-overgang", "Transição de zoom", "Переход увеличения", "缩放过渡", "줌 전환", "انتقال التكبير", "Transisi Zoom", "Перехід зуму", "Μετάβαση ζουμ", "Zoomövergång", "การเปลี่ยนซูม", "Přechod zoomu", "Zoomovergang", "Yakınlaştırma geçişi", "Zoomovergang", "Zoom átmenet", "Zoom-siirtymä", "Chuyển zoom", "Przejście zoomu", "Tranziție zoom"},
    {"Zoom Transition Speed %", "ãºã¼ã é·ç§»éåº¦ %", "Zoom-Übergangsgeschwindigkeit %", "Velocidad de transición de zoom %", "Vitesse de transition du zoom %", "Velocità transizione zoom %", "Zoomovergangssnelheid %", "Velocidade de transição do zoom %", "Скорость перехода зума %", "缩放过渡速度 %", "줌 전환 속도 %", "سرعة انتقال التكبير %", "Kecepatan Transisi Zoom %", "Швидкість переходу зуму %", "Ταχύτητα μετάβασης ζουμ %", "Zoomövergångshastighet %", "ความเร็วการเปลี่ยนซูม %", "Rychlost přechodu zoomu %", "Zoom-overgangshastighed %", "Zoom geçiş hızı %", "Zoom-overgangshastighet %", "Zoom átmeneti sebesség %", "Zoom-siirtymän nopeus %", "Tốc độ chuyển zoom %", "Szybkość przejścia zoomu %", "Viteză tranziție zoom %"},
    {"Transition Speed %", "é·ç§»éåº¦ %", "Übergangsgeschwindigkeit %", "Velocidad de transición %", "Vitesse de transition %", "Velocità transizione %", "Overgangssnelheid %", "Velocidade de transição %", "Скорость перехода %", "过渡速度 %", "전환 속도 %", "سرعة الانتقال %", "Kecepatan transisi %", "Швидкість переходу %", "Ταχύτητα μετάβασης %", "Övergångshastighet %", "ความเร็วการเปลี่ยน %", "Rychlost přechodu %", "Overgangshastighed %", "Geçiş hızı %", "Overgangshastighet %", "Átmeneti sebesség %", "Siirtymänopeus %", "Tốc độ chuyển %", "Szybkość przejścia %", "Viteză tranziție %"},
    ...
    {"Pulse Ring", "ãã«ã¹ãªã³ã°", "Pulsring", "Anillo pulsante", "Anneau pulsant", "Anello pulsante", "Pulsring", "Anel pulsante", "Пульсирующее кольцо", "脉冲环", "펄스 링", "حلقة النبض", "Cincin denyut", "Пульсуюче кільце", "Δακτύλιος παλμού", "Pulsring", "วงแหวนพัลส์", "Pulzní kruh", "Pulsring", "Nabız halkası", "Pulsring", "Pulzáló gyűrű", "Pulssirengas", "Vòng xung", "Pierścień pulsacji", "Inel pulsatoriu"},
    {"Zoom Pulse Strength %", "ãºã¼ã ãã«ã¹å¼·åº¦ %", "Zoom-Puls-Stärke %", "Intensidad de pulso de zoom %", "Intensité impulsion zoom %", "Intensità impulso zoom %", "Zoom-pulssterkte %", "Intensidade de pulso de zoom %", "Сила пульсации увеличения %", "缩放脉冲强度 %", "줌 펄스 강도 %", "قوة نبض التكبير %", "Kekuatan Pulsa Zoom %", "Сила імпульсу зуму %", "Ένταση παλμού ζουμ %", "Zoompulstyrka %", "ความแรงพัลส์ซูม %", "Síla pulzu zoomu %", "Zoom-pulsstyrke %", "Yakınlaştırma darbe gücü %", "Zoom-pulsstyrke %", "Zoom impulzus erősség %", "Zoom-pulssin voimakkuus %", "Cường độ xung zoom %", "Siła impulsu zoomu %", "Putere puls zoom %"},
    {"Pulse Strength %", "ãã«ã¹å¼·åº¦ %", "Pulsstärke %", "Intensidad del pulso %", "Intensité de pulsation %", "Intensità impulso %", "Pulssterkte %", "Intensidade do pulso %", "Сила пульсации %", "脉冲强度 %", "펄스 강도 %", "قوة النبض %", "Kekuatan Pulsa %", "Сила пульсації %", "Ένταση παλμού %", "Pulsstyrka %", "ความแรงพัลส์ %", "Síla pulzu %", "Pulsstyrke %", "Darbe gücü %", "Pulsstyrke %", "Impulzus erősség %", "Pulssin voimakkuus %", "Cường độ xung %", "Siła impulsu %", "Putere puls %"},
    {"Zoom Crosshair", "ãºã¼ã ç§æº", "Zoom-Visier", "Punto de mira con zoom", "Réticule au zoom", "Reticolo zoom", "Zoom-richtkruis", "Mira com zoom", "Прицел при зуме", "缩放准星", "확대 조준선", "تقاطع التكبير", "Bidik zoom", "Приціл при зумі", "Στόχευση ζουμ", "Zoom-sikte", "เล็งซูม", "Zaměřovač při zoomu", "Zoom-sigtekors", "Zoom nişangahı", "Zoom-trådkors", "Zoom irányzék", "Zoom-tähtäin", "Tâm ngắm zoom", "Celownik zoom", "Țintă zoom"},
    ...
    {"Custom Scope Dot Color", "ã¹ã³ã¼ããããè²ãåå¥æå®", "Eigene Visierpunkt-Farbe", "Color personalizado del punto del visor", "Couleur personnalisée du point de visée", "Colore punto mirino personalizzato", "Aangepaste vizierpuntkleur", "Cor personalizada do ponto da mira", "Пользовательский цвет точки прицела", "自定义瞄准点颜色", "사용자 스코프 점 색상", "لون نقطة المنظار المخصص", "Warna titik scope kustom", "Користувацький колір точки прицілу", "Προσαρμοσμένο χρώμα σημείου σκόπευτήρου", "Anpassad siktprickfärg", "สีจุดเล็งกำหนดเอง", "Vlastní barva bodu zaměřovače", "Brugerdefineret sigtepunktfarve", "Özel nişangah noktası rengi", "Egendefinert siktepunktfarge", "Egyéni irányzékpont szín", "Mukautettu tähtäinpisteen väri", "Màu chấm ống ngắm tùy chỉnh", "Niestandardowy kolor punktu celownika", "Culoare personalizată punct lunetă"},
    {"Scope Dot Color", "ã¹ã³ã¼ããããè²", "Fadenkreuz-Punktfarbe", "Color del punto de retícula", "Couleur point réticule", "Colore punto mirino", "Mirinopuntkleur", "Cor do ponto da retícula", "Цвет точки прицела", "瞄准镜圆点颜色", "스코프 점 색상", "لون نقطة الشبكة", "Warna Titik Reticle", "Колір точки прицілу", "Χρώμα κουκκίδας σταυρού", "Siktepunktfärg", "สีจุดเรติเคิล", "Barva tečky mířidla", "Sigtekornspunktfarve", "Nişangah nokta rengi", "Siktetpunktfarge", "Célkereszt pont színe", "Tähtäinpisteen väri", "Màu chấm tâm ngắm", "Kolor kropki celownika", "Culoare punct reticul"},
    {"Staged", "æ®µé", "Gestuft", "Por etapas", "Par étapes", "A fasi", "Gefaseerd", "Por estágios", "Поэтапный", "分阶段", "단계별", "متدرج", "Bertahap", "Поетапний", "Σταδιακό", "Stegvis", "เป็นขั้น", "Postupné", "Trinvis", "Aşamalı", "Trinnvis", "Fokozatos", "Vaiheittainen", "Theo giai đoạn", "Etapy", "Pe etape"},
    {"Fade", "ãã§ã¼ã", "Einblenden", "Fundido", "Fondu", "Dissolvenza", "Vervagen", "Desvanecer", "Затухание", "淡入淡出", "페이드", "تلاشي", "Fade", "Затухання", "Ξεθώριασμα", "Tona in", "เฟด", "Prolnutí", "Fade", "Solma", "Fade", "Áttűnés", "Häivytys", "Mờ dần", "Zanikanie", "Estompare"},
    ...
    {"Glitch2", "ã°ãªãã2", "Glitch2", "Glitch2", "Glitch2", "Glitch2", "Glitch2", "Glitch2", "Glitch2", "Glitch2", "Glitch2", "Glitch2", "Glitch2", "Glitch2", "Glitch2", "Glitch2", "Glitch2", "Glitch2", "Glitch2", "Glitch2", "Glitch2", "Glitch2", "Glitch2", "Glitch2", "Glitch2", "Glitch2"},
    {"Snap", "ã¹ããã", "Einrasten", "Ajuste", "Accrochage", "Aggancio", "Snap", "Encaixe", "Привязка", "吸附", "스냅", "التثبيت", "Snap", "Прив'язка", "Κούμπωμα", "Fäst", "สแนป", "Přichycení", "Snap", "Yapış", "Snap", "Illesztés", "Kiinnitys", "Snap", "Przyciąganie", "Fixare"},
    {"Digital", "ãã¸ã¿ã«", "Digital", "Digital", "Numérique", "Digitale", "Digitaal", "Digital", "Цифровой", "数字", "디지털", "رقمي", "Digital", "Цифровий", "Ψηφιακό", "Digital", "ดิจิทัล", "Digitální", "Digital", "Dijital", "Digital", "Digitális", "Digitaalinen", "Kỹ thuật số", "Cyfrowy", "Digital"},
    {"Pulse Wave", "ãã«ã¹æ³¢", "Pulswelle", "Onda pulsante", "Onde pulsée", "Onda pulsante", "Pulsgolf", "Onda pulsante", "Импульсная волна", "脉冲波", "펄스 파", "موجة نبضية", "Gelombang pulsa", "Імпульсна хвиля", "Παλμική κυματική", "Pulsvåg", "คลื่นพัลส์", "Pulzní vlna", "Pulsbølge", "Darbe dalgası", "Pulsbølge", "Impulzushullám", "Pulssiaalto", "Sóng xung", "Fala impulsowa", "Undă puls"},
    ...
    {"SF Movie", "SFæ ç»", "SF-Film", "Película SF", "Film SF", "Film SF", "SF-film", "Filme SF", "SF-фильм", "SF 影片", "SF 영화", "فيلم SF", "Film SF", "SF-фільм", "Ταινία SF", "SF-film", "ภาพยนตร์ SF", "SF film", "SF-film", "SF filmi", "SF-film", "SF film", "SF-elokuva", "Phim SF", "Film SF", "Film SF"},
    {"Tactical Lock", "æ¦è¡ã­ãã¯", "Taktische Sperre", "Bloqueo táctico", "Verrouillage tactique", "Blocco tattico", "Tactische vergrendeling", "Bloqueio tático", "Тактическая блокировка", "战术锁定", "전술 잠금", "قفل تكتيكي", "Kunci Taktis", "Тактичне блокування", "Τακτικό κλείδωμα", "Taktiskt lås", "ล็อกเชิงกล", "Taktické zamčení", "Taktisk lås", "Taktik kilitleme", "Taktisk lås", "Taktikai zár", "Taktinen lukitus", "Khóa chiến thuật", "Blokada taktyczna", "Blocare tactică"},
    {"Sniper Optics", "ã¹ãã¤ãã¼åå­¦", "Scharfschützenoptik", "Óptica de francotirador", "Optique de sniper", "Ottica da cecchino", "Scherpschutteroptiek", "Óptica de sniper", "Снайперская оптика", "狙击光学", "스나이퍼 광학", "بصريات القناص", "Optik Sniper", "Снайперська оптика", "Οπτικά σκοπευτή", "Prickskytteoptik", "Sniper Optics", "Odstřelovačská optika", "Snigskytteoptik", "Keskin nişancı optiği", "Skarpskytteroptikk", "Mesterlövész optika", "Tarkkuuskiväärin optiikka", "Quang học bắn tỉa", "Optyka snajperska", "Optică sniper"},
    {"Drone LIDAR", "ãã­ã¼ã³LIDAR", "Drohnen-LIDAR", "LIDAR del dron", "LIDAR du drone", "LIDAR drone", "Drone-LIDAR", "LIDAR do drone", "LIDAR дрона", "无人机 LIDAR", "드론 LIDAR", "LIDAR الطائرة بدون طيار", "LIDAR drone", "LIDAR дрона", "LIDAR drone", "Drönar-LIDAR", "LIDAR โดรน", "Dron LIDAR", "Drone-LIDAR", "Drone LIDAR", "Drone-LIDAR", "Drón LIDAR", "Drone-LIDAR", "LIDAR drone", "LIDAR drona", "LIDAR dronă"},
    ...
    {"Zoom", "ãºã¼ã ", "Zoom", "Zoom", "Zoom", "Zoom", "Zoom", "Zoom", "Зум", "缩放", "줌", "تكبير", "Zoom", "Зум", "Ζουμ", "Zoom", "ซูม", "Zoom", "Zoom", "Yakınlaştırma", "Zoom", "Nagyítás", "Zoom", "Thu phóng", "Powiększenie", "Zoom"},
    {"Outline", "ã¢ã¦ãã©ã¤ã³", "Umriss", "Contorno", "Contour", "Contorno", "Omtrek", "Contorno", "Контур", "轮廓", "외곽선", "حد خارجي", "Garis Luar", "Контур", "Περίγραμμα", "Kontur", "เส้นขอบ", "Obrys", "Kontur", "Ana hat", "Kontur", "Körvonal", "Ääriviiva", "Viền", "Obrys", "Contur"},
    {"Outline Color", "ã¢ã¦ãã©ã¤ã³è²", "Umrissfarbe", "Color del contorno", "Couleur du contour", "Colore contorno", "Omtrekkleur", "Cor do contorno", "Цвет контура", "轮廓颜色", "외곽선 색상", "لون الحد", "Warna Garis", "Колір контуру", "Χρώμα περιγράμματος", "Konturfärg", "สีเส้นขอบ", "Barva obrysu", "Konturfarve", "Ana hat rengi", "Konturfarge", "Körvonal szín", "Ääriviivan väri", "Màu viền", "Kolor obrysu", "Culoare contur"},
    {"Outline Opacity", "ã¢ã¦ãã©ã¤ã³ä¸éæåº¦", "Konturdeckkraft", "Opacidad del contorno", "Opacité du contour", "Opacità contorno", "Contourdekking", "Opacidade do contorno", "Непрозрачность контура", "轮廓不透明度", "외곽선 불투명도", "شفافية الحدود", "Opasitas garis luar", "Непрозорість контуру", "Αδιαφάνεια περιγράμματος", "Konturopacitet", "ความทึบเส้นขอบ", "Neprůhlednost obrysu", "Konturopacitet", "Dış çizgi opaklığı", "Konturopasitet", "Körvonal átlátszatlansága", "Ääriviivan läpinäkymättömyys", "Độ mờ viền", "Krycie obrysu", "Opacitate contur"},
    ...
    {"Outline Thick.", "ã¢ã¦ãã©ã¤ã³å¤ªã", "Konturstärke", "Grosor del contorno", "Épaiss. contour", "Spess. contorno", "Omlijndikte", "Espess. contorno", "Толщ. контура", "轮廓粗细", "외곽선 두께", "سُمك الحدود", "Ketebalan garis luar", "Товщина контуру", "Πάχος περιγράμματος", "Konturtjocklek", "ความหนาเส้นขอบ", "Tloušťka obrysu", "Konturtykkelse", "Dış çizgi kalınlığı", "Konturtykkelse", "Kontúrvastagság", "Ääriviivan paksuus", "Độ dày viền", "Grubość konturu", "Grosime contur"},
    {"Center Dot", "ä¸­å¤®ããã", "Mittelpunkt", "Punto central", "Point central", "Punto centrale", "Middelpunt", "Ponto central", "Центральная точка", "中心圆点", "중앙 점", "نقطة مركزية", "Titik Tengah", "Центральна точка", "Κεντρική κουκκίδα", "Mittpunkt", "จุดกลาง", "Středová tečka", "Midterpunkt", "Merkez nokta", "Midtpunkt", "Középpont", "Keskipiste", "Chấm giữa", "Kropka środkowa", "Punct central"},
    {"Custom Dot Color", "ãããè²ãåå¥æå®", "Eigene Punktfarbe", "Color de punto personalizado", "Couleur de point personnalisée", "Colore punto personalizzato", "Aangepaste puntkleur", "Cor de ponto personalizada", "Пользовательский цвет точки", "自定义点颜色", "사용자 지정 점 색상", "لون النقطة المخصص", "Warna Titik Kustom", "Користувацький колір точки", "Προσαρμοσμένο χρώμα κουκκίδας", "Anpassad punktfärg", "สีจุดกำหนดเอง", "Vlastní barva tečky", "Brugerdefineret punktfarve", "Özel nokta rengi", "Egendefinert punktfarge", "Egyéni pont szín", "Mukautettu pisteen väri", "Màu chấm tùy chỉnh", "Niestandardowy kolor punktu", "Culoare punct personalizată"},
    {"Dot Color", "ãããè²", "Punktfarbe", "Color del punto", "Couleur du point", "Colore punto", "Puntkleur", "Cor do ponto", "Цвет точки", "点颜色", "점 색상", "لون النقطة", "Warna titik", "Колір точки", "Χρώμα σημείου", "Punktfärg", "สีจุด", "Barva bodu", "Punktfarve", "Nokta rengi", "Punktfarge", "Pont színe", "Pisteen väri", "Màu chấm", "Kolor punktu", "Culoare punct"},
    ...
    {"Dot Thick.", "ãããå¤ªã", "Punktstärke", "Grosor del punto", "Épaiss. point", "Spess. punto", "Puntdikte", "Espess. ponto", "Толщ. точки", "点粗细", "점 두께", "سُمك النقطة", "Ketebalan titik", "Товщина точки", "Πάχος σημείου", "Punktjocklek", "ความหนาจุด", "Tloušťka bodu", "Punktykkelse", "Nokta kalınlığı", "Punktykkelse", "Pont vastagsága", "Pisteen paksuus", "Độ dày chấm", "Grubość punktu", "Grosime punct"},
    {"T-Style", "Tã¹ã¿ã¤ã«", "T-Stil", "Estilo T", "Style T", "Stile T", "T-stijl", "Estilo T", "Стиль T", "T 型", "T 스타일", "نمط T", "Gaya T", "Стиль T", "Στυλ T", "T-stil", "สไตล์ T", "T-styl", "T-stil", "T-Stili", "T-stil", "T-stílus", "T-tyyli", "Kiểu T", "Styl T", "Stil T"},
    {"Inner", "åå´", "Innen", "Interior", "Intérieur", "Interno", "Binnen", "Interior", "Внутренний", "内侧", "내부", "داخلي", "Dalam", "Внутрішній", "Εσωτερικό", "Inre", "ด้านใน", "Vnitřní", "Indre", "İç", "Indre", "Belső", "Sisä", "Bên trong", "Wewnętrzny", "Interior"},
    {"Outer", "å¤å´", "Außen", "Exterior", "Extérieur", "Esterno", "Buiten", "Exterior", "Внешний", "外侧", "외측", "خارجي", "Luar", "Зовнішній", "Εξωτερικό", "Yttre", "ด้านนอก", "Vnější", "Ydre", "Dış", "Ytre", "Külső", "Ulkopuoli", "Ngoài", "Zewnętrzny", "Exterior"},
    ...
    {"Outer Lines", "å¤å´ã©ã¤ã³", "Außenlinien", "Líneas exteriores", "Lignes extérieures", "Linee esterne", "Buitenlijnen", "Linhas externas", "Внешние линии", "外侧线条", "외곽선", "الخطوط الخارجية", "Garis luar", "Зовнішні лінії", "Εξωτερικές γραμμές", "Ytterlinjer", "เส้นนอก", "Vnější čáry", "Ydre linjer", "Dış çizgiler", "Ytre linjer", "Külső vonalak", "Ulommat viivat", "Đường ngoài", "Linie zewnętrzne", "Linii exterioare"},
    {"Show", "è¡¨ç¤º", "Anzeigen", "Mostrar", "Afficher", "Mostra", "Tonen", "Mostrar", "Показать", "显示", "표시", "إظهار", "Tampilkan", "Показати", "Εμφάνιση", "Visa", "แสดง", "Zobrazit", "Vis", "Göster", "Vis", "Megjelenítés", "Näytä", "Hiện", "Pokaż", "Afișează"},
    {"Show Text", "æå­ãè¡¨ç¤º", "Text anzeigen", "Mostrar texto", "Afficher le texte", "Mostra testo", "Tekst tonen", "Mostrar texto", "Показать текст", "显示文字", "텍스트 표시", "إظهار النص", "Tampilkan Teks", "Показати текст", "Εμφάνιση κειμένου", "Visa text", "แสดงข้อความ", "Zobrazit text", "Vis tekst", "Metni göster", "Vis tekst", "Szöveg megjelenítése", "Näytä teksti", "Hiển thị chữ", "Pokaż tekst", "Afișează text"},
    {"Show Number", "æ°å¤ãè¡¨ç¤º", "Zahl anzeigen", "Mostrar número", "Afficher le nombre", "Mostra numero", "Nummer tonen", "Mostrar número", "Показать число", "显示数值", "숫자 표시", "إظهار الرقم", "Tampilkan angka", "Показати число", "Εμφάνιση αριθμού", "Visa nummer", "แสดงตัวเลข", "Zobrazit číslo", "Vis nummer", "Sayıyı göster", "Vis nummer", "Szám megjelenítése", "Näytä numero", "Hiển thị số", "Pokaż liczbę", "Afișează numărul"},
    ...
    {"Enable (Override All)", "æå¹å (å¨ä½ä¸æ¸ã)", "Aktivieren (Alles überschreiben)", "Activar (Anular todo)", "Activer (Remplacer tout)", "Abilita (Sostituisci tutto)", "Inschakelen (Alles overschrijven)", "Ativar (Substituir tudo)", "Включить (Переопределить всё)", "启用（覆盖全部）", "활성화 (전체 재정의)", "تفعيل (تجاوز الكل)", "Aktifkan (Ganti semua)", "Увімкнути (Перевизначити все)", "Ενεργοποίηση (Αντικατάσταση όλων)", "Aktivera (Ersätt alla)", "เปิดใช้ (แทนที่ทั้งหมด)", "Povolit (Přepsat vše)", "Aktiver (Tilsidesæt alt)", "Etkinleştir (Tümünü geçersiz kıl)", "Aktiver (Overstyr alt)", "Engedélyezés (Mindent felülír)", "Ota käyttöön (Korvaa kaikki)", "Bật (Ghi đè tất cả)", "Włącz (Zastąp wszystko)", "Activează (Înlocuiește tot)"},
    {"Opacity", "ä¸éæåº¦", "Deckkraft", "Opacidad", "Opacité", "Opacità", "Dekking", "Opacidade", "Непрозрачность", "不透明度", "불투명도", "الشفافية", "Opasitas", "Непрозорість", "Αδιαφάνεια", "Opacitet", "ความทึบ", "Neprůhlednost", "Uigennemsigtighed", "Opaklık", "Opasitet", "Átlátszatlanság", "Peittävyys", "Độ mờ", "Krycie", "Opacitate"},
    {"Length", "é·ã", "Länge", "Longitud", "Longueur", "Lunghezza", "Lengte", "Comprimento", "Длина", "长度", "길이", "الطول", "Panjang", "Довжина", "Μήκος", "Längd", "ความยาว", "Délka", "Længde", "Uzunluk", "Lengde", "Hossz", "Pituus", "Chiều dài", "Długość", "Lungime"},
    {"Length X", "é·ã X", "Länge X", "Longitud X", "Longueur X", "Lunghezza X", "Lengte X", "Comprimento X", "Длина X", "长度 X", "길이 X", "الطول X", "Panjang X", "Довжина X", "Μήκος X", "Längd X", "ความยาว X", "Délka X", "Længde X", "Uzunluk X", "Lengde X", "Hossz X", "Pituus X", "Chiều dài X", "Długość X", "Lungime X"},
    ...
    {"Link XY", "XYãé£å", "XY verknüpfen", "Vincular XY", "Lier XY", "Collega XY", "XY koppelen", "Vincular XY", "Связать XY", "联动 XY", "XY 연동", "ربط XY", "Tautkan XY", "Зв'язати XY", "Σύνδεση XY", "Länka XY", "เชื่อม XY", "Propojit XY", "Link XY", "XY bağla", "Koble XY", "XY összekapcsolása", "Linkitä XY", "Liên kết XY", "Połącz XY", "Leagă XY"},
    {"Thickness", "å¤ªã", "Dicke", "Grosor", "Épaisseur", "Spessore", "Dikte", "Espessura", "Толщина", "粗细", "두께", "السُمك", "Ketebalan", "Товщина", "Πάχος", "Tjocklek", "ความหนา", "Tloušťka", "Tykkelse", "Kalınlık", "Tykkelse", "Vastagság", "Paksuus", "Độ dày", "Grubość", "Grosime"},
    {"Offset", "ãªãã»ãã", "Versatz", "Desplazamiento", "Décalage", "Offset", "Offset", "Deslocamento", "Смещение", "偏移", "오프셋", "إزاحة", "Offset", "Зміщення", "Μετατόπιση", "Offset", "ออฟเซ็ต", "Posun", "Forskydning", "Ofset", "Forskyvning", "Eltolás", "Siirtymä", "Offset", "Przesunięcie", "Offset"},
    {"Offset X", "ãªãã»ãã X", "Versatz X", "Desplazamiento X", "Décalage X", "Offset X", "Offset X", "Deslocamento X", "Смещение X", "偏移 X", "오프셋 X", "إزاحة X", "Offset X", "Зміщення X", "Μετατόπιση X", "Offset X", "ออฟเซ็ต X", "Odsazení X", "Forskydning X", "Ofset X", "Offset X", "Eltolás X", "Siirtymä X", "Offset X", "Przesunięcie X", "Offset X"},
    ...
    {"Anchor", "åºæºä½ç½®", "Anker", "Ancla", "Ancrage", "Ancoraggio", "Anker", "Âncora", "Привязка", "锚点", "기준점", "مرساة", "Jangkar", "Прив'язка", "Άγκυρα", "Ankare", "จุดยึด", "Kotva", "Anker", "Çapa", "Anker", "Horgony", "Ankkuri", "Neo", "Kotwica", "Ancoră"},
    {"Top Left", "å·¦ä¸", "Oben links", "Arriba a la izquierda", "En haut à gauche", "In alto a sinistra", "Linksboven", "Superior esquerdo", "Вверху слева", "左上", "왼쪽 위", "أعلى يسار", "Kiri Atas", "Зверху ліворуч", "Πάνω αριστερά", "Övre vänster", "บนซ้าย", "Vlevo nahoře", "Øverst til venstre", "Sol üst", "Øverst til venstre", "Bal felső", "Ylhäällä vasemmalla", "Trên trái", "Góra lewo", "Sus stânga"},
    {"Top Center", "ä¸ä¸­å¤®", "Oben Mitte", "Arriba centro", "Haut centre", "In alto al centro", "Boven midden", "Superior central", "Верх по центру", "上中", "상단 중앙", "أعلى الوسط", "Tengah Atas", "Верх по центру", "Πάνω κέντρο", "Överst i mitten", "กลางบน", "Nahoře uprostřed", "Top midt", "Üst orta", "Topp midt", "Felső közép", "Yläkeskellä", "Giữa trên", "Góra środek", "Sus centru"},
    {"Top Right", "å³ä¸", "Oben rechts", "Arriba a la derecha", "En haut à droite", "In alto a destra", "Rechtsboven", "Superior direito", "Вверху справа", "右上", "오른쪽 위", "أعلى اليمين", "Kanan atas", "Вгорі справа", "Πάνω δεξιά", "Övre höger", "บนขวา", "Vpravo nahoře", "Øverst til højre", "Sağ üst", "Øverst til høyre", "Jobb felső", "Yläoikea", "Trên phải", "Góra prawo", "Sus dreapta"},
    ...
    {"Middle Center", "ä¸­å¤®", "Mitte Mitte", "Centro central", "Centre central", "Centro centrale", "Midden midden", "Centro central", "Центр по центру", "正中", "중앙", "الوسط المركزي", "Tengah tengah", "Центр по центру", "Κέντρο κέντρο", "Mitten mitten", "กลางกลาง", "Střed střed", "Midt midt", "Orta orta", "Midt midt", "Közép közép", "Keskellä keskellä", "Giữa giữa", "Środek środek", "Centru centru"},
    {"Middle Right", "å³ä¸­å¤®", "Mitte rechts", "Centro derecha", "Milieu droite", "Centro destra", "Midden rechts", "Centro direito", "Середина справа", "右中央", "오른쪽 중앙", "وسط يمين", "Kanan Tengah", "Посередині праворуч", "Μέση δεξιά", "Mitten höger", "กลางขวา", "Uprostřed vpravo", "Midt til højre", "Orta sağ", "Midt til høyre", "Közép jobb", "Keskellä oikealla", "Giữa phải", "Środek prawo", "Mijloc dreapta"},
    {"Bottom Left", "å·¦ä¸", "Unten links", "Abajo izquierda", "Bas gauche", "In basso a sinistra", "Linksonder", "Inferior esquerda", "Внизу слева", "左下", "왼쪽 하단", "أسفل اليسار", "Kiri Bawah", "Внизу зліва", "Κάτω αριστερά", "Nederst till vänster", "ซ้ายล่าง", "Dole vlevo", "Nederst til venstre", "Sol alt", "Nederst til venstre", "Bal alsó", "Alhaalla vasemmalla", "Dưới trái", "Dół lewo", "Jos stânga"},
    {"Bottom Center", "ä¸ä¸­å¤®", "Unten Mitte", "Abajo al centro", "En bas au centre", "In basso al centro", "Onder midden", "Inferior central", "Внизу по центру", "下中", "아래 중앙", "أسفل الوسط", "Tengah bawah", "Внизу по центру", "Κάτω κέντρο", "Nedre mitten", "ล่างกลาง", "Dole uprostřed", "Nederst i midten", "Alt orta", "Nederst i midten", "Alsó közép", "Alhaalla keskellä", "Dưới giữa", "Dół środek", "Jos centru"},
    ...
    {"Bot Right", "å³ä¸", "Unten rechts", "Abajo derecha", "Bas droite", "In basso a destra", "Onder rechts", "Inferior direita", "Внизу справа", "右下", "오른쪽 아래", "أسفل يمين", "Kanan bawah", "Внизу справа", "Κάτω δεξιά", "Nere höger", "ล่างขวา", "Dole vpravo", "Nede højre", "Alt sağ", "Nede høyre", "Lent jobbra", "Alhaalla oikealla", "Dưới phải", "Dół prawo", "Jos dreapta"},
    {"Left", "å·¦", "Links", "Izquierda", "Gauche", "Sinistra", "Links", "Esquerda", "Слева", "左", "왼쪽", "يسار", "Kiri", "Ліворуч", "Αριστερά", "Vänster", "ซ้าย", "Vlevo", "Venstre", "Sol", "Venstre", "Bal", "Vasen", "Trái", "Lewo", "Stânga"},
    {"Center", "ä¸­å¤®", "Mitte", "Centro", "Centre", "Centro", "Midden", "Centro", "По центру", "中央", "중앙", "الوسط", "Tengah", "По центру", "Κέντρο", "Centrum", "กลาง", "Střed", "Center", "Merkez", "Senter", "Közép", "Keskellä", "Giữa", "Środek", "Centru"},
    {"Right", "å³", "Rechts", "Derecha", "Droite", "Destra", "Rechts", "Direita", "Справа", "右", "오른쪽", "يمين", "Kanan", "Праворуч", "Δεξιά", "Höger", "ขวา", "Vpravo", "Højre", "Sağ", "Høyre", "Jobb", "Oikea", "Phải", "Prawo", "Dreapta"},
    ...
    {"Start", "éå§", "Start", "Inicio", "Début", "Inizio", "Start", "Início", "Начало", "开始", "시작", "بداية", "Mulai", "Початок", "Έναρξη", "Start", "เริ่ม", "Začátek", "Start", "Başlangıç", "Start", "Kezdet", "Alku", "Bắt đầu", "Początek", "Început"},
    ...
    {"Horizontal", "æ¨ª", "Horizontal", "Horizontal", "Horizontal", "Orizzontale", "Horizontaal", "Horizontal", "Горизонтально", "横向", "가로", "أفقي", "Horizontal", "Горизонтально", "Οριζόντια", "Horisontell", "แนวนอน", "Horizontální", "Horisontal", "Yatay", "Horisontal", "Vízszintes", "Vaaka", "Ngang", "Poziomo", "Orizontal"},
    {"Vertical", "ç¸¦", "Vertikal", "Vertical", "Vertical", "Verticale", "Verticaal", "Vertical", "Вертикально", "纵向", "세로", "عمودي", "Vertikal", "Вертикальний", "Κάθετο", "Vertikal", "แนวตั้ง", "Vertikální", "Vertikal", "Dikey", "Vertikal", "Függőleges", "Pysty", "Dọc", "Pionowy", "Vertical"},
    {"Horiz", "æ¨ª", "Horiz.", "Horiz.", "Horiz.", "Oriz.", "Horiz.", "Horiz.", "Гориз.", "横", "가로", "أفقي", "Horiz", "Гориз.", "Οριζ.", "Horiz", "แนวนอน", "Horiz", "Horiz", "Yatay", "Horiz", "Vízsz.", "Vaaka", "Ngang", "Poz.", "Oriz."},
    {"Vert", "ç¸¦", "Vert.", "Vert.", "Vert.", "Vert.", "Vert.", "Vert.", "Верт.", "纵", "세로", "عمودي", "Vert.", "Верт.", "Καθ.", "Vert.", "แนวตั้ง", "Vert.", "Vert.", "Dikey", "Vert.", "Függ.", "Pysty", "Dọc", "Pion.", "Vert."},
    ...
    {"Relative to Text", "ãã­ã¹ãåºæº", "Relativ zum Text", "Relativo al texto", "Relatif au texte", "Relativo al testo", "Relatief ten opzichte van tekst", "Relativo ao texto", "Относительно текста", "相对于文字", "텍스트 기준", "نسبة إلى النص", "Relatif ke teks", "Відносно тексту", "Σχετικά με κείμενο", "Relativt till text", "เทียบกับข้อความ", "Relativně k textu", "Relativt til tekst", "Metne göre", "Relativt til tekst", "Szöveghez viszonyítva", "Suhteessa tekstiin", "Tương đối văn bản", "Względem tekstu", "Relativ la text"},
    {"Independent", "ç¬ç«", "Unabhängig", "Independiente", "Indépendant", "Indipendente", "Onafhankelijk", "Independente", "Независимо", "独立", "독립", "مستقل", "Independen", "Незалежний", "Ανεξάρτητο", "Oberoende", "อิสระ", "Nezávislé", "Uafhængig", "Bağımsız", "Uavhengig", "Független", "Riippumaton", "Độc lập", "Niezależny", "Independent"},
    {"Gauge → Text", "ゲージ→文字", "Anzeige → Text", "Medidor → Texto", "Jauge → Texte", "Indicatore → Testo", "Meter → Tekst", "Medidor → Texto", "Индикатор → Текст", "计量条 → 文字", "게이지 → 텍스트", "مقياس → نص", "Gauge → Teks", "Індикатор → Текст", "Ένδειξη → Κείμενο", "Mätare → Text", "เกจ → ข้อความ", "Ukazatel → Text", "Måler → Tekst", "Gösterge → Metin", "Måler → Tekst", "Mérő → Szöveg", "Mittari → Teksti", "Thanh → Văn bản", "Wskaźnik → Tekst", "Indicator → Text"},
    {"Text→Gauge", "Text→Anzeige", "Text→Anzeige", "Texto→Medidor", "Texte→Jauge", "Testo→Indicatore", "Tekst→Meter", "Texto→Medidor", "Текст→Индикатор", "文字→量表", "텍스트→게이지", "Text→Anzeige", "Text→Anzeige", "Text→Anzeige", "Text→Anzeige", "Text→Anzeige", "Text→Anzeige", "Text→Anzeige", "Text→Anzeige", "Text→Anzeige", "Text→Anzeige", "Text→Anzeige", "Text→Anzeige", "Text→Anzeige", "Text→Anzeige", "Text→Anzeige"},
    {"Gauge → Text", "ゲージ→文字", "Anzeige → Text", "Medidor → Texto", "Jauge → Texte", "Indicatore → Testo", "Meter → Tekst", "Medidor → Texto", "Индикатор → Текст", "计量条 → 文字", "게이지 → 텍스트", "مقياس → نص", "Gauge → Teks", "Індикатор → Текст", "Ένδειξη → Κείμενο", "Mätare → Text", "เกจ → ข้อความ", "Ukazatel → Text", "Måler → Tekst", "Gösterge → Metin", "Måler → Tekst", "Mérő → Szöveg", "Mittari → Teksti", "Thanh → Văn bản", "Wskaźnik → Tekst", "Indicator → Text"},
    ...
    {"Position Mode", "ä½ç½®ã¢ã¼ã", "Positionsmodus", "Modo de posición", "Mode de position", "Modalità posizione", "Positiemodus", "Modo de posição", "Режим позиции", "位置模式", "위치 모드", "وضع الموضع", "Mode Posisi", "Режим позиції", "Λειτουργία θέσης", "Positionsläge", "โหมดตำแหน่ง", "Režim pozice", "Positionstilstand", "Konum modu", "Posisjonsmodus", "Pozíció mód", "Sijaintitila", "Chế độ vị trí", "Tryb pozycji", "Mod poziție"},
    {"Pos Mode", "ä½ç½®ã¢ã¼ã", "Positionsmodus", "Modo de posición", "Mode de position", "Modo posizione", "Positiemodus", "Modo de posição", "Режим позиции", "位置模式", "위치 모드", "وضع الموضع", "Mode Posisi", "Режим позиції", "Λειτουργία θέσης", "Positionsläge", "โหมดตำแหน่ง", "Režim pozice", "Positionstilstand", "Konum modu", "Posisjonsmodus", "Pozíció mód", "Sijaintitila", "Chế độ vị trí", "Tryb pozycji", "Mod poziție"},
    {"Gauge Side", "ã²ã¼ã¸å´", "Anzeigeseite", "Lado del medidor", "Côté de la jauge", "Lato indicatore", "Meterzijde", "Lado do medidor", "Сторона индикатора", "量表侧", "게이지 측면", "جانب المقياس", "Sisi gauge", "Сторона індикатора", "Πλευρά ένδειξης", "Mätarsida", "ด้านเกจ", "Strana ukazatele", "Målerside", "Gösterge tarafı", "Målerside", "Mérő oldala", "Mittarin puoli", "Cạnh đồng hồ", "Strona wskaźnika", "Latura indicatorului"},
    ...
    {"Gauge Anchor", "ã²ã¼ã¸åºæº", "Anzeigen-Anker", "Ancla del medidor", "Ancrage jauge", "Ancoraggio indicatore", "Meteranker", "Âncora do medidor", "Привязка шкалы", "计量条锚点", "게이지 기준점", "مرساة المقياس", "Jangkar pengukur", "Прив'язка шкали", "Άγκυρα μετρητή", "Mätare-ankare", "จุดยึดเกจ", "Kotva ukazatele", "Måleranker", "Gösterge çapası", "Måleranker", "Mérő horgony", "Mittarin ankkuri", "Neo thanh đo", "Kotwica wskaźnika", "Ancoră indicator"},
    {"Gauge X", "ã²ã¼ã¸ X", "Anzeige X", "Medidor X", "Jauge X", "Indicatore X", "Meter X", "Medidor X", "Индикатор X", "计量条 X", "게이지 X", "مقياس X", "Gauge X", "Шкала X", "Μέτρηση X", "Mätare X", "Gauge X", "Měřidlo X", "Måler X", "Gösterge X", "Måler X", "Mérő X", "Mittari X", "Đồng hồ X", "Wskaźnik X", "Indicator X"},
    {"Gauge Y", "ã²ã¼ã¸ Y", "Anzeige Y", "Indicador Y", "Jauge Y", "Indicatore Y", "Meter Y", "Medidor Y", "Индикатор Y", "指示条 Y", "게이지 Y", "مؤشر Y", "Gauge Y", "Індикатор Y", "Μετρητής Y", "Mätare Y", "Gauge Y", "Ukazatel Y", "Måler Y", "Gösterge Y", "Måler Y", "Mérő Y", "Mittari Y", "Gauge Y", "Wskaźnik Y", "Indicator Y"},
    {"Text Offset X", "æå­ãªãã»ãã X", "Textversatz X", "Desplazamiento del texto X", "Décalage texte X", "Offset testo X", "Tekstoffset X", "Deslocamento do texto X", "Смещение текста X", "文字偏移 X", "텍스트 오프셋 X", "إزاحة النص X", "Offset teks X", "Зміщення тексту X", "Μετατόπιση κειμένου X", "Textoffset X", "ออฟเซ็ตข้อความ X", "Odsazení textu X", "Tekstforskydning X", "Metin ofseti X", "Tekstoffset X", "Szöveg eltolás X", "Tekstin siirtymä X", "Offset chữ X", "Przesunięcie tekstu X", "Offset text X"},
    ...
    {"Align X", "æ´å X", "Ausrichtung X", "Alineación X", "Alignement X", "Allineamento X", "Uitlijning X", "Alinhamento X", "Выравнивание X", "对齐 X", "정렬 X", "محاذاة X", "Perataan X", "Вирівнювання X", "Στοίχιση X", "Justering X", "จัดแนว X", "Zarovnání X", "Justering X", "Hizalama X", "Justering X", "Igazítás X", "Tasaus X", "Căn X", "Wyrównanie X", "Aliniere X"},
    {"Align Y", "æ´å Y", "Ausrichtung Y", "Alineación Y", "Alignement Y", "Allineamento Y", "Uitlijning Y", "Alinhamento Y", "Выравнивание Y", "对齐 Y", "정렬 Y", "محاذاة Y", "Perataan Y", "Вирівнювання Y", "Στοίχιση Y", "Justering Y", "จัดแนว Y", "Zarovnání Y", "Justering Y", "Hizalama Y", "Justering Y", "Igazítás Y", "Tasaus Y", "Căn Y", "Wyrównanie Y", "Aliniere Y"},
    {"Orientation", "åã", "Ausrichtung", "Orientación", "Orientation", "Orientamento", "Orientatie", "Orientação", "Ориентация", "方向", "방향", "الاتجاه", "Orientasi", "Орієнтація", "Προσανατολισμός", "Orientering", "การวางแนว", "Orientace", "Retning", "Yönelim", "Retning", "Tájolás", "Suunta", "Hướng", "Orientacja", "Orientare"},
    {"Orient", "åã", "Ausrichtung", "Orientación", "Orientation", "Orientamento", "Uitlijning", "Orientação", "Ориентация", "方向", "방향", "توجيه", "Orientasi", "Орієнтація", "Προσανατολισμός", "Orientering", "ทิศทาง", "Orientace", "Retning", "Yönelim", "Retning", "Tájolás", "Suunta", "Hướng", "Orientacja", "Orientare"},
    ...
    {"Pos Y", "ä½ç½® Y", "Pos Y", "Pos Y", "Pos Y", "Pos Y", "Pos Y", "Pos Y", "Поз Y", "位置 Y", "Pos Y", "الموضع Y", "Pos Y", "Поз Y", "Θέση Y", "Pos Y", "Pos Y", "Pos Y", "Pos Y", "Pos Y", "Pos Y", "Pos Y", "Pos Y", "Pos Y", "Pos Y", "Pos Y"},
    {"Mode", "ã¢ã¼ã", "Modus", "Modo", "Mode", "Modalità", "Modus", "Modo", "Режим", "模式", "모드", "الوضع", "Mode", "Режим", "Λειτουργία", "Läge", "โหมด", "Režim", "Tilstand", "Mod", "Modus", "Mód", "Tila", "Chế độ", "Tryb", "Mod"},
    {"Layout", "ã¬ã¤ã¢ã¦ã", "Layout", "Diseño", "Disposition", "Layout", "Lay-out", "Layout", "Макет", "布局", "레이아웃", "التخطيط", "Layout", "Макет", "Διάταξη", "Layout", "เลย์เอาต์", "Rozvržení", "Layout", "Düzen", "Oppsett", "Elrendezés", "Asettelu", "Bố cục", "Układ", "Layout"},
    {"Weapon Layout", "æ­¦å¨ã¬ã¤ã¢ã¦ã", "Waffenlayout", "Diseño de armas", "Disposition des armes", "Layout armi", "Wapenlayout", "Layout de armas", "Расположение оружия", "武器布局", "무기 레이아웃", "تخطيط الأسلحة", "Tata letak senjata", "Розташування зброї", "Διάταξη όπλων", "Vapenlayout", "เลย์เอาต์อาวุธ", "Rozložení zbraní", "Våbenlayout", "Silah düzeni", "Våpenlayout", "Fegyver elrendezés", "Aseasettelu", "Bố cục vũ khí", "Układ broni", "Layout arme"},
    ...
    {"Label: Ring Time", "ã©ãã«: ãªã³ã°æé", "Label: Ringzeit", "Etiqueta: Tiempo de anillo", "Libellé : Temps d'anneau", "Etichetta: Tempo anello", "Label: Ringtijd", "Rótulo: Tempo do anel", "Метка: Время кольца", "标签：环时间", "라벨: 링 시간", "تسمية: وقت الحلقة", "Label: Waktu cincin", "Мітка: Час кільця", "Ετικέτα: Χρόνος δακτυλίου", "Etikett: Ringtid", "ป้ายกำกับ: เวลาวงแหวน", "Popisek: Čas kruhu", "Etiket: Ringtid", "Etiket: Halka süresi", "Etikett: Ringtid", "Címke: Gyűrű idő", "Tunniste: Rengasaika", "Nhãn: Thời gian vòng", "Etykieta: Czas pierścienia", "Etichetă: Timp inel"},
    {"Label: Prime Time", "ã©ãã«: ãã©ã¤ã æé", "Beschriftung: Prime Time", "Etiqueta: Prime Time", "Étiquette : Prime Time", "Etichetta: Prime Time", "Label: Prime Time", "Rótulo: Prime Time", "Метка: Prime Time", "标签：Prime Time", "라벨: Prime Time", "تسمية: Prime Time", "Label: Prime Time", "Мітка: Prime Time", "Ετικέτα: Prime Time", "Etikett: Prime Time", "ป้าย: Prime Time", "Popisek: Prime Time", "Etiket: Prime Time", "Etiket: Prime Time", "Etikett: Prime Time", "Címke: Prime Time", "Tunniste: Prime Time", "Nhãn: Prime Time", "Etykieta: Prime Time", "Etichetă: Prime Time"},
    {"Battle", "ããã«", "Kampf", "Batalla", "Combat", "Battaglia", "Gevecht", "Batalha", "Бой", "战斗", "배틀", "معركة", "Pertempuran", "Бій", "Μάχη", "Strid", "การต่อสู้", "Bitva", "Kamp", "Savaş", "Kamp", "Csata", "Taistelu", "Trận đấu", "Bitwa", "Luptă"},
    {"Bounty", "ãã¦ã³ãã£", "Kopfgeld", "Recompensa", "Prime", "Taglia", "Bounty", "Recompensa", "Награда", "赏金", "바운티", "مكافأة", "Bounty", "Нагорода", "Αμοιβή", "Bounty", "Bounty", "Odměna", "Bounty", "Ödül", "Bounty", "Fejpénz", "Palkkio", "Bounty", "Nagroda", "Recompensă"},
    ...
    {"Defender", "ãã£ãã§ã³ãã¼", "Verteidiger", "Defensor", "Défenseur", "Difensore", "Verdediger", "Defensor", "Защитник", "防守方", "디펜더", "مدافع", "Bertahan", "Захисник", "Υπερασπιστής", "Försvarare", "ป้องกัน", "Obránce", "Forsvarer", "Savunmacı", "Forsvarer", "Védő", "Puolustaja", "Phòng thủ", "Obrońca", "Apărător"},
    {"Prime", "ãã©ã¤ã ", "Prime", "Prime", "Prime", "Prime", "Prime", "Prime", "Prime", "Prime", "Prime", "Prime", "Prime", "Prime", "Prime", "Prime", "Prime", "Prime", "Prime", "Prime", "Prime", "Prime", "Prime", "Prime", "Prime", "Prime"},
    {"Label", "ã©ãã«", "Label", "Etiqueta", "Étiquette", "Etichetta", "Label", "Rótulo", "Метка", "标签", "라벨", "تسمية", "Label", "Мітка", "Ετικέτα", "Etikett", "ป้าย", "Popisek", "Label", "Etiket", "Etikett", "Címke", "Tunniste", "Nhãn", "Etykieta", "Etichetă"},
    {"Value", "å¤", "Wert", "Valor", "Valeur", "Valore", "Waarde", "Valor", "Значение", "值", "값", "قيمة", "Nilai", "Значення", "Τιμή", "Värde", "ค่า", "Hodnota", "Værdi", "Değer", "Verdi", "Érték", "Arvo", "Giá trị", "Wartość", "Valoare"},
    ...
    {"Value Color: Overall", "å¤ã®è²: å¨ä½", "Wertfarbe: Gesamt", "Color del valor: General", "Couleur valeur : Global", "Colore valore: Totale", "Waardekleur: Totaal", "Cor do valor: Geral", "Цвет значения: Общий", "数值颜色：整体", "값 색상: 전체", "لون القيمة: الإجمالي", "Warna nilai: Keseluruhan", "Колір значення: Загальний", "Χρώμα τιμής: Συνολικό", "Värdefärg: Totalt", "สีค่า: รวม", "Barva hodnoty: Celková", "Værdifarve: Samlet", "Değer rengi: Genel", "Verdifarge: Totalt", "Értékszín: Összesített", "Arvon väri: Kokonaisuus", "Màu giá trị: Tổng thể", "Kolor wartości: Ogólny", "Culoare valoare: General"},
    {"Sep Color", "åºåãè²", "Trennfarbe", "Color separador", "Couleur séparateur", "Colore separatore", "Scheidingskleur", "Cor separadora", "Цвет разделителя", "分隔色", "구분선 색상", "لون الفاصل", "Warna Pemisah", "Колір розділювача", "Χρώμα διαχωρισμού", "Separatorfärg", "สีตัวคั่น", "Barva oddělovače", "Separatorfarve", "Ayırıcı rengi", "Skillefarge", "Elválasztó szín", "Erottimen väri", "Màu phân cách", "Kolor separatora", "Culoare separator"},
    {"Sep Color: Overall", "åºåãè²: å¨ä½", "Trennfarbe: Gesamt", "Color de separación: General", "Couleur de séparation : Global", "Colore separatore: Generale", "Scheidingskleur: Algemeen", "Cor de separação: Geral", "Цвет разделителя: Общий", "分隔颜色: 整体", "구분 색상: 전체", "لون الفاصل: إجمالي", "Warna Pemisah: Keseluruhan", "Колір розділювача: Загальний", "Χρώμα διαχωρισμού: Συνολικό", "Separationsfärg: Övergripande", "สีตัวคั่น: โดยรวม", "Barva oddělovače: Celkové", "Separationsfarve: Samlet", "Ayırıcı rengi: Genel", "Separasjonsfarge: Samlet", "Elválasztó szín: Összesített", "Erottimen väri: Kokonais", "Màu phân cách: Tổng thể", "Kolor separatora: Ogólny", "Culoare separator: General"},
    {"Goal Color", "ç®æ¨è²", "Zielfarbe", "Color de objetivo", "Couleur objectif", "Colore obiettivo", "Doelkleur", "Cor do objetivo", "Цвет цели", "目标颜色", "목표 색상", "لون الهدف", "Warna tujuan", "Колір цілі", "Χρώμα στόχου", "Målfärg", "สีเป้าหมาย", "Barva cíle", "Målfarve", "Hedef rengi", "Målfarge", "Cél színe", "Tavoitteen väri", "Màu mục tiêu", "Kolor celu", "Culoare obiectiv"},
    ...
    {"Src Radius", "ã½ã¼ã¹åå¾", "Quell-Radius", "Radio origen", "Rayon source", "Raggio sorgente", "Bronradius", "Raio de origem", "Исходный радиус", "源半径", "소스 반경", "نصف قطر المصدر", "Radius sumber", "Вихідний радіус", "Ακτίνα πηγής", "Källradie", "รัศมีต้นทาง", "Zdrojový poloměr", "Kilderadius", "Kaynak yarıçapı", "Kilderadius", "Forrás sugár", "Lähdesäde", "Bán kính nguồn", "Promień źródła", "Rază sursă"},
    {"Corner Radius", "è§ä¸¸åå¾", "Eckenradius", "Radio de esquina", "Rayon d'angle", "Raggio angolo", "Hoekradius", "Raio do canto", "Радиус угла", "圆角半径", "모서리 반경", "نصف قطر الزاوية", "Radius Sudut", "Радіус кута", "Ακτίνα γωνίας", "Hörnradie", "รัศมีมุม", "Poloměr rohu", "Hjørneradius", "Köşe yarıçapı", "Hjørneradius", "Sarok sugár", "Kulmasäde", "Bán kính góc", "Promień rogu", "Rază colț"},
    {"Padding", "ä½ç½", "Abstand", "Relleno", "Marge", "Padding", "Padding", "Preenchimento", "Отступ", "边距", "여백", "Padding", "Padding", "Відступ", "Padding", "Padding", "Padding", "Odsazení", "Padding", "Padding", "Padding", "Kitöltés", "Täyte", "Padding", "Padding", "Padding"},
    {"Spacing", "éé", "Abstand", "Espaciado", "Espacement", "Spaziatura", "Afstand", "Espaçamento", "Интервал", "间距", "간격", "تباعد", "Jarak", "Інтервал", "Διάκενο", "Avstånd", "ระยะห่าง", "Rozestup", "Afstand", "Aralık", "Avstand", "Távolság", "Väli", "Khoảng cách", "Odstęp", "Spațiere"},
    ...
    {"Highlight", "ãã¤ã©ã¤ã", "Hervorhebung", "Resaltado", "Surbrillance", "Evidenziazione", "Markering", "Destaque", "Подсветка", "高亮", "하이라이트", "تمييز", "Sorotan", "Підсвітка", "Επισήμανση", "Markering", "ไฮไลต์", "Zvýraznění", "Fremhævning", "Vurgulama", "Utheving", "Kiemelés", "Korostus", "Nổi bật", "Podświetlenie", "Evidențiere"},
    {"Highlight Current Weapon", "ç¾å¨ã®æ­¦å¨ããã¤ã©ã¤ã", "Aktuelle Waffe hervorheben", "Resaltar arma actual", "Mettre en évidence l'arme actuelle", "Evidenzia arma corrente", "Huidig wapen markeren", "Destacar arma atual", "Выделить текущее оружие", "高亮当前武器", "현재 무기 강조", "تمييز السلاح الحالي", "Sorot Senjata Saat Ini", "Підсвітити поточну зброю", "Επισήμανση τρέχοντος όπλου", "Markera aktuellt vapen", "ไฮไลต์อาวุธปัจจุบัน", "Zvýraznit aktuální zbraň", "Fremhæv nuværende våben", "Geçerli silahı vurgula", "Uthev gjeldende våpen", "Aktuális fegyver kiemelése", "Korosta nykyinen ase", "Làm nổi bật vũ khí hiện tại", "Podświetl bieżącą broń", "Evidențiază arma curentă"},
    {"Highlight Color", "ãã¤ã©ã¤ãè²", "Hervorhebungsfarbe", "Color de resaltado", "Couleur de surbrillance", "Colore evidenziazione", "Highlightkleur", "Cor de destaque", "Цвет выделения", "高亮颜色", "하이라이트 색상", "لون التمييز", "Warna Sorotan", "Колір виділення", "Χρώμα επισήμανσης", "Markeringsfärg", "สีไฮไลต์", "Barva zvýraznění", "Fremhævningsfarve", "Vurgu rengi", "Uthevingsfarge", "Kiemelés szín", "Korostuksen väri", "Màu nổi bật", "Kolor podświetlenia", "Culoare evidențiere"},
    {"Highlight Opacity", "ãã¤ã©ã¤ãä¸éæåº¦", "Hervorhebungsdeckkraft", "Opacidad del resaltado", "Opacité de surbrillance", "Opacità evidenziazione", "Highlight-dekking", "Opacidade do destaque", "Непрозрачность подсветки", "高亮不透明度", "하이라이트 불투명도", "شفافية التمييز", "Opasitas sorotan", "Непрозорість підсвітки", "Αδιαφάνεια επισήμανσης", "Markeringsopacitet", "ความทึบไฮไลต์", "Neprůhlednost zvýraznění", "Fremhævningsopacitet", "Vurgu opaklığı", "Uthevingsopasitet", "Kiemelés átlátszatlansága", "Korostuksen läpinäkymättömyys", "Độ mờ nổi bật", "Krycie podświetlenia", "Opacitate evidențiere"},
    ...
    {"Hl Opacity", "HLä¸éæåº¦", "HL-Deckkraft", "Opacidad HL", "Opacité HL", "Opacità HL", "HL-dekking", "Opacidade HL", "Непрозрачность HL", "HL 不透明度", "HL 불투명도", "شفافية HL", "Opasitas HL", "Непрозорість HL", "Αδιαφάνεια HL", "HL-opacitet", "ความทึบ HL", "Neprůhlednost HL", "HL-gennemsigtighed", "HL opaklığı", "HL-opasitet", "HL átlátszatlanság", "HL:n läpinäkymättömyys", "Độ mờ HL", "Krycie HL", "Opacitate HL"},
    {"Hl Thickness", "HLå¤ªã", "HL-Dicke", "Grosor HL", "Épaisseur HL", "Spess. HL", "HL-dikte", "Espess. HL", "Толщ. HL", "HL粗细", "HL 두께", "سُمك التمييز", "Ketebalan HL", "Товщ. підсв.", "Πάχος HL", "HL-tjocklek", "ความหนา HL", "Tloušťka HL", "HL-tykkelse", "HL kalınlığı", "HL-tykkelse", "HL vastagság", "HL-paksuus", "Độ dày HL", "Grubość HL", "Grosime HL"},
    {"Hl Padding", "HLä½ç½", "HL-Abstand", "Relleno HL", "Marge HL", "Padding HL", "HL-padding", "Preenchimento HL", "Отступ HL", "HL 边距", "HL 여백", "Hl Padding", "Hl Padding", "Відступ HL", "Hl Padding", "Hl-padding", "Hl Padding", "Odsazení HL", "Hl-padding", "Hl Padding", "Hl-padding", "HL kitöltés", "HL-täyte", "Hl Padding", "Padding HL", "Hl Padding"},
    {"Hl Corner Radius", "HLè§ä¸¸", "HL-Eckenradius", "Radio de esquina HL", "Rayon coin HL", "Raggio angolo HL", "HL-hoekradius", "Raio de canto HL", "Радиус угла HL", "HL 圆角", "HL 모서리 반경", "نصف قطر زاوية HL", "Radius sudut HL", "Радіус кута HL", "Ακτίνα γωνίας HL", "HL-hörnradius", "รัศมีมุม HL", "Poloměr rohu HL", "HL-hjørneradius", "HL köşe yarıçapı", "HL-hjørneradius", "HL sarok sugara", "HL-kulman säde", "Bán kính góc HL", "Promień rogu HL", "Rază colț HL"},
    ...
    {"Hl Ofs Right", "HLå³Ofs", "HL-Ofs rechts", "Despl. HL derecha", "Décal. HL droite", "Ofs HL destra", "HL-ofs rechts", "Desloc. HL direita", "Смещ. HL вправо", "HL 右偏移", "HL Ofs 오른쪽", "إزاحة HL يمين", "Ofs HL kanan", "Зміщ. HL вправо", "Μετατόπιση HL δεξιά", "HL-ofs höger", "Ofs HL ขวา", "Ofs HL vpravo", "HL-ofs højre", "HL ofs sağ", "HL-ofs høyre", "HL ofs jobbra", "HL:n ofs oikea", "Ofs HL phải", "Ofs HL w prawo", "Ofs HL dreapta"},
    ...
    {"HP Label Color By Value", "HPã©ãã«ã®è² (å¤é£å)", "HP-Label-Farbe nach Wert", "Color de etiqueta HP según valor", "Couleur libellé HP selon valeur", "Colore etichetta HP per valore", "HP-labelkleur op waarde", "Cor do rótulo HP por valor", "Цвет метки HP по значению", "HP 标签颜色（按数值）", "HP 라벨 색상 (값별)", "لون تسمية HP حسب القيمة", "Warna label HP menurut nilai", "Колір мітки HP за значенням", "Χρώμα ετικέτας HP ανά τιμή", "HP-etikettfärg efter värde", "สีป้าย HP ตามค่า", "Barva popisku HP podle hodnoty", "HP-etiketfarve efter værdi", "Değere göre HP etiket rengi", "HP-etikettfarge etter verdi", "HP címke színe érték szerint", "HP-tunnisteen väri arvon mukaan", "Màu nhãn HP theo giá trị", "Kolor etykiety HP według wartości", "Culoare etichetă HP după valoare"},
    {"HP Outline", "HPã®ã¢ã¦ãã©ã¤ã³", "HP-Umriss", "Contorno HP", "Contour HP", "Contorno HP", "HP-omtrek", "Contorno HP", "Контур HP", "HP 轮廓", "HP 외곽선", "حد HP", "Garis Luar HP", "Контур HP", "Περίγραμμα HP", "HP-kontur", "เส้นขอบ HP", "Obrys HP", "HP-kontur", "HP ana hat", "HP-kontur", "HP körvonal", "HP-ääriviiva", "Viền HP", "Obrys HP", "Contur HP"},
    {"HP Gauge", "HPã²ã¼ã¸", "HP-Anzeige", "Indicador de HP", "Jauge de PV", "Indicatore HP", "HP-meter", "Medidor de HP", "Индикатор HP", "HP 指示条", "HP 게이지", "مؤشر HP", "Gauge HP", "Індикатор HP", "Μετρητής HP", "HP-mätare", "Gauge HP", "Ukazatel HP", "HP-måler", "HP göstergesi", "HP-måler", "HP mérő", "HP-mittari", "Gauge HP", "Wskaźnik HP", "Indicator HP"},
    {"HP Gauge Color By Value", "HPã²ã¼ã¸ã®è² (å¤é£å)", "HP-Anzeigefarbe nach Wert", "Color del medidor de HP según valor", "Couleur jauge HP selon la valeur", "Colore indicatore HP per valore", "HP-meterkleur op waarde", "Cor do medidor de HP por valor", "Цвет индикатора HP по значению", "HP 量表颜色（按数值）", "HP 게이지 색상 (값 연동)", "لون مقياس HP حسب القيمة", "Warna gauge HP menurut nilai", "Колір індикатора HP за значенням", "Χρώμα ένδειξης HP ανά τιμή", "HP-mätarfärg efter värde", "สีเกจ HP ตามค่า", "Barva ukazatele HP podle hodnoty", "HP-målerfarve efter værdi", "Değere göre HP göstergesi rengi", "HP-målerfarge etter verdi", "HP mérő színe érték szerint", "HP-mittarin väri arvon mukaan", "Màu đồng hồ HP theo giá trị", "Kolor wskaźnika HP według wartości", "Culoare indicator HP după valoare"},
    ...
    {"Match Status", "è©¦åæå ±", "Spielstand", "Estado de partida", "État du match", "Stato partita", "Wedstrijdstatus", "Estado da partida", "Состояние матча", "比赛状态", "매치 상태", "حالة المباراة", "Status pertandingan", "Стан матчу", "Κατάσταση αγώνα", "Matchstatus", "สถานะแมตช์", "Stav zápasu", "Kampstatus", "Maç durumu", "Kampstatus", "Mérkőzés állapota", "Ottelun tila", "Trạng thái trận", "Stan meczu", "Stare meci"},
    {"Score", "ã¹ã³ã¢", "Punktestand", "Puntuación", "Score", "Punteggio", "Score", "Pontuação", "Счёт", "分数", "점수", "النتيجة", "Skor", "Рахунок", "Σκορ", "Poäng", "คะแนน", "Skóre", "Score", "Skor", "Poeng", "Pontszám", "Pisteet", "Điểm", "Wynik", "Scor"},
    {"Score Labels", "ã¹ã³ã¢ã©ãã«", "Punkte-Labels", "Etiquetas de puntuación", "Étiquettes de score", "Etichette punteggio", "Scorelabels", "Rótulos de pontuação", "Метки счёта", "分数标签", "점수 라벨", "تسميات النقاط", "Label Skor", "Мітки рахунку", "Ετικέτες σκορ", "Poängetiketter", "ป้ายคะแนน", "Popisky skóre", "Scorelabels", "Skor etiketleri", "Poeng-etiketter", "Pontszám címkék", "Pistetunnisteet", "Nhãn điểm", "Etykiety wyniku", "Etichete scor"},
    {"Score Colors", "ã¹ã³ã¢ã®è²", "Punktefarben", "Colores de puntuación", "Couleurs de score", "Colori punteggio", "Scorekleuren", "Cores de pontuação", "Цвета счёта", "得分颜色", "점수 색상", "ألوان النقاط", "Warna skor", "Кольори рахунку", "Χρώματα σκορ", "Poängfärger", "สีคะแนน", "Barvy skóre", "Scorefarver", "Skor renkleri", "Poengfarger", "Pontszín", "Pisteiden värit", "Màu điểm", "Kolory wyniku", "Culori scor"},
    ...
    {"Rank / Time", "é ä½ / æé", "Rang / Zeit", "Rango / Tiempo", "Rang / Temps", "Grado / Tempo", "Rang / Tijd", "Classificação / Tempo", "Ранг / Время", "排名 / 时间", "순위 / 시간", "الرتبة / الوقت", "Peringkat / Waktu", "Ранг / Час", "Κατάταξη / Χρόνος", "Rang / Tid", "อันดับ / เวลา", "Pořadí / Čas", "Rang / Tid", "Sıra / Süre", "Rang / Tid", "Rang / Idő", "Sijoitus / Aika", "Hạng / Thời gian", "Ranga / Czas", "Rang / Timp"},
    {"Rank", "é ä½", "Rang", "Rango", "Rang", "Grado", "Rang", "Classificação", "Ранг", "排名", "순위", "الرتبة", "Peringkat", "Ранг", "Κατάταξη", "Rang", "อันดับ", "Hodnost", "Rang", "Sıra", "Rang", "Rang", "Sijoitus", "Hạng", "Ranga", "Rang"},
    {"Rank Outline", "é ä½ã®ã¢ã¦ãã©ã¤ã³", "Rang-Umriss", "Contorno de rango", "Contour du rang", "Contorno rango", "Rangomtrek", "Contorno de rank", "Контур ранга", "排名轮廓", "순위 외곽선", "حدود الرتبة", "Garis Peringkat", "Контур рангу", "Περίγραμμα βαθμού", "Rangkontur", "เส้นขอบอันดับ", "Obrys hodnosti", "Rangkontur", "Rütbe ana hattı", "Rangkontur", "Rang körvonal", "Arvon ääriviiva", "Viền hạng", "Obrys rangi", "Contur rang"},
    {"Time Left", "æ®ãæé", "Verbleibende Zeit", "Tiempo restante", "Temps restant", "Tempo rimanente", "Resterende tijd", "Tempo restante", "Оставшееся время", "剩余时间", "남은 시간", "الوقت المتبقي", "Waktu tersisa", "Час, що залишився", "Χρόνος που απομένει", "Tid kvar", "เวลาที่เหลือ", "Zbývající čas", "Tid tilbage", "Kalan süre", "Tid igjen", "Hátralévő idő", "Aikaa jäljellä", "Thời gian còn lại", "Pozostały czas", "Timp rămas"},
    ...
    {"Time Limit", "å¶éæé", "Zeitlimit", "Límite de tiempo", "Limite de temps", "Limite di tempo", "Tijdslimiet", "Limite de tempo", "Лимит времени", "时间限制", "시간 제한", "حد الوقت", "Batas waktu", "Ліміт часу", "Χρονικό όριο", "Tidsgräns", "จำกัดเวลา", "Časový limit", "Tidsgrænse", "Süre sınırı", "Tidsgrense", "Időkorlát", "Aikaraja", "Giới hạn thời gian", "Limit czasu", "Limită de timp"},
    {"Time Limit Outline", "å¶éæéã®ã¢ã¦ãã©ã¤ã³", "Zeitlimit-Umriss", "Contorno de límite de tiempo", "Contour limite de temps", "Contorno limite tempo", "Tijdslimiet-omtrek", "Contorno de limite de tempo", "Контур лимита времени", "时间限制轮廓", "제한 시간 외곽선", "حد حد الوقت", "Garis Luar Batas Waktu", "Контур ліміту часу", "Περίγραμμα χρονικού ορίου", "Tidsgränskontur", "เส้นขอบจำกัดเวลา", "Obrys časového limitu", "Tidsgrænsekontur", "Süre sınırı ana hat", "Tidsgrensekontur", "Időkorlát körvonal", "Aikarajan ääriviiva", "Viền giới hạn thời gian", "Obrys limitu czasu", "Contur limită timp"},
    {"Bomb", "ãã ", "Bombe", "Bomba", "Bombe", "Bomba", "Bom", "Bomba", "Бомба", "炸弹", "폭탄", "قنبلة", "Bom", "Бомба", "Βόμβα", "Bomb", "ระเบิด", "Bomba", "Bombe", "Bomba", "Bombe", "Bomba", "Pommi", "Bom", "Bomba", "Bombă"},
    {"Bomb Left", "æ®ããã ", "Bomben übrig", "Bombas restantes", "Bombes restantes", "Bombe rimaste", "Bommen over", "Bombas restantes", "Бомб осталось", "剩余炸弹", "남은 폭탄", "القنابل المتبقية", "Bom tersisa", "Бомб залишилось", "Βόμβες που απομένουν", "Bomber kvar", "ระเบิดที่เหลือ", "Zbývající bomby", "Bomber tilbage", "Kalan bomba", "Bomber igjen", "Hátralévő bombák", "Pommeja jäljellä", "Bom còn lại", "Pozostałe bomby", "Bombe rămase"},
    ...
    {"Frame Outline", "ãã¬ã¼ã ã®ã¢ã¦ãã©ã¤ã³", "Rahmenkontur", "Contorno del marco", "Contour du cadre", "Contorno cornice", "Frame-omlijning", "Contorno da moldura", "Контур рамки", "边框轮廓", "프레임 외곽선", "حدود الإطار", "Garis luar bingkai", "Контур рамки", "Περίγραμμα πλαισίου", "Ramkontur", "เส้นขอบเฟรม", "Obrys rámečku", "Rammeomrids", "Çerçeve dış çizgisi", "Rammeomriss", "Keret körvonal", "Kehyksen ääriviiva", "Viền khung", "Kontur ramki", "Contur cadru"},
    {"Crosshair", "ç§æº", "Fadenkreuz", "Retícula", "Réticule", "Mirino", "Richtkruis", "Mira", "Прицел", "准星", "조준선", "شبكة التصويب", "Reticle", "Приціл", "Σταυρονόμι", "Sikte", "เรติเคิล", "Mířidla", "Sigtekorn", "Nişangah", "Sikte", "Célkereszt", "Tähtäin", "Tâm ngắm", "Celownik", "Reticul"},
    {"Wpn\\\\\\\\nIcon", "武器\\\\\\\\nアイコン", "Wpn\nSymbol", "Arma\nIcono", "Arme\nIcône", "Arma\nIcona", "Wpn\nPictogram", "Arma\nÍcone", "Оруж.\nЗначок", "武器\n图标", "무기\n아이콘", "Wpn\nIcon", "Wpn\nIkon", "Збр.\nЗначок", "Όπλ.\nΕικονίδιο", "Vap\nIkon", "Wpn\nไอคอน", "Zbr.\nIkona", "Våb\nIkon", "Sil\nSimge", "Våp\nIkon", "Fegy\nIkon", "Ase\nKuvake", "Wpn\nBiểu tượng", "Broń\nIkona", "Armă\nPictogramă"},
    {"Bmb\\\\\\\\nIcon", "ボム\\\\\\\\nアイコン", "Bomben-\nSymbol", "Icono\nde bomba", "Icône\nbombe", "Icona\nbomba", "Bom\npictogram", "Ícone\nde bomba", "Иконка\nбомбы", "炸弹\n图标", "폭탄\n아이콘", "أيقونة\nقنبلة", "Ikon\nbom", "Іконка\nбомби", "Εικονίδιο\nβόμβας", "Bomb-\nikon", "ไอคอน\nระเบิด", "Ikona\nbomby", "Bombe-\nikon", "Bomba\nsimgesi", "Bombe-\nikon", "Bomba\nikon", "Pommi-\nikoni", "Biểu tượng\nbom", "Ikona\nbomby", "Pictogram\nbombă"},
    {"Wpn\\\\\\\\nInventory", "武器\\\\\\\\n一覧", "Waffen-\nInventar", "Armas\nInventario", "Armes\nInventaire", "Armi\nInventario", "Wapen-\nInventaris", "Armas\nInventário", "Оружие\nИнвентарь", "武器\n栏", "무기\n인벤토리", "أسلحة\nالمخزون", "Senjata\nInventori", "Зброя\nІнвентар", "Όπλα\nΑπόθεμα", "Vapen\nInventarie", "อาวุธ\nคลัง", "Zbraně\nInventář", "Våben\nInventar", "Silah\nEnvanter", "Våpen\nInventar", "Fegyver\nInventár", "Aseet\nInventaario", "Vũ khí\nKho", "Broń\nEkwipunek", "Arme\nInventar"},
    {"WPN", "æ­¦å¨", "WPN", "ARM", "ARM", "ARM", "WPN", "ARM", "ОРУ", "武器", "무기", "WPN", "WPN", "WPN", "WPN", "WPN", "WPN", "WPN", "WPN", "WPN", "WPN", "WPN", "WPN", "WPN", "WPN", "WPN"},
    {"BMB", "ãã ", "BMB", "BMB", "BMB", "BMB", "BMB", "BMB", "BMB", "炸弹", "폭탄", "BMB", "BMB", "BMB", "BMB", "BMB", "BMB", "BMB", "BMB", "BMB", "BMB", "BMB", "BMB", "BMB", "BMB", "BMB"},
    {"points", "å¾ç¹", "Punkte", "puntos", "points", "punti", "punten", "pontos", "очки", "得分", "점수", "نقاط", "poin", "очки", "πόντοι", "poäng", "คะแนน", "body", "point", "puan", "poeng", "pont", "pisteet", "điểm", "punkty", "puncte"},
    {"Bombs", "ãã ", "Bomben", "Bombas", "Bombes", "Bombe", "Bommen", "Bombas", "Бомбы", "炸弹", "폭탄", "قنابل", "Bom", "Бомби", "Βόμβες", "Bomber", "ระเบิด", "Bomby", "Bomber", "Bombalar", "Bomber", "Bombák", "Pommit", "Bom", "Bomby", "Bombe"},
    ...
    {"Acquiring Node", "ãã¼ãåå¾ä¸­", "Knoten wird erobert", "Capturando nodo", "Acquisition de nœud", "Acquisizione nodo", "Knooppunt veroveren", "Capturando nó", "Захват узла", "占领节点中", "노드 점령 중", "الاستحواذ على العقدة", "Mengambil node", "Захоплення вузла", "Απόκτηση κόμβου", "Tar över nod", "ยึดโหนด", "Získávání uzlu", "Overtager node", "Düğüm ele geçiriliyor", "Tar over node", "Csomópont megszerzése", "Solmun valtaus", "Chiếm node", "Przejmowanie węzła", "Achiziționare nod"},
    {"Turret", "ã¿ã¬ãã", "Geschütz", "Torreta", "Tourelle", "Torretta", "Turret", "Torreta", "Турель", "炮塔", "터렛", "برج", "Menara", "Турель", "Πύργος", "Torn", "ป้อม", "Věž", "Tårn", "Taret", "Tårn", "Torony", "Torni", "Tháp pháo", "Wieżyczka", "Turetă"},
    {"Octo Reset", "ãªã¯ããªã¹ãªã»ãã", "Octo-Reset", "Reinicio Octo", "Réinitialisation Octo", "Reset Octo", "Octo-reset", "Redefinir Octo", "Сброс Octo", "Octo 重置", "Octo 리셋", "Octo Reset", "Reset Octo", "Скинути Octo", "Octo Reset", "Octo-återställning", "Octo Reset", "Reset Octo", "Octo-nulstilling", "Octo Sıfırla", "Octo-tilbakestilling", "Octo visszaállítás", "Octo-nollaus", "Octo Reset", "Reset Octo", "Reset Octo"},
    {"Octo Drop", "ãªã¯ããªã¹ãã­ãã", "Oktolith-Drop", "Caída de octolito", "Chute d'octolithe", "Drop octoliti", "Octoliet-drop", "Queda de octolito", "Выпадение октолита", "Octolith 掉落", "옥톨리스 드롭", "سقوط Octolith", "Drop Octolith", "Випадення Octolith", "Πτώση Octolith", "Octolith-drop", "ดรอป Octolith", "Drop Octolith", "Octolith-drop", "Octolith düşüşü", "Octolith-drop", "Octolith drop", "Octolith-pudotus", "Rơi Octolith", "Drop Octolith", "Drop Octolith"},
    ...
    {"Octo Missing", "ãªã¯ããªã¹æªææ", "Oktolith fehlt", "Octólito ausente", "Octolithe manquant", "Octolito mancante", "Octoliet ontbreekt", "Octólito ausente", "Октолит отсутствует", "八边形缺失", "옥토리스 미보유", "أوكتوليث مفقود", "Octolith hilang", "Октоліт відсутній", "Λείπει Octolith", "Octolith saknas", "ไม่มี Octolith", "Chybí Octolith", "Octolith mangler", "Octolith eksik", "Octolith mangler", "Hiányzó Octolith", "Octolith puuttuu", "Thiếu Octolith", "Brak Octolith", "Octolith lipsă"},
    {"Slot: Kill / Death  [flags=0x02]", "ã¹ã­ãã: ã­ã« / ãã¹ [flags=0x02]", "Slot: Kill / Death  [flags=0x02]", "Slot: Kill / Death  [flags=0x02]", "Slot : Kill / Death  [flags=0x02]", "Slot: Kill / Death  [flags=0x02]", "Slot: Kill / Death  [flags=0x02]", "Slot: Kill / Death  [flags=0x02]", "Слот: Kill / Death  [flags=0x02]", "槽位：击杀 / 死亡 [flags=0x02]", "슬롯: Kill / Death  [flags=0x02]", "Slot: Kill / Death  [flags=0x02]", "Slot: Kill / Death  [flags=0x02]", "Slot: Kill / Death  [flags=0x02]", "Slot: Kill / Death  [flags=0x02]", "Slot: Kill / Death  [flags=0x02]", "Slot: Kill / Death  [flags=0x02]", "Slot: Kill / Death  [flags=0x02]", "Slot: Kill / Death  [flags=0x02]", "Slot: Kill / Death  [flags=0x02]", "Slot: Kill / Death  [flags=0x02]", "Slot: Kill / Death  [flags=0x02]", "Slot: Kill / Death  [flags=0x02]", "Slot: Kill / Death  [flags=0x02]", "Slot: Kill / Death  [flags=0x02]", "Slot: Kill / Death  [flags=0x02]"},
    {"Slot: Node Capture  [flags=0x11]", "ã¹ã­ãã: ãã¼ãåå¾ [flags=0x11]", "Slot: Knotenerfassung  [flags=0x11]", "Ranura: Captura de nodo  [flags=0x11]", "Emplacement : Capture de nœud  [flags=0x11]", "Slot: Cattura nodo  [flags=0x11]", "Slot: Knooppunt vastleggen  [flags=0x11]", "Slot: Captura de nó  [flags=0x11]", "Слот: Захват узла  [flags=0x11]", "槽位: 节点占领 [flags=0x11]", "슬롯: 노드 점령 [flags=0x11]", "Slot: Node Capture  [flags=0x11]", "Slot: Node Capture  [flags=0x11]", "Слот: Захоплення вузла  [flags=0x11]", "Slot: Node Capture  [flags=0x11]", "Slot: Node Capture  [flags=0x11]", "Slot: Node Capture  [flags=0x11]", "Slot: Node Capture  [flags=0x11]", "Slot: Node Capture  [flags=0x11]", "Slot: Node Capture  [flags=0x11]", "Slot: Node Capture  [flags=0x11]", "Slot: Node Capture  [flags=0x11]", "Slot: Node Capture  [flags=0x11]", "Slot: Node Capture  [flags=0x11]", "Slot: Node Capture  [flags=0x11]", "Slot: Node Capture  [flags=0x11]"},
    {"Slot: Objective     [flags=0x01]", "ã¹ã­ãã: ç®æ¨ [flags=0x01]", "Slot: Ziel     [flags=0x01]", "Ranura: Objetivo     [flags=0x01]", "Emplacement : Objectif     [flags=0x01]", "Slot: Obiettivo     [flags=0x01]", "Slot: Doel     [flags=0x01]", "Slot: Objetivo     [flags=0x01]", "Слот: Цель     [flags=0x01]", "槽位：目标     [flags=0x01]", "슬롯: 목표     [flags=0x01]", "فتحة: الهدف     [flags=0x01]", "Slot: Objektif     [flags=0x01]", "Слот: Ціль     [flags=0x01]", "Θύρα: Στόχος     [flags=0x01]", "Plats: Mål     [flags=0x01]", "สล็อต: เป้าหมาย     [flags=0x01]", "Slot: Cíl     [flags=0x01]", "Slot: Mål     [flags=0x01]", "Yuva: Hedef     [flags=0x01]", "Spor: Mål     [flags=0x01]", "Slot: Cél     [flags=0x01]", "Paikka: Tavoite     [flags=0x01]", "Slot: Mục tiêu     [flags=0x01]", "Slot: Cel     [flags=0x01]", "Slot: Obiectiv     [flags=0x01]"},
    ...
    {"Yellow Green", "é»ç·", "Gelbgrün", "Verde amarillento", "Vert jaune", "Giallo-verde", "Geelgroen", "Verde-amarelado", "Жёлто-зелёный", "黄绿色", "황록색", "أخضر مصفر", "Hijau kekuningan", "Жовто-зелений", "Κιτρινοπράσινο", "Gulgrön", "เขียวเหลือง", "Žlutozelená", "Gulgrøn", "Sarı yeşil", "Gulgrønn", "Sárgászöld", "Keltavihreä", "Vàng xanh", "Żółtozielony", "Galben-verde"},
    {"Green Yellow", "ç·é»", "Grüngelb", "Verde amarillo", "Jaune vert", "Giallo verde", "Geelgroen", "Verde amarelo", "Жёлто-зелёный", "绿黄", "녹황", "أخضر أصفر", "Hijau Kuning", "Зелено-жовтий", "Πράσινο κίτρινο", "Gröngul", "เขียวเหลือง", "Zeleně žlutá", "Grøngul", "Yeşil sarı", "Grønngul", "Zöldes sárga", "Vihreänkeltainen", "Xanh vàng", "Zielono-żółty", "Galben verzui"},
    {"Yellow", "é»", "Gelb", "Amarillo", "Jaune", "Giallo", "Geel", "Amarelo", "Жёлтый", "黄", "노랑", "أصفر", "Kuning", "Жовтий", "Κίτρινο", "Gul", "เหลือง", "Žlutá", "Gul", "Sarı", "Gul", "Sárga", "Keltainen", "Vàng", "Żółty", "Galben"},
    {"Pure Cyan", "ç´ã·ã¢ã³", "Reines Cyan", "Cian puro", "Cyan pur", "Ciano puro", "Zuiver cyaan", "Ciano puro", "Чистый циан", "纯青", "순수 시안", "سماوي نقي", "Sian murni", "Чистий ціан", "Καθαρό κυανό", "Rent cyan", "ฟ้าบริสุทธิ์", "Čistý azurový", "Ren cyan", "Saf cyan", "Ren cyan", "Tiszta cián", "Puhdas syaani", "Xanh lơ thuần", "Czysty cyjan", "Cian pur"},
    ...
    {"Pink", "ãã³ã¯", "Rosa", "Rosa", "Rose", "Rosa", "Roze", "Rosa", "Розовый", "粉色", "분홍", "وردي", "Merah muda", "Рожевий", "Ροζ", "Rosa", "ชมพู", "Růžová", "Pink", "Pembe", "Rosa", "Rózsaszín", "Vaaleanpunainen", "Hồng", "Różowy", "Roz"},
    {"Red", "èµ¤", "Rot", "Rojo", "Rouge", "Rosso", "Rood", "Vermelho", "Красный", "红", "빨강", "أحمر", "Merah", "Червоний", "Κόκκινο", "Röd", "แดง", "Červená", "Rød", "Kırmızı", "Rød", "Piros", "Punainen", "Đỏ", "Czerwony", "Roșu"},
    {"Orange", "ãªã¬ã³ã¸", "Orange", "Naranja", "Orange", "Arancione", "Oranje", "Laranja", "Оранжевый", "橙", "주황", "برتقالي", "Oranye", "Помаранчевий", "Πορτοκαλί", "Orange", "ส้ม", "Oranžová", "Orange", "Turuncu", "Oransje", "Narancs", "Oranssi", "Cam", "Pomarańczowy", "Portocaliu"},
    {"Samus Hud", "ãµã ã¹HUD", "Samus-HUD", "HUD de Samus", "HUD Samus", "HUD Samus", "Samus-HUD", "HUD da Samus", "HUD Samus", "Samus HUD", "사무스 HUD", "HUD Samus", "HUD Samus", "HUD Samus", "HUD Samus", "Samus-HUD", "HUD Samus", "HUD Samus", "Samus-HUD", "Samus HUD", "Samus-HUD", "Samus HUD", "Samus-HUD", "HUD Samus", "HUD Samus", "HUD Samus"},
    ...
    {"Kanden Hud", "ã«ã³ãã³HUD", "Kanden-HUD", "HUD de Kanden", "HUD Kanden", "HUD Kanden", "Kanden-HUD", "HUD de Kanden", "HUD Kanden", "Kanden HUD", "Kanden HUD", "HUD Kanden", "HUD Kanden", "HUD Kanden", "HUD Kanden", "Kanden-HUD", "HUD Kanden", "HUD Kanden", "Kanden-HUD", "Kanden HUD", "Kanden-HUD", "Kanden HUD", "Kanden-HUD", "HUD Kanden", "HUD Kanden", "HUD Kanden"},
    {"Spire Hud", "ã¹ãã¤ã¢HUD", "Spire-HUD", "HUD Spire", "HUD Spire", "HUD Spire", "Spire-HUD", "HUD Spire", "HUD Spire", "Spire HUD", "Spire HUD", "HUD Spire", "HUD Spire", "HUD Spire", "HUD Spire", "Spire-HUD", "HUD Spire", "HUD Spire", "Spire-HUD", "Spire HUD", "Spire-HUD", "Spire HUD", "Spire HUD", "HUD Spire", "HUD Spire", "HUD Spire"},
    {"Spire Hud Outline", "ã¹ãã¤ã¢HUDã®ã¢ã¦ãã©ã¤ã³", "Spire-HUD-Umriss", "Contorno HUD Spire", "Contour HUD Spire", "Contorno HUD Spire", "Spire HUD-omtrek", "Contorno HUD Spire", "Контур HUD Spire", "Spire HUD 轮廓", "Spire HUD 외곽선", "Spire Hud Outline", "Spire Hud Outline", "Spire Hud Outline", "Spire Hud Outline", "Spire Hud Outline", "Spire Hud Outline", "Spire Hud Outline", "Spire Hud Outline", "Spire Hud Outline", "Spire Hud Outline", "Spire Hud Outline", "Spire Hud Outline", "Spire Hud Outline", "Spire Hud Outline", "Spire Hud Outline"},
    {"Trace Hud", "ãã¬ã¼ã¹HUD", "Trace-HUD", "HUD de Trace", "HUD Trace", "HUD Trace", "Trace-HUD", "HUD do Trace", "HUD Trace", "Trace HUD", "트레이스 HUD", "HUD Trace", "HUD Trace", "HUD Trace", "HUD Trace", "Trace-HUD", "HUD Trace", "HUD Trace", "Trace-HUD", "Trace HUD", "Trace-HUD", "Trace HUD", "Trace-HUD", "HUD Trace", "HUD Trace", "HUD Trace"},
    ...
    {"Noxus Hud Outline", "ãã¯ãµã¹HUDã®ã¢ã¦ãã©ã¤ã³", "Noxus-HUD-Kontur", "Contorno del HUD de Noxus", "Contour HUD Noxus", "Contorno HUD Noxus", "Noxus-HUD-omlijning", "Contorno do HUD de Noxus", "Контур HUD Noxus", "Noxus HUD 轮廓", "Noxus HUD 외곽선", "حدود HUD Noxus", "Garis luar HUD Noxus", "Контур HUD Noxus", "Περίγραμμα HUD Noxus", "Noxus-HUD-kontur", "เส้นขอบ HUD Noxus", "Obrys HUD Noxus", "Noxus-HUD-kontur", "Noxus HUD dış çizgisi", "Noxus-HUD-kontur", "Noxus HUD körvonal", "Noxus-HUD:n ääriviiva", "Viền HUD Noxus", "Kontur HUD Noxus", "Contur HUD Noxus"},
    {"Sylux Hud", "ãµã¤ã©ãã¯ã¹HUD", "Sylux-HUD", "HUD Sylux", "HUD Sylux", "HUD Sylux", "Sylux-HUD", "HUD Sylux", "HUD Sylux", "Sylux HUD", "Sylux HUD", "HUD Sylux", "HUD Sylux", "HUD Sylux", "HUD Sylux", "Sylux-HUD", "HUD Sylux", "HUD Sylux", "Sylux-HUD", "Sylux HUD", "Sylux-HUD", "Sylux HUD", "Sylux HUD", "HUD Sylux", "HUD Sylux", "HUD Sylux"},
    {"Sylux Crosshair", "ãµã¤ã©ãã¯ã¹ç§æº", "Sylux-Fadenkreuz", "Retícula Sylux", "Réticule Sylux", "Mirino Sylux", "Sylux richtkruis", "Mira Sylux", "Прицел Sylux", "Sylux 准星", "Sylux 조준선", "Sylux Crosshair", "Sylux Crosshair", "Sylux Crosshair", "Sylux Crosshair", "Sylux Crosshair", "Sylux Crosshair", "Sylux Crosshair", "Sylux Crosshair", "Sylux Crosshair", "Sylux Crosshair", "Sylux Crosshair", "Sylux Crosshair", "Sylux Crosshair", "Sylux Crosshair", "Sylux Crosshair"},
    {"Weavel Hud", "ã¦ã£ã¼ã´ã§ã«HUD", "Weavel-HUD", "HUD de Weavel", "HUD Weavel", "HUD Weavel", "Weavel-HUD", "HUD do Weavel", "HUD Weavel", "Weavel HUD", "위벨 HUD", "HUD Weavel", "HUD Weavel", "HUD Weavel", "HUD Weavel", "Weavel-HUD", "HUD Weavel", "HUD Weavel", "Weavel-HUD", "Weavel HUD", "Weavel-HUD", "Weavel HUD", "Weavel-HUD", "HUD Weavel", "HUD Weavel", "HUD Weavel"},
    ...
    {"Avium Purple", "ã¢ã´ã£ã¦ã ç´«", "Avium-Lila", "Púrpura Avium", "Violet Avium", "Viola Avium", "Avium-paars", "Roxo Avium", "Фиолетовый Avium", "Avium 紫", "Avium 보라", "بنفسجي Avium", "Ungu Avium", "Фіолетовий Avium", "Μωβ Avium", "Avium-lila", "ม่วง Avium", "Fialová Avium", "Avium-lilla", "Avium mor", "Avium-lilla", "Avium lila", "Avium-violetti", "Tím Avium", "Fiolet Avium", "Violet Avium"},
    {"OSD Bright Green", "OSDæããç·", "OSD Hellgrün", "OSD verde brillante", "OSD vert vif", "OSD verde brillante", "OSD heldergroen", "OSD verde brilhante", "OSD ярко-зелёный", "OSD 亮绿", "OSD 밝은 녹색", "OSD أخضر فاتح", "OSD Hijau Terang", "OSD яскраво-зелений", "OSD φωτεινό πράσινο", "OSD ljusgrön", "OSD เขียวสด", "OSD světle zelená", "OSD lysegrøn", "OSD parlak yeşil", "OSD lysegrønn", "OSD világoszöld", "OSD kirkkaanvihreä", "OSD xanh sáng", "OSD jasnozielony", "OSD verde deschis"},
    {"OSD No-Ammo Red", "OSDå¼¾è¬ãªãèµ¤", "OSD Keine-Munition Rot", "OSD sin munición rojo", "OSD plus de munitions rouge", "OSD munizioni esaurite rosso", "OSD geen munitie rood", "OSD sem munição vermelho", "OSD нет боеприпасов красный", "OSD 无弹药红色", "OSD 탄약 없음 빨강", "OSD No-Ammo Red", "OSD No-Ammo Red", "OSD No-Ammo Red", "OSD No-Ammo Red", "OSD No-Ammo Red", "OSD No-Ammo Red", "OSD No-Ammo Red", "OSD No-Ammo Red", "OSD No-Ammo Red", "OSD No-Ammo Red", "OSD No-Ammo Red", "OSD No-Ammo Red", "OSD No-Ammo Red", "OSD No-Ammo Red", "OSD No-Ammo Red"},
    {"Power Beam", "ãã¯ã¼ãã¼ã ", "Power Beam", "Power Beam", "Power Beam", "Power Beam", "Power Beam", "Power Beam", "Power Beam", "Power Beam", "Power Beam", "Power Beam", "Power Beam", "Power Beam", "Power Beam", "Power Beam", "Power Beam", "Power Beam", "Power Beam", "Power Beam", "Power Beam", "Power Beam", "Power Beam", "Power Beam", "Power Beam", "Power Beam"},
    {"Volt Driver", "ボルトドライバー", "Volt Driver", "Volt Driver", "Volt Driver", "Volt Driver", "Volt Driver", "Volt Driver", "Volt Driver", "Volt Driver", "Volt Driver", "Volt Driver", "Volt Driver", "Volt Driver", "Volt Driver", "Volt Driver", "Volt Driver", "Volt Driver", "Volt Driver", "Volt Driver", "Volt Driver", "Volt Driver", "Volt Driver", "Volt Driver", "Volt Driver", "Volt Driver"},
    {"VoltDriver", "ãã«ããã©ã¤ãã¼", "VoltDriver", "VoltDriver", "VoltDriver", "VoltDriver", "VoltDriver", "VoltDriver", "VoltDriver", "VoltDriver", "VoltDriver", "VoltDriver", "VoltDriver", "VoltDriver", "VoltDriver", "VoltDriver", "VoltDriver", "VoltDriver", "VoltDriver", "VoltDriver", "VoltDriver", "VoltDriver", "VoltDriver", "VoltDriver", "VoltDriver", "VoltDriver"},
    {"Missile", "ããµã¤ã«", "Rakete", "Misil", "Missile", "Missile", "Raket", "Míssil", "Ракета", "导弹", "미사일", "صاروخ", "Misil", "Ракета", "Πύραυλος", "Missil", "มิสไซล์", "Střela", "Missil", "Füze", "Missil", "Rakéta", "Ohjus", "Tên lửa", "Pocisk", "Rachetă"},
    {"Battle Hammer", "ããã«ãã³ãã¼", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battle Hammer", "Battle Hammer", "Battle Hammer", "Battle Hammer", "Battle Hammer", "Battle Hammer", "Battle Hammer", "Battle Hammer", "Battle Hammer", "Battle Hammer", "Battle Hammer", "Battle Hammer", "Battle Hammer", "Battle Hammer", "Battle Hammer"},
    {"Battlehammer", "ããã«ãã³ãã¼", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer", "Battlehammer"},
    ...
    {"Judicator", "ã¸ã¥ãã£ã±ã¤ã¿ã¼", "Judicator", "Judicator", "Judicator", "Judicator", "Judicator", "Judicator", "Judicator", "Judicator", "Judicator", "Judicator", "Judicator", "Judicator", "Judicator", "Judicator", "Judicator", "Judicator", "Judicator", "Judicator", "Judicator", "Judicator", "Judicator", "Judicator", "Judicator", "Judicator"},
    {"Magmaul", "ãã°ã¢ã¼ã«", "Magmaul", "Magmaul", "Magmaul", "Magmaul", "Magmaul", "Magmaul", "Magmaul", "Magmaul", "Magmaul", "Magmaul", "Magmaul", "Magmaul", "Magmaul", "Magmaul", "Magmaul", "Magmaul", "Magmaul", "Magmaul", "Magmaul", "Magmaul", "Magmaul", "Magmaul", "Magmaul", "Magmaul"},
    {"Shock Coil", "ã·ã§ãã¯ã³ã¤ã«", "Shock Coil", "Shock Coil", "Shock Coil", "Shock Coil", "Shock Coil", "Shock Coil", "Shock Coil", "Shock Coil", "Shock Coil", "Shock Coil", "Shock Coil", "Shock Coil", "Shock Coil", "Shock Coil", "Shock Coil", "Shock Coil", "Shock Coil", "Shock Coil", "Shock Coil", "Shock Coil", "Shock Coil", "Shock Coil", "Shock Coil", "Shock Coil"},
    {"ShockCoil", "ã·ã§ãã¯ã³ã¤ã«", "ShockCoil", "ShockCoil", "ShockCoil", "ShockCoil", "ShockCoil", "ShockCoil", "ShockCoil", "ShockCoil", "ShockCoil", "ShockCoil", "ShockCoil", "ShockCoil", "ShockCoil", "ShockCoil", "ShockCoil", "ShockCoil", "ShockCoil", "ShockCoil", "ShockCoil", "ShockCoil", "ShockCoil", "ShockCoil", "ShockCoil", "ShockCoil"},
    ...
    {"PB Color", "PBè²", "PB-Farbe", "Color PB", "Couleur PB", "Colore PB", "PB-kleur", "Cor PB", "Цвет PB", "PB 颜色", "PB 색상", "لون PB", "Warna PB", "Колір PB", "Χρώμα PB", "PB-färg", "สี PB", "Barva PB", "PB-farve", "PB rengi", "PB-farge", "PB szín", "PB-väri", "Màu PB", "Kolor PB", "Culoare PB"},
    {"VD Color", "VDè²", "VD-Farbe", "Color VD", "Couleur VD", "Colore VD", "VD-kleur", "Cor VD", "Цвет VD", "VD 色", "VD 색상", "لون VD", "Warna VD", "Колір VD", "Χρώμα VD", "VD-färg", "สี VD", "Barva VD", "VD-farve", "VD rengi", "VD-farge", "VD szín", "VD-väri", "Màu VD", "Kolor VD", "Culoare VD"},
    {"MSL Color", "MSLè²", "MSL-Farbe", "Color MSL", "Couleur MSL", "Colore MSL", "MSL-kleur", "Cor MSL", "Цвет MSL", "MSL 颜色", "MSL 색상", "MSL Color", "MSL Color", "MSL Color", "MSL Color", "MSL Color", "MSL Color", "MSL Color", "MSL Color", "MSL Color", "MSL Color", "MSL Color", "MSL Color", "MSL Color", "MSL Color", "MSL Color"},
    {"BH Color", "BHè²", "BH-Farbe", "Color BH", "Couleur BH", "Colore BH", "BH-kleur", "Cor BH", "Цвет BH", "BH 颜色", "BH 색상", "لون BH", "Warna BH", "Колір BH", "Χρώμα BH", "BH-färg", "สี BH", "Barva BH", "BH-farve", "BH rengi", "BH-farge", "BH szín", "BH-väri", "Màu BH", "Kolor BH", "Culoare BH"},
    ...
    {"JUD Color", "JUDè²", "JUD-Farbe", "Color JUD", "Couleur JUD", "Colore JUD", "JUD-kleur", "Cor JUD", "Цвет JUD", "JUD 颜色", "JUD 색상", "لون JUD", "Warna JUD", "Колір JUD", "Χρώμα JUD", "JUD-färg", "สี JUD", "Barva JUD", "JUD-farve", "JUD rengi", "JUD-farge", "JUD szín", "JUD-väri", "Màu JUD", "Kolor JUD", "Culoare JUD"},
    {"MAG Color", "MAGè²", "MAG-Farbe", "Color MAG", "Couleur MAG", "Colore MAG", "MAG-kleur", "Cor MAG", "Цвет MAG", "MAG 色", "MAG 색상", "لون MAG", "Warna MAG", "Колір MAG", "Χρώμα MAG", "MAG-färg", "สี MAG", "Barva MAG", "MAG-farve", "MAG rengi", "MAG-farge", "MAG szín", "MAG-väri", "Màu MAG", "Kolor MAG", "Culoare MAG"},
    {"SCL Color", "SCLè²", "SCL-Farbe", "Color SCL", "Couleur SCL", "Colore SCL", "SCL-kleur", "Cor SCL", "Цвет SCL", "SCL 颜色", "SCL 색상", "SCL Color", "SCL Color", "SCL Color", "SCL Color", "SCL Color", "SCL Color", "SCL Color", "SCL Color", "SCL Color", "SCL Color", "SCL Color", "SCL Color", "SCL Color", "SCL Color", "SCL Color"},
    {"OC Color", "OCè²", "OC-Farbe", "Color OC", "Couleur OC", "Colore OC", "OC-kleur", "Cor OC", "Цвет OC", "OC 颜色", "OC 색상", "لون OC", "Warna OC", "Колір OC", "Χρώμα OC", "OC-färg", "สี OC", "Barva OC", "OC-farve", "OC rengi", "OC-farge", "OC szín", "OC-väri", "Màu OC", "Kolor OC", "Culoare OC"},
    ...
    {"Extra Light", "ç¹ç´°", "Extra Light", "Extra Light", "Extra Light", "Extra Light", "Extra Light", "Extra Light", "Extra Light", "Extra Light", "Extra Light", "Extra Light", "Extra Light", "Extra Light", "Extra Light", "Extra Light", "Extra Light", "Extra Light", "Extra Light", "Extra Light", "Extra Light", "Extra Light", "Extra Light", "Extra Light", "Extra Light", "Extra Light"},
    {"Light", "ç´°å­", "Leicht", "Ligera", "Léger", "Leggero", "Licht", "Leve", "Тонкий", "细体", "가는", "خفيف", "Ringan", "Легкий", "Ελαφρύ", "Lätt", "เบา", "Lehké", "Let", "Hafif", "Lett", "Könnyű", "Kevyt", "Nhẹ", "Lekki", "Ușor"},
    {"Normal", "æ¨æº", "Standard", "Estándar", "Standard", "Standard", "Standaard", "Padrão", "Стандартный", "标准", "표준", "عادي", "Normal", "Стандартний", "Κανονικό", "Normal", "ปกติ", "Normální", "Normal", "Normal", "Normal", "Normál", "Normaali", "Bình thường", "Normalny", "Normal"},
    {"Medium", "ä¸­å¤ª", "Mittel", "Medio", "Moyen", "Medio", "Gemiddeld", "Médio", "Средний", "中", "중간", "متوسط", "Sedang", "Середній", "Μέτριο", "Medel", "ปานกลาง", "Střední", "Mellem", "Orta", "Middels", "Közepes", "Keskitaso", "Trung bình", "Średni", "Mediu"},
    ...
    {"Bold", "å¤ªå­", "Fett", "Negrita", "Gras", "Grassetto", "Vet", "Negrito", "Жирный", "粗体", "굵게", "عريض", "Tebal", "Жирний", "Έντονα", "Fet", "ตัวหนา", "Tučné", "Fed", "Kalın", "Fet", "Félkövér", "Lihavoitu", "Đậm", "Pogrubienie", "Aldin"},
    {"Extra Bold", "æ¥µå¤ª", "Extra fett", "Extra negrita", "Extra gras", "Extra grassetto", "Extra vet", "Extra negrito", "Экстра жирный", "极粗", "초굵게", "عريض جداً", "Ekstra Tebal", "Дуже жирний", "Έξτρα έντονο", "Extra fet", "หนามาก", "Extra tučné", "Ekstra fed", "Ekstra kalın", "Ekstra fet", "Extra vastag", "Erittäin lihavoitu", "Cực đậm", "Ekstra pogrubiony", "Extra bold"},
    {"Black", "é»å¤ª", "Schwarz", "Negro", "Noir", "Nero", "Zwart", "Preto", "Чёрный", "黑", "검정", "أسود", "Hitam", "Чорний", "Μαύρο", "Svart", "ดำ", "Černá", "Sort", "Siyah", "Svart", "Fekete", "Musta", "Đen", "Czarny", "Negru"},

    // Ramp labels
    {"Number of Colors", "è²æ°", "Anzahl der Farben", "Número de colores", "Nombre de couleurs", "Numero di colori", "Aantal kleuren", "Número de cores", "Количество цветов", "颜色数量", "색상 수", "عدد الألوان", "Jumlah warna", "Кількість кольорів", "Αριθμός χρωμάτων", "Antal färger", "จำนวนสี", "Počet barev", "Antal farver", "Renk sayısı", "Antall farger", "Színek száma", "Värien määrä", "Số màu", "Liczba kolorów", "Număr de culori"},
    ...
    {"Threshold 2 (%)", "ãããå¤ 2 (%)", "Schwellwert 2 (%)", "Umbral 2 (%)", "Seuil 2 (%)", "Soglia 2 (%)", "Drempel 2 (%)", "Limite 2 (%)", "Порог 2 (%)", "阈值 2 (%)", "임계값 2 (%)", "العتبة 2 (%)", "Ambang 2 (%)", "Поріг 2 (%)", "Όριο 2 (%)", "Tröskel 2 (%)", "เกณฑ์ 2 (%)", "Práh 2 (%)", "Tærskel 2 (%)", "Eşik 2 (%)", "Terskel 2 (%)", "Küszöb 2 (%)", "Kynnys 2 (%)", "Ngưỡng 2 (%)", "Próg 2 (%)", "Prag 2 (%)"},
    {"Threshold 3 (%)", "ãããå¤ 3 (%)", "Schwellenwert 3 (%)", "Umbral 3 (%)", "Seuil 3 (%)", "Soglia 3 (%)", "Drempel 3 (%)", "Limite 3 (%)", "Порог 3 (%)", "阈值 3 (%)", "임계값 3 (%)", "العتبة 3 (%)", "Ambang 3 (%)", "Поріг 3 (%)", "Όριο 3 (%)", "Tröskel 3 (%)", "เกณฑ์ 3 (%)", "Práh 3 (%)", "Tærskel 3 (%)", "Eşik 3 (%)", "Terskel 3 (%)", "Küszöb 3 (%)", "Kynnys 3 (%)", "Ngưỡng 3 (%)", "Próg 3 (%)", "Prag 3 (%)"},
    {"Threshold 4 (%)", "ãããå¤ 4 (%)", "Schwellenwert 4 (%)", "Umbral 4 (%)", "Seuil 4 (%)", "Soglia 4 (%)", "Drempel 4 (%)", "Limite 4 (%)", "Порог 4 (%)", "阈值 4 (%)", "임계값 4 (%)", "Threshold 4 (%)", "Threshold 4 (%)", "Threshold 4 (%)", "Threshold 4 (%)", "Threshold 4 (%)", "Threshold 4 (%)", "Threshold 4 (%)", "Threshold 4 (%)", "Threshold 4 (%)", "Threshold 4 (%)", "Threshold 4 (%)", "Threshold 4 (%)", "Threshold 4 (%)", "Threshold 4 (%)", "Threshold 4 (%)"},
    {"Threshold 5 (%)", "ãããå¤ 5 (%)", "Schwellwert 5 (%)", "Umbral 5 (%)", "Seuil 5 (%)", "Soglia 5 (%)", "Drempel 5 (%)", "Limite 5 (%)", "Порог 5 (%)", "阈值 5 (%)", "임계값 5 (%)", "عتبة 5 (%)", "Ambang 5 (%)", "Поріг 5 (%)", "Όριο 5 (%)", "Tröskel 5 (%)", "เกณฑ์ 5 (%)", "Prah 5 (%)", "Tærskel 5 (%)", "Eşik 5 (%)", "Terskel 5 (%)", "Küszöb 5 (%)", "Kynnys 5 (%)", "Ngưỡng 5 (%)", "Próg 5 (%)", "Prag 5 (%)"},
    ...
    {"Color 1", "è² 1", "Farbe 1", "Color 1", "Couleur 1", "Colore 1", "Kleur 1", "Cor 1", "Цвет 1", "颜色 1", "색상 1", "اللون 1", "Warna 1", "Колір 1", "Χρώμα 1", "Färg 1", "สี 1", "Barva 1", "Farve 1", "Renk 1", "Farge 1", "Szín 1", "Väri 1", "Màu 1", "Kolor 1", "Culoare 1"},
    {"Color 2", "è² 2", "Farbe 2", "Color 2", "Couleur 2", "Colore 2", "Kleur 2", "Cor 2", "Цвет 2", "颜色 2", "색상 2", "اللون 2", "Warna 2", "Колір 2", "Χρώμα 2", "Färg 2", "สี 2", "Barva 2", "Farve 2", "Renk 2", "Farge 2", "Szín 2", "Väri 2", "Màu 2", "Kolor 2", "Culoare 2"},
    {"Color 3", "è² 3", "Farbe 3", "Color 3", "Couleur 3", "Colore 3", "Kleur 3", "Cor 3", "Цвет 3", "颜色 3", "색상 3", "Color 3", "Color 3", "Color 3", "Color 3", "Color 3", "Color 3", "Color 3", "Color 3", "Color 3", "Color 3", "Color 3", "Color 3", "Color 3", "Color 3", "Color 3"},
    {"Color 4", "è² 4", "Farbe 4", "Color 4", "Couleur 4", "Colore 4", "Kleur 4", "Cor 4", "Цвет 4", "颜色 4", "색상 4", "لون 4", "Warna 4", "Колір 4", "Χρώμα 4", "Färg 4", "สี 4", "Barva 4", "Farve 4", "Renk 4", "Farge 4", "Szín 4", "Väri 4", "Màu 4", "Kolor 4", "Culoare 4"},
