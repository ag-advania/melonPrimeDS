...
public:
    ...
    // Qt 経由 WM_INPUT（joy2KeySupport=true の時だけ使う）
...
private:
    //=====================================================
    // 独自 RawInput スレッド（joy2KeySupport=false のときのみ）
    //=====================================================
    ...
    void registerRawToTarget(HWND targetHwnd) noexcept;
