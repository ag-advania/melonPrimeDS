...
extern const uint32_t Blob034[6560];
inline constexpr uint32_t Blob034_Words = 6560u;
...
extern const uint32_t Blob037[48627];
inline constexpr uint32_t Blob037_Words = 48627u;
...
extern const uint32_t Blob072[6560];
inline constexpr uint32_t Blob072_Words = 6560u;
...
extern const uint32_t Blob075[48631];
inline constexpr uint32_t Blob075_Words = 48631u;
...
extern const uint32_t Blob110[6560];
inline constexpr uint32_t Blob110_Words = 6560u;
...
extern const uint32_t Blob113[48627];
inline constexpr uint32_t Blob113_Words = 48627u;
