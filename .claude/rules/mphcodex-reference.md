...
- For investigation flow and reusable commands, read:
  - `.claude/skills/調査スキル.md`
  - `.claude/skills/調査コマンド集.md`
...
- After implementing, build with `.claude\skills\build-mingw.bat` or the
  existing-build variant as described in `.claude/rules/build.md`.
