...
| 7 — Vulkan Classic 3D correctness baseline | Phase 7.1 native raster bootstrap implemented; Phase 7.2 clear-plane bootstrap implemented; Windows build/runtime pending | `pending Phase 7 continuation commit` | Windows Vulkan build pending | offscreen draw/readback and clear-plane attachment/readback harness pending | Windows UCRT64 package | ROM still uses Software; clear bitmap, polygon upload and DS polygon raster remain pending; see `tests/vulkan/reference/phase7-clear-plane-verification.md` | Revert the Phase 7 continuation commit |
