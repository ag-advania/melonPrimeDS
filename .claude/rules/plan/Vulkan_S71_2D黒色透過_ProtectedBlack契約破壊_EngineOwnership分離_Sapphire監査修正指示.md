...
| S71-6 | Track Sapphire FrameLatch extraction and desktop adapter parity in CI | **done** | `SAPPHIRE_SOURCE_MANIFEST.md` に FrameLatch / black-contract adapter を追記。`.github/workflows/sapphire-vendor-parity.yml` に S71 test を追加。 |
