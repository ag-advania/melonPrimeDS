...
| OPT-HRT1 | HUD runtime base/adventure/visible state is cached by `NDS* + MainRAM + NumFrames + player offset + ROM group` | Repeated 120/240Hz draws of the same emulated frame reuse HP, pause, view, hunter, weapon, and ammo-cap state instead of re-reading RAM | Per game frame |
