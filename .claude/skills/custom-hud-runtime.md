...
Use this as the reference when changing runtime Custom HUD rendering, caching, the no-HUD patch, fonts, auto-scale, or the radar overlay. For the settings dialog / edit-mode UI surfaces, see [settings-ui-and-edit-mode.md](settings-ui-and-edit-mode.md).
