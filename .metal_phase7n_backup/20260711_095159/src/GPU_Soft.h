...
public:
    ...
    bool Get3DReplacementMasks(void** top, void** bottom);
...
private:
    ...
    u32* Framebuffer[2][2];
    u8* Framebuffer3DReplaceMode[2][2];

    u32* Output3D;
    alignas(8) u32 Output2D[2][256];
    alignas(8) u8 Output3DReplaceMode[256];

    void DrawScanlineA(u32 line, u32* dst, u8* replaceModeDst);
    void DrawScanlineB(u32 line, u32* dst, u8* replaceModeDst);
