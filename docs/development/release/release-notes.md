...
| Internal only | `docs/` / `tools/` maintenance, CI workflow, refactor with no UX change |
...
- Do not mention internal refactors, documentation/tooling maintenance, or CI-only changes.
...
|---|---|
| Documentation/tooling only | Internal maintenance, no UX impact |
