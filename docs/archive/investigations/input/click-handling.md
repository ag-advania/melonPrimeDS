...
[../../../architecture/input/aim-input.md](../../../architecture/input/aim-input.md) §10.
...
- Click-related repo history: [../../../architecture/input/aim-input.md](../../../architecture/input/aim-input.md) §7,
  [MelonPrime refactoring history](../../../architecture/history/melonprime-refactoring.md) §4.5 (R2 button-priority fix),
  §5.2 (OPT-S / fence aggregation), §15.5 (P-35 revert).
- Single-writer atomic discipline: [MelonPrime refactoring history](../../../architecture/history/melonprime-refactoring.md)
  §3.2.
