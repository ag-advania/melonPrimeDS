...
|---|---|---|
| Video Settings | PASS | `video-20-final-r2/manual-video.harness.log`: dialog observed, `cancel=1..20`, `apply-same-value=1..20`, validation findings 0 |
| Fast Forward / Slow Motion | PASS | `speed-final-r3/manual-speed.harness.log`: all four hold/toggle actions sent, runtime speed-path evidence 11, validation findings 0 |
| ROM lifecycle | PASS | `rom-final/manual-rom.harness.log`: save slot 1, load, undo, reset, and second-session reopen; validation findings 0 |
...
desktop interaction and is the authoritative PASS.
