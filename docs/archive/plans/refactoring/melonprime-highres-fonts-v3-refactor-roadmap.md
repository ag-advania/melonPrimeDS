...
- `docs/architecture/history/melonprime-refactoring.md`
...
| `docs/archive/plans/refactoring/melonprime-full-refactor-plan-v4.md` | 既存V4リファクタリング計画、完了済みフェーズ、残課題 |
...
| `docs/architecture/repository.md` | HUD dirty rect、GL upload skip、PlatformInput、config default分類 |
