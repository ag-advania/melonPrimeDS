...
summarized in [melonprime-refactoring.md](../../../architecture/history/melonprime-refactoring.md)
...
[melonprime-srp-performance-contract.md](../../../architecture/srp-performance-contract.md).
...
- [PatchLifecycleGateway Step 3 Plan](melonprime_patch_lifecycle_gateway_step3_plan.md) —
  ...
  [melonprime-patch-system.md](../../../architecture/gameplay/patch-system.md) for why
