...
[Metal backend implementation guide](../../../archive/plans/rendering/metal/specs/melonprime_metal_backend_implementation_guide_final_killswitch_separate_metal_preset.md)
...
it is UI-disabled — see [../../../features/rendering/macos-compute-renderer-restriction.md](../../../features/rendering/macos-compute-renderer-restriction.md)).
...
Metal. See [compute renderer mosaic investigation](../../../archive/investigations/rendering/compute-renderer-mosaic-bug.md) for why that renderer
...
**Problem this closes:** [../../../features/rendering/macos-compute-renderer-restriction.md](../../../features/rendering/macos-compute-renderer-restriction.md)
...
- [EmuInstance.cpp](../../../../src/frontend/qt_sdl/EmuInstance.cpp) `usesOpenGL()`: routed through the
  ...
  [../../../archive/audits/upstream/non-melonprime-upstream-diff-2026-06-11.md](../../../archive/audits/upstream/non-melonprime-upstream-diff-2026-06-11.md) (the `#else` branch preserves
...
- `MelonPrimeVideoBackend.cpp` registered in `SOURCES_QT_SDL` in
  ...
  [../../../architecture/repository.md](../../../architecture/repository.md) "SRP v3 Unit Ownership").
...
- `pwsh tools/ci/audits/audit-config-defaults.ps1` — PASS.
- `pwsh tools/ci/audits/check-inc-ownership.ps1` — PASS (56 `.inc` files, `MelonPrimeVideoBackend.h`
...
Following [Phase 8 execution instructions](../../../archive/plans/rendering/metal/done/metal_phase8_execution_instructions.md)
...
[Phase 8 execution instructions](../../../archive/plans/rendering/metal/done/metal_phase8_execution_instructions.md)'s
Priority 2 gate.
...
Following
[Tester UI/performance instructions](../../../archive/plans/rendering/metal/done/metal_tester_ui_perf_audit_and_execution_instructions_v2.md),
