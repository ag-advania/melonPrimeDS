...
- 現行参照ブランチ: <https://github.com/ag-advania/melonPrimeDS/tree/develop_hud>（HEAD `2a0266f14`、2026-08-28 現行checkout確認）
...
- process-global mutable state監査を
  `tools/ci/audits/audit-melonprime-instance-state.ps1`へ固定
- A/B再現手順と保存すべき証跡を
...
- `tools/ci/audits/audit-melonprime-thread-boundary.ps1 -Strict`で直接GUI API／legacy state参照0件を固定
- Windows MinGW build、HUD golden、全CI auditを確認
