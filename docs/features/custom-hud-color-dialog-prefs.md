...
- Added `tools/ci/audits/audit-color-dialog-prefs.ps1` (grep ratchet; Windows/Ubuntu CI)
...
- [x] Local script: `tools/ci/audits/audit-color-dialog-prefs.ps1`
...
rg "QColorDialog::getColor" src/frontend/qt_sdl
rg "#include <QColorDialog>" src/frontend/qt_sdl
pwsh -NoProfile -File tools/ci/audits/audit-color-dialog-prefs.ps1
...
- [settings-ui-and-edit-mode.md](../development/ui/settings-and-edit-mode.md) — Custom HUD settings / edit mode UI
- [custom-hud-runtime.md](../development/hud/custom-hud-runtime.md) — HUD runtime ownership (RGB config, not palette)
