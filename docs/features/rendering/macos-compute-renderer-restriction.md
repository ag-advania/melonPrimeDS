...
- `InputConfig/MelonPrimeInputConfig.ui` — not touched. A `.ui`-level
  ...
  platform-scatter convention (see [../../architecture/input/aim-input.md](../../architecture/input/aim-input.md)
  and [../../architecture/repository.md](../../architecture/repository.md) Platform Input section for
...
- ~~No normalization of an already-saved `3D.Renderer = renderer3D_OpenGLCompute`
  ...
  [../../plans/rendering/metal/backend-plan.md](../../plans/rendering/metal/backend-plan.md) Phase 0
