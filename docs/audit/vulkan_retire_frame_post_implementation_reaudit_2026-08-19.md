...
- Complete and retain the Ubuntu x86_64/aarch64 and BSD FreeBSD/NetBSD/OpenBSD
  ...
  x86_64/arm64 target PASS. FreeBSD remains the single hosted target gap
  because its VM retry failed before dependency setup.
