...
#
# Verifies the unity-include ownership rule from docs/architecture/repository.md
# and docs/archive/plans/refactoring/melonprime-full-refactor-plan.md Phase 0 / Phase 6:
